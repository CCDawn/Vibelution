...
const nodes = [
  ...
  },
  {
    ...
    outputs: ["experiment_plan 草稿", "readinessChecklist", "baselineSelection blocker", "promotion/reject 前置门禁"],
...
const implementationBlueprint = {
  ...
  deliveredSlice: [
    ...
    ["实验计划索引", "workspace/teams/<teamId>/experiment_plans/index.json", "保存实验计划草稿、selectedHypotheses、baselineSelection、readinessChecklist 和 full-run blocker。"],
