...
const implementationBlueprint = {
  ...
  activeTeam: {
    ...
    note: "挑战杯科研流程直接绑定当前 Vibelution ai科学研究团队，不另建新团队；点击左侧 ai科学研究团队后直接进入团队专属科研工作台，科研流程索引下沉到团队内容区内部作为二级导航，资料搜集已拆成独立一级工作页，组织画布仅作为附属结构视图。",
