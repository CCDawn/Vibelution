...
const knowledgeRunbook = {
  ...
  projectAlignment: [
    ...
    ["知识治理 Agent", "agent-knowledge-steward 固定存在；ToolPolicy 含 knowledge proposal/ingestion/governance/rating 工具；边界 proposal_and_rating_suggestion_only", "高度匹配", "07 节点可直接对齐知识治理 Agent；但该 Agent 不能直接应用正式知识，只能提交建议和待审摄取包。"],
...
const implementationBlueprint = {
  ...
  services: [
    ...
    ["memory_ingestion_bridge", "复用现有 knowledge tools 与 /api/knowledge-bases/*，把摄取包映射到正式知识平台。"],
  ],
  communicationRoles: [
