...
const nodes = [
  ...
  },
  {
    ...
    actions: [
      ...
      "Teams 实验阶段页展示实验计划账本、候选算法假设、readyForSmoke/readyForFullRun 门禁、active smoke 摘要和 smoke 结果登记表单。",
    ...
    openQuestions: ["下一刀评估是否需要轻量 smoke runner，或先接 full-run/ExperimentResult 的显式执行边界。"],
  },
  {
    id: "11",
