    ...
    <main class="shell">
      ...
      <section id="overview" class="review-dashboard">
        ...
        <aside class="dashboard-panel">
          <h2>审核摘要</h2>
          <div class="kpi-grid">
            <div class="kpi"><b>当前阶段</b><strong>M6.32</strong><span>资料筛选可由资料质量评估 Agent 一键批量执行，结果仍停留在候选区。</span></div>
