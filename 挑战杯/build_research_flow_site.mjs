...
const nodes = [
  ...
  },
  {
    ...
    summary: "在交给记忆平台前先做领域与工程风险过滤，并把返工/拒绝纳入状态机闭环。",
    ...
    outputs: ["review_record 候选", "review_prefiltered 状态", "review_needs_revision 状态", "transfer returned/rejected 记录", "rejection_archive"],
