...
const implementationBlueprint = {
  ...
  deliveredSlice: [
    ...
    ["Team 前端入口", "/teams?team=research-team", "读取 /workflow-orchestration、/candidates?limit=8、/knowledge-ingestion/status 和通用 data-processing run/status/assignment，展示科研流程状态、资料搜集执行台、候选仓库、校验摘要、知识入库漏斗、actionItems 和 officialBoundary；非科研团队显示占位，不初始化 workflow。"],
