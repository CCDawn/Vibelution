...
const knowledgeNodeRunbook = {
  "01": {
    ...
    tools: ["/api/teams/{teamId}/workflow-orchestration/stage-rounds/status", "/api/teams/{teamId}/workflow-orchestration/stage-rounds/start", "/api/teams/{teamId}/workflow-orchestration/stage-rounds/{stageRoundId}/coordination/retry", "/api/teams/{teamId}/workflow-orchestration/stage-rounds/{stageRoundId}/memory-record/retry", "/api/teams/{teamId}/workflow-orchestration/source-collection-runs", "/api/data-processing/runs", "/api/data-processing/runs/{runId}/collection-assignments", "/api/data-processing/runs/{runId}/collection-assignments/{assignmentId}/outputs", "/api/teams/{teamId}/workflow-orchestration/data-processing/runs/{runId}/records/{recordId}/source-candidate", "research_knowledge_query_tool", "/api/teams/{teamId}/workflow-orchestration/candidates/{candidateId}/source-extraction"],
