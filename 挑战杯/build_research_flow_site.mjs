    ...
    <main class="shell">
      ...
      <section id="overview" class="review-dashboard">
        ...
        <aside class="dashboard-panel">
          <h2>审核摘要</h2>
          <div class="kpi-grid">
            <div class="kpi"><b>当前阶段</b><strong>M6.24</strong><span>知识搜集工作台已加入中文展示映射和主操作控制台，内部字段默认降级到详情。</span></div>
