    ...
    <main class="shell">
      ...
      <section id="overview" class="review-dashboard">
        ...
        <aside class="dashboard-panel">
          <h2>审核摘要</h2>
          <div class="kpi-grid">
            <div class="kpi"><b>当前阶段</b><strong>M6.35</strong><span>知识搜集五个步骤已改为页内子页，只显示当前阶段内容和当前阶段操作。</span></div>
