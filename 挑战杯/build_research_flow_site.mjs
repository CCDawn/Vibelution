...
const knowledgeRunbook = {
  ...
  stateFlow: [
    ...
    ["steward_pending_knowledge_review", "待审入库对象", "知识库管理员 approved 回写已创建 SourceArtifact、pending RefinementProposal，可选 pending ratingSuggestion；等待或执行审批门禁。"],
  ...
  teamWorkflowOrchestration: {
    ...
    landedApis: [
      ...
      ["POST", "/api/teams/{team_id}/workflow-orchestration/steward-packs/{candidate_id}/knowledge-ingestion", "由知识库管理员把有效 steward_pack_draft 提交为 SourceArtifact + pending RefinementProposal，可选 pending ratingSuggestion；不创建 KnowledgeItem/RAG/正式图谱。"],
  ...
  roles: [
    ...
    ["知识库管理员 / agent-knowledge-steward", "生成治理建议、评级建议和摄取包，不绕过审核。"],
...
const implementationBlueprint = {
  ...
  milestones: [
    ...
    ["M6.65", "科研团队 Agent 结构性重绑", "research-team 增加标准 7 角色修复入口：科研协调、资料发现、来源获取、内容提炼、资料质量评估、候选图谱、资料入库；旧成员、旧画布节点和重复 challengeCupTeamId Agent 可被物理清理。", "阶段 Agent 必须拥有 directSessionId 且在会话页可见；阶段私聊入口只跳转到对应 Agent 私有对话页，缺少私聊会话时提示修复团队 Agent，不再退回 Agent 管理页。"],
        ...
        <div class="plan-library-intro">
          ...
          <div class="dashboard-panel">
            ...
            <div class="focus-list">
              ...
              <div class="focus-item"><b>治理</b><span>知识库管理员只提交建议与待审对象。</span></div>
