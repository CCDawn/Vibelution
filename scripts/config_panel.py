...
I18N = {
    "zh": {
        ...
        "clear_api_key": "清除密钥",
        "api_key_hint": "保存后写入本机用户级环境变量；不会写入外部 operator config.toml。",
    ...
    "en": {
        ...
        "api_key_hint": "Saved to the local user environment; never written to the external operator config.toml.",
