...
class WorkflowLedgerStore:
    ...
    def get_catalog_run_authorization(
        ...
        return self.read(lambda repo: repo.get_catalog_run_authorization(authorization_id))
    ...
    def list_catalog_run_authorizations(
        ...
        return self.read(lambda repo: repo.list_catalog_run_authorizations(team_id, plan_id))
