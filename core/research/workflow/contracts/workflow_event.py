...
class WorkflowEventType(str, Enum):
    ...
    SESSION_SCOPE_RESOLVED = "workflow.session_scope.resolved"
    CHILD_SESSION_CREATED = "workflow.child_session.created"
    CHILD_SESSION_RESUMED = "workflow.child_session.resumed"
    SCOPE_ATTEMPT_RETRIED = "workflow.scope_attempt.retried"
    HYPOTHESIS_FRAGMENT_RECORDED = "workflow.hypothesis_fragment.recorded"
    HYPOTHESIS_AGGREGATION_BLOCKED = "workflow.hypothesis_aggregation.blocked"
    HYPOTHESIS_AGGREGATION_COMPLETED = "workflow.hypothesis_aggregation.completed"
