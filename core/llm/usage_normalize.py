...
def normalize_usage_payload(raw: Mapping[str, Any] | None) -> Dict[str, Any]:
    """Normalize usage into the canonical camelCase + snake dual fields."""
    return normalize_usage_dict(raw)
