...
storage resolution live in the service. The route layer never re-implements the
plan allowlist or any fixture lifecycle.
"""
...
@router.get(
    "/teams/{team_id}/challenge-cup-dev-controls",
...
@router.post(
    "/teams/{team_id}/challenge-cup-dev-controls/readiness",
...
@router.post(
    "/teams/{team_id}/challenge-cup-dev-controls/batches/{plan_id}",
