...
def build_supervised_judge_quality_report(limit: int = 200) -> dict[str, Any]:
    ...
    return {
        ...
        "kappa": report.kappa,
        "topLevelSampleSource": report.topLevelSampleSource,
        "anchoredPairs": report.anchoredPairs,
        "anchoredConfusionMatrix": report.anchoredConfusionMatrix,
        "anchoredKappa": report.anchoredKappa,
        "agentPairs": report.agentPairs,
        "agentConfusionMatrix": report.agentConfusionMatrix,
        "agentKappa": report.agentKappa,
