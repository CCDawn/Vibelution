    ...
    *,
    ...
    return {
        ...
        "request": {
            ...
            "sourceCollectionRunId": str(source_collection_run_id or "").strip(),
...
def _result_from_rag_context(context: dict[str, Any], *, rank: int) -> dict[str, Any]:
    ...
    return {
        ...
        "sourceCandidateId": str(source.get("sourceCandidateId") or "").strip(),
        "sourceIdentityHash": str(source.get("sourceIdentityHash") or "").strip(),
        "evidenceLevel": str(source.get("evidenceLevel") or "").strip(),
...
def _citation_from_rag_result(result: dict[str, Any], *, rank: int) -> dict[str, Any]:
    ...
    return {
        ...
        "sourceCandidateId": str(result.get("sourceCandidateId") or "").strip(),
        "sourceIdentityHash": str(result.get("sourceIdentityHash") or "").strip(),
        "evidenceLevel": str(result.get("evidenceLevel") or "").strip(),
