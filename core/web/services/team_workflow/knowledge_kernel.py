...
def _research_memory_knowledge_results(
    ...
    *,
    ...
    if (require_scope or normalized_project_id or normalized_question_id) and (
        not normalized_project_id or not normalized_question_id
    ):
...
def _candidate_store_path(
    ...
    return s._team_workflow_root(team_id, research_project_id) / "candidate_store" / "index.json"
