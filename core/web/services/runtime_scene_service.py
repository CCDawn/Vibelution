...
from .runtime_scene.diagnosis import (
    ...
    _parse_startup_bracket_log_line,
    _parse_startup_raw_json_line,
    _scan_startup_raw_evidence,
    _startup_timestamp_in_window,
    _startup_trace_window,
...
STARTUP_TRACE_STEPS = [
    ...
    },
    {
        ...
        "eventCodes": {
            "supervisor.started",
            "launcher.monitor.started",
            "launcher.monitor.workbench_open",
