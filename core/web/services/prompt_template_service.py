...
KNOWLEDGE_STEWARD_PROMPT_VERSION = 17
KNOWLEDGE_STEWARD_PROMPT_PATH = PROJECT_ROOT / "core/core_prompt/roles/knowledge_steward.md"
...
DEFAULT_PROMPT_TEMPLATES: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "name": "知识库管理员",
        "category": "knowledge",
        "content": KNOWLEDGE_STEWARD_PROMPT_PATH.read_text(encoding="utf-8").strip(),
        "metadata": {
            "builtin": True,
            "roleKey": "knowledge_steward",
            "builtinContentVersion": KNOWLEDGE_STEWARD_PROMPT_VERSION,
        },
    },
    {
