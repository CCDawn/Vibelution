...
| `workbench_ui_preferences_service.py` | Instance-local durable Workbench UI preferences (layout, shell chrome). | — | `workbench_ui.py` | `test_workbench_ui_preferences_service.py`, `test_workbench_ui_route_contract.py` |
