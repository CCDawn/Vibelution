...
def get_memory_usage_contract() -> dict[str, Any]:
    ...
    contract = {
        ...
        "principles": [
            ...
            "Evidence is not knowledge; proposals are not formal knowledge; formal knowledge is created by steward-screened direct ingestion or reviewer-confirmed proposal flows.",
            "Evolution systems may register runtime evidence and proposals, but raw runtime evidence must pass the knowledge steward gate before formal knowledge writes.",
        ...
        "domains": [
            ...
            },
            {
                ...
                "writesThrough": [
                    ...
                    "KB SourceArtifact from centralSourceId",
                    "steward source review direct ingestion",
                    "RefinementProposal for uncertain items",
                    "owner review/apply for proposals",
            ...
            },
            {
                ...
                "storage": "chat room history + owner source inbox + central source registry",
                "readsThrough": ["team_chat_refinement sourceRef", "traceability view"],
                "writesThrough": ["owner inbox collection", "steward source review", "direct ingestion or central-source refinement proposal"],
                "canRegisterSource": True,
                "canCreateFormalKnowledge": True,
                "promptDefault": "conversation_context_only",
                "boundary": "Group chat becomes evidence first; only a steward-screened source review or proposal review can create formal knowledge.",
            },
            {
                ...
                "writesThrough": ["runtime_evidence_refinement owner inbox source", "steward source review", "direct ingestion or central-source RefinementProposal"],
                "canRegisterSource": True,
                "canCreateFormalKnowledge": False,
                "promptDefault": "bounded_runtime_context",
                "boundary": "Self evolution may record validated lessons as evidence/proposals; the knowledge steward gate controls any formal knowledge write.",
            },
            {
                ...
                "boundary": "Case traces and decisions are evidence; they do not mutate Team KB without steward screening or proposal review.",
            },
            {
                "domainId": "external_artifacts",
                "label": "External search and PDF",
                "owner": "Research/parser pipeline",
                "storage": "owner source inbox + central source registry + SourceArtifact + KnowledgeItem or RefinementProposal",
                "readsThrough": ["pdf_refinement", "external_search_refinement"],
                "writesThrough": ["owner source inbox review", "direct ingestion after steward screening", "proposal tool for uncertain items"],
                "canRegisterSource": True,
                "canCreateFormalKnowledge": False,
                "promptDefault": "not_in_prompt",
                "boundary": "Parsers and searchers produce owner inbox sources; the knowledge steward decides whether to direct-ingest or keep proposal review.",
            },
        ],
        "flow": [
            {"stepId": "source_inbox", "label": "Collect source to owner inbox", "creates": ["OwnerSourceInboxSource"], "requiresReviewer": False},
            {"stepId": "central_source", "label": "Steward review/promote central source", "creates": ["CentralSource"], "requiresReviewer": True},
            {"stepId": "direct_ingest", "label": "Direct-ingest screened source", "creates": ["SourceArtifact", "KnowledgeBatch", "KnowledgeItem"], "requiresReviewer": True},
            {"stepId": "proposal", "label": "Refine proposal for uncertain items", "creates": ["SourceArtifact", "RefinementProposal"], "requiresReviewer": False},
            {"stepId": "review", "label": "Review/apply proposal", "creates": ["KnowledgeBatch", "KnowledgeItem"], "requiresReviewer": True},
