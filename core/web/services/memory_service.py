    ...
    contract = {
        ...
        "domains": [
            ...
            },
            {
                ...
                "writesThrough": ["owner inbox collection", "steward source review", "central-source refinement proposal"],
                "canRegisterSource": True,
                "canCreateFormalKnowledge": False,
            ...
            },
            {
                ...
                "writesThrough": ["runtime_evidence_refinement owner inbox source", "steward source review", "central-source RefinementProposal"],
                "canRegisterSource": True,
                "canCreateFormalKnowledge": False,
            ...
            },
            {
                ...
                "storage": "owner source inbox + central source registry + SourceArtifact + RefinementProposal",
                "readsThrough": ["pdf_refinement", "external_search_refinement"],
                "writesThrough": ["ingestion package with centralSourceId", "steward source review", "proposal tool"],
                "canRegisterSource": True,
                "canCreateFormalKnowledge": False,
                "promptDefault": "not_in_prompt",
        ...
        "flow": [
            ...
            {"stepId": "kb_source", "label": "Attach central source to knowledge base", "creates": ["SourceArtifact"], "requiresReviewer": False},
