    ...
    profiles = {
        ...
        "challenge_cup_content_extraction": {
            ...
            "taskProfile": {
                ...
                "constraints": "工具边界以 web_fetch_tool、search_summarize_sources_tool、research_knowledge_query_tool 和 agent_message_tool 为主。",
        ...
        "challenge_cup_source_quality": {
            ...
            "taskProfile": {
                ...
                "constraints": "工具边界允许 research_knowledge_query_tool、web_search_tool、web_fetch_tool、batch_web_search_tool、paper_search_tool、project_search_tool、news_search_tool、search_summarize_sources_tool 和 agent_message_tool。",
