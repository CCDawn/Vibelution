...
def bulk_purge_agents(agent_ids: list[str] | None) -> dict[str, Any]:
    ...
    if candidate_ids:
        ...
        mode_cleanup = _timed(
            timings,
            "remove_from_mode_bindings",
            lambda: remove_agents_from_mode_bindings(candidate_ids, agent_snapshots_by_agent_id=snapshots_by_agent_id),
        )
        for agent_id in candidate_ids:
            ...
            try:
                ...
                direct_session_cleanups.append(direct_session_cleanup)
    ...
    return {
        ...
        "cleanupSummary": {
            ...
            "removedFromTeamIds": list(team_cleanup.get("changedTeamIds") or []),
            "modeBindingsRepaired": len(mode_cleanup.get("repairWarnings") or []),
            "directSessions": direct_session_cleanups,
            "dataRetention": "purged",
        },
        "timingsMs": timings,
        "durationMs": duration_ms,
