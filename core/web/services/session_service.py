...
def list_sessions(*, include_hidden_internal: bool = False) -> list[dict]:
    ...
    try:
        ...
        _finish_session_list_cache_build(signature=signature, started_at=started_at)
        raise
...
def create_child_session(
    ...
    *,
    ...
    with _CHAT_STATE_LOCK:
        ...
        child = _make_empty_conversation(
            child_id,
            title=title,
            timestamp=now,
            conversation_index_kind=agent_directory_service.CONVERSATION_INDEX_KIND_HIDDEN,
    ...
    _append_session_conversation_event(
        ...
        status="completed",
        payload={
            "content": _child_session_created_card(child_id=child_id, title=title, auto_start=auto_start),
            "metadata": {
...
def _normalize_conversation(
    ...
    *,
    ...
    return {
        ...
        "reasoningEffort": normalize_reasoning_effort(raw.get("reasoning_effort") or raw.get("reasoningEffort")),
