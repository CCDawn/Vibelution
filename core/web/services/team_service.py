...
# A Launcher backend instance owns one project root, so bootstrap and API
# callers share this process-local lock while the Team is first materialized.
_CHALLENGE_CUP_RESEARCH_TEAM_BOOTSTRAP_LOCK = threading.RLock()
...
CHALLENGE_CUP_RESEARCH_TEAM_ROLE_CONTRACT = _team_constants.CHALLENGE_CUP_RESEARCH_TEAM_ROLE_CONTRACT
CHALLENGE_CUP_RESEARCH_TEAM_ROLE_CONTRACT_VERSION = _team_constants.CHALLENGE_CUP_RESEARCH_TEAM_ROLE_CONTRACT_VERSION
CHALLENGE_CUP_RESEARCH_TEAM_ROLE_CONTRACT_FINGERPRINT = _team_constants.CHALLENGE_CUP_RESEARCH_TEAM_ROLE_CONTRACT_FINGERPRINT
CHALLENGE_CUP_RESEARCH_TEAM_PARTICIPANT_POLICY_VERSION = _team_constants.CHALLENGE_CUP_RESEARCH_TEAM_PARTICIPANT_POLICY_VERSION
CHALLENGE_CUP_RESEARCH_TEAM_LEGACY_READ_MODE = _team_constants.CHALLENGE_CUP_RESEARCH_TEAM_LEGACY_READ_MODE
CHALLENGE_CUP_RESEARCH_TEAM_LEGACY_ROLE_OWNERS = _team_constants.CHALLENGE_CUP_RESEARCH_TEAM_LEGACY_ROLE_OWNERS
...
challenge_cup_research_team_missing = _system_teams.challenge_cup_research_team_missing
bootstrap_challenge_cup_research_team = _system_teams.bootstrap_challenge_cup_research_team
knowledge_expansion_team_agents_need_repair = _system_teams.knowledge_expansion_team_agents_need_repair
challenge_cup_research_team_copy_outdated = _system_teams.challenge_cup_research_team_copy_outdated
apply_challenge_cup_research_team_copy_refresh = _system_teams.apply_challenge_cup_research_team_copy_refresh
...
_materialize_challenge_cup_research_team_agents = _system_teams._materialize_challenge_cup_research_team_agents
_materialize_challenge_cup_research_team_agent = _system_teams._materialize_challenge_cup_research_team_agent
...
_purge_team_agents = _system_teams._purge_team_agents
_purge_team_agent = _system_teams._purge_team_agent
