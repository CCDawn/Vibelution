...
# callers share this process-local migration lock. RLock keeps nested Team
# reconciliation safe while the complete Challenge Cup migration is serialized.
_CHALLENGE_CUP_RESEARCH_TEAM_MIGRATION_LOCK = threading.RLock()
...
CHALLENGE_CUP_RESEARCH_TEAM_DIALOGUE_MODEL_REF = (
    _team_constants.CHALLENGE_CUP_RESEARCH_TEAM_DIALOGUE_MODEL_REF
)
...
_challenge_cup_research_team_alias_resolution = _system_teams._challenge_cup_research_team_alias_resolution
_mark_challenge_cup_research_team_legacy_agents = _system_teams._mark_challenge_cup_research_team_legacy_agents
