...
def get_workbench_state_payload(
    *,
    project_root: Path | None = None,
...
def _case_diagnostics(record) -> list[dict[str, Any]]:
    return build_case_diagnostics(record.case_summaries)
...
def _run_state_label(status: str, *, lang: str) -> str:
    ...
    mapping = {
        ...
        "observing": text_for(lang, zh="评测完成 · 观察池", en="Run complete · observation pool"),
