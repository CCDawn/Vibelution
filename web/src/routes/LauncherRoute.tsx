...
export function LauncherRoute() {
  ...
  const copy = lang === "zh"
    ? {
        ...
        startProjectSummary: "工作台未运行时，从这里启动后端、前端资源和工作台窗口。",
    ...
    : {
        ...
        useStartAction: "Start Workbench",
        ...
        startProjectSummary: "When the Workbench is closed, start backend, frontend assets, and the workbench window from here.",
