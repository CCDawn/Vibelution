...
import { Database, ExternalLink, HardDrive, LoaderCircle, Play, Power, RefreshCw, ShieldCheck, Square, Trash2 } from "lucide-react";
...
import { VButton, VNativeSelect, VRouteHeader } from "../components/vui";
...
function ProjectMaintenancePanel({
  copy,
  summary,
  maintenanceProfile,
  plan,
