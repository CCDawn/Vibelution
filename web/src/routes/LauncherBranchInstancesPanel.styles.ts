...
const tableGrid =
  "grid-cols-[28px_minmax(110px,1fr)_minmax(80px,0.55fr)_minmax(80px,0.55fr)_minmax(64px,0.4fr)_minmax(56px,0.35fr)_minmax(0,1.2fr)_auto]";
const tableGrid860 =
  "max-[860px]:grid-cols-[28px_minmax(110px,1fr)_minmax(72px,0.5fr)_minmax(72px,0.5fr)_minmax(0,1fr)_auto] max-[860px]:[&>span:nth-child(5)]:hidden max-[860px]:[&>span:nth-child(6)]:hidden";
const tableGrid620 =
  "max-[620px]:grid-cols-[28px_minmax(0,1fr)_auto] max-[620px]:[&>span:nth-child(n+3):nth-child(-n+7)]:hidden";
...
const styles = {
  ...
  actionCell: "flex items-center justify-end",
