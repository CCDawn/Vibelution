...
const contentPreClass = `m-0 max-h-[48vh] overflow-auto ${fieldSurfaceClass} p-2.5 text-[var(--vui-font-xs)] leading-[1.48] text-vui-fg-primary whitespace-pre-wrap break-words`;
