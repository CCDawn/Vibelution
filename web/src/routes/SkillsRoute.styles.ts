...
const panelClass = "grid min-h-0 min-w-0 content-start gap-[7px] rounded-lg border border-vui-border-soft bg-[color-mix(in_srgb,var(--surface-panel)_66%,transparent)] p-2";
...
const bulkActionBarClass = "flex min-w-0 flex-wrap items-center gap-[6px] rounded-lg border border-vui-border-soft bg-[color-mix(in_srgb,var(--surface-panel)_60%,transparent)] p-[7px]";
