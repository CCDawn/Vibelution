...
const styles = {
  ...
  findingCard: `vui-routes-configroute findingCard ${rowSurface} [display:grid] [gap:10px] [min-width:0] [padding:12px]`,
  ...
  healthPanelHeader: "vui-routes-configroute healthPanelHeader [display:flex] [align-items:start] [justify-content:space-between] [gap:12px] [min-width:0] [&_h3]:[min-width:0] [&_h3]:[margin:0] [&_h3]:[color:var(--fg-primary)] [&_h3]:[font-size:0.96rem] [&_h3]:[overflow-wrap:anywhere]",
