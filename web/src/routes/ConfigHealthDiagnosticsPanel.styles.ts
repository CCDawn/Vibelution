...
const styles = {
  ...
  inlineBadge: "vui-routes-configroute inlineBadge [display:inline-flex] [align-items:center] [justify-content:center] [min-height:24px] [padding:0_8px] [border-radius:999px] [border:1px_solid_transparent] [font-size:var(--vui-font-xs)] [white-space:nowrap] [color:var(--fg-secondary)] [background:var(--surface-card-muted)]",
