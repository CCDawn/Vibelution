...
import graphPanelSource from "./MemoryGraphViewPanel.tsx?raw";
...
describe("MemoryRoute layout contract", () => {
  ...
  it("wires the read-only 3D memory knowledge graph API and canvas shell", () => {
    ...
    expect(graphPanelSource).toContain("copy.graphKnowledgeLoading");
    expect(graphPanelSource).toContain("copy.graphKnowledgeTruncated");
    expect(graphPanelSource).toContain("styles.graphKnowledgeContent");
    expect(graphPanelSource).toContain("MemoryGraphCanvas");
    expect(graphPanelSource).toContain("copy.graphGpu");
    expect(graphPanelSource).toContain("copy.graphWorker");
    expect(graphPanelSource).toContain("copy.graphReadOnly");
    expect(graphPanelSource).toContain("copy.graphAcl");
    expect(graphPanelSource).toContain("copy.graphInteractionHint");
    ...
    expect(graphPanelSource).toContain("copy.graphVisibleNodes");
    expect(graphPanelSource).toContain("copy.graphVisibleEdges");
    expect(graphPanelSource).toContain("copy.graphClearFocus");
    ...
    expect(graphPanelSource).toContain("copy.graphResponsibilityQuestion");
    expect(graphPanelSource).toContain("copy.graphDirectChildren");
    expect(graphPanelSource).toContain("copy.graphNodeKnowledge");
    expect(graphPanelSource).toContain("styles.graphResponsibilityPanel");
    expect(graphPanelSource).toContain("styles.graphKnowledgePanel");
    expect(graphPanelSource).toContain("copy.graphRelations");
    expect(graphPanelSource).toContain("copy.graphIncoming");
    expect(graphPanelSource).toContain("copy.graphOutgoing");
    expect(graphPanelSource).toContain("copy.graphNoRelations");
    expect(graphPanelSource).toContain("styles.graphRelationPanel");
    expect(graphPanelSource).toContain("styles.graphRelationGroup");
    expect(graphPanelSource).toContain("styles.graphClearFocusButton");
    expect(graphPanelSource).toContain("styles.graphWorkspace");
    expect(graphPanelSource).toContain("styles.graphCanvasPanel");
    expect(graphPanelSource).toContain("styles.graphTypeList");
    ...
    expect(graphPanelSource).toContain("GRAPH_NODE_TYPE_LABELS");
    expect(graphPanelSource).toContain("styles.graphNodeTypeMark");
    expect(graphPanelSource).toContain("data-node-type");
    expect(graphPanelSource).toContain("data-active");
  ...
  it("keeps explanatory Memory platform copy out of persistent paragraphs", () => {
    ...
    expect(graphPanelSource).toContain('title={copy.graphInteractionHint}');
