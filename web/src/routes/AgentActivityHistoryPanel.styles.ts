...
const styles = {
  ...
  activityTimelineItem_inbox: "[border-color:color-mix(in_srgb,_var(--state-success)_28%,_var(--vui-border-subtle))] [background:color-mix(in_srgb,_var(--state-success)_5%,_var(--vui-surface-row))]",
