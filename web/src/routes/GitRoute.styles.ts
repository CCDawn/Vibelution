export const gitRouteStyles: Record<string, string> = {
  ...
  summaryCard:
    "grid min-w-0 grid-cols-[auto_minmax(0,1fr)] items-baseline gap-2 rounded-lg border border-[var(--border-soft)] bg-[var(--surface-panel)] p-[var(--route-summary-padding)] text-left text-inherit disabled:cursor-default disabled:opacity-75 [&[data-vui]]:cursor-pointer [&[data-vui]:hover:not(:disabled)]:border-[color-mix(in_srgb,var(--accent-cool)_28%,transparent)] [&[data-vui]:hover:not(:disabled)]:bg-[color-mix(in_srgb,var(--accent-cool)_7%,var(--surface-panel))] [&_[data-slot=vui-button-content]]:contents [&_[data-slot=vui-button-label]]:contents [&_span]:whitespace-nowrap [&_span]:text-[var(--vui-font-xs)] [&_span]:uppercase [&_span]:tracking-[0.06em] [&_span]:text-[var(--fg-tertiary)] [&_strong]:min-w-0 [&_strong]:overflow-hidden [&_strong]:text-ellipsis [&_strong]:whitespace-nowrap [&_strong]:text-[var(--vui-font-xs)] [&_strong]:text-[var(--fg-primary)]",
  notice:
  ...
  cleanStateStrip:
    "grid w-full min-w-0 cursor-pointer grid-cols-[minmax(170px,auto)_minmax(0,1fr)] items-center gap-3 rounded-lg border border-[var(--border-soft)] bg-[var(--surface-panel)] px-3 py-2.5 text-left text-inherit hover:border-[color-mix(in_srgb,var(--accent-cool)_30%,transparent)] hover:bg-[color-mix(in_srgb,var(--accent-cool)_7%,var(--surface-panel))] max-[860px]:grid-cols-1 [&_[data-slot=vui-button-content]]:contents [&_[data-slot=vui-button-label]]:contents [&_h2]:m-0 [&_h2]:text-[0.98rem] [&_h2]:text-[var(--fg-primary)] [&>span]:min-w-0 [&>span]:overflow-hidden [&>span]:text-ellipsis [&>span]:whitespace-nowrap [&>span]:text-[var(--vui-font-xs)] [&>span]:leading-tight [&>span]:text-[var(--fg-secondary)]",
  ...
  filterButton:
    "inline-flex min-h-7 items-center justify-center gap-1.5 rounded-[var(--radius-control)] border border-[var(--border-soft)] bg-[var(--surface-card)] px-2 py-1 text-[var(--vui-font-xs)] text-[var(--fg-secondary)] hover:border-[var(--border-strong)] hover:bg-[var(--surface-panel-hover)] hover:text-[var(--fg-primary)]",
  filterButtonActive:
    "inline-flex min-h-7 items-center justify-center gap-1.5 rounded-[var(--radius-control)] border border-[color-mix(in_srgb,var(--accent-warm)_30%,transparent)] bg-[color-mix(in_srgb,var(--accent-warm)_14%,transparent)] px-2 py-1 text-[var(--vui-font-xs)] text-[var(--accent-warm-2)]",
  selectionButton:
  ...
  emptyPreview:
    "grid h-full content-start justify-items-start gap-[7px] rounded-lg border border-[var(--border-soft)] bg-[var(--surface-panel)] p-3.5 text-[var(--fg-secondary)] [&_p]:m-0 [&_p]:text-[var(--vui-font-xs)] [&_p]:leading-tight [&_p]:text-[var(--fg-secondary)] [&_strong]:text-[0.98rem] [&_strong]:text-[var(--fg-primary)] [&_svg]:h-[18px] [&_svg]:w-[18px] [&_svg]:text-[var(--accent-cool)]",
