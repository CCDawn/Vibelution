export const gitRouteStyles: Record<string, string> = {
  ...
  commitHeader:
    "flex min-w-0 items-center justify-between gap-2 [&_code]:min-w-0 [&_code]:text-[var(--vui-font-xs)] [&_code]:text-[var(--accent-warm-2)] [&_span]:inline-flex [&_span]:min-w-0 [&_span]:items-center [&_span]:gap-[5px] [&_span]:overflow-hidden [&_span]:text-ellipsis [&_span]:whitespace-nowrap [&_span]:text-[var(--vui-font-xs)] [&_span]:text-[var(--fg-tertiary)]",
};
