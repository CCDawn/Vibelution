...
describe("EvolutionRoute library user flow contract", () => {
  ...
  it("keeps the runnable source picker separate from the full supervised benchmark catalog", () => {
    ...
    expect(routeSource).toContain("EvolutionDatasetCatalogPanel");
    expect(datasetCatalogPanelSource).toContain("datasetCatalogPanel");
    expect(datasetCatalogPanelSource).toContain("item.visibilityReason");
    expect(datasetCatalogPanelSource).toContain("item.usabilityReason");
    expect(datasetCatalogPanelSource).toContain("datasetCatalogStatusLabel");
