...
describe("ChatCodingRoute layout contract", () => {
  ...
  it("folds previous-turn context and cache composition into session diagnostics", () => {
    ...
    expect(routeSource).toContain("buildCacheDonutSegments(computedCacheCompositionSegments, computedCacheCompositionTotalTokens)");
    ...
    expect(routeSource).toContain("cacheDonutComputedSegmentClass(segment.key)");
    expect(routeSource).toContain("computedCacheLegendSegmentClass(segment.key)");
    expect(routeSource).toContain("cacheDonutSegmentStyle(segment, computedCacheDonutSegments.length > 1 ? 0.55 : 0)");
    expect(routeSource).toContain("cacheDonutSegmentTitle(segment, computedCacheCompositionTotalTokens, numberFormatter, lang)");
