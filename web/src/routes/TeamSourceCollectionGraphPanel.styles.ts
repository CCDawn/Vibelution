...
const styles = {
  ...
  sourceCollectionGraphNodeListShell: `sourceCollectionGraphNodeListShell min-w-0 max-w-full grid max-h-[28vh] min-h-[96px] content-start gap-1.5 overflow-auto rounded-[var(--radius-control)] border border-[color:var(--border-soft)] ${vuiFlatPanelClass} p-1.5 text-[var(--fg-primary)] [scrollbar-gutter:stable] max-[860px]:max-h-[34vh]`,
