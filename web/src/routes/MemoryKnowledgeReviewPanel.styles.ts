const styles = {
  ...
  queueToolbar:
    "queueToolbar min-w-0 !grid min-h-0 content-start justify-start gap-1.5 overflow-auto grid-cols-[repeat(auto-fit,minmax(min(100%,11rem),max-content))] [&_label]:min-w-0",
  wideField:
