...
const styles = {
  sessionContextMenu: `vui-routes-chatcodingroute sessionContextMenu fixed z-[80] grid w-[188px] max-w-[calc(100vw-24px)] content-start gap-1 ${vuiFlatPanelClass} p-1 text-[var(--fg-primary)] shadow-none backdrop-blur-[4px]`,
