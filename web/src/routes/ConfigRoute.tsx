...
export const CONFIG_COPY = {
  zh: {
    ...
    groupModelingSummary: "模型库、任务模型和模型适配设置放在同一组里。",
    ...
    profilePreparedHint: "可以在这里新增任务模型。确认后页面会立即展示本次修改，保存后写入 config.toml。",
    currentRoute: "当前配置",
    stagedRoute: "本次修改预览",
    apiKeySource: "密钥来源",
    editProfile: "编辑",
    ...
    keyMissing: "缺失",
    sourceLibrary: "模型库",
    sourceProfileGenerated: "来自当前任务模型",
  ...
  en: {
    ...
    groupModelingSummary: "Keep the model library, task models, and model adaptation settings together.",
    ...
    profiles: "Task models",
    profileAdd: "Add task model",
    profileId: "Task model ID",
    ...
    profilePreparedHint: "Add a new task model here. Confirm updates the page immediately; saving writes config.toml.",
    ...
    sourceProfileGenerated: "from current task model",
...
function buildConfigSidebarGroups(copy: ConfigCopy): ConfigSidebarGroup[] {
  return [
    ...
    {
      id: "git-commits",
      title: copy.groupGitTitle,
      summary: copy.groupGitSummary,
      memberSectionIds: ["git"],
    },
    {
      id: "agent-evolution",
