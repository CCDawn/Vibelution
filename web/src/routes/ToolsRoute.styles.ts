...
const styles = {
  ...
  bulkActionBar:
    "bulkActionBar min-w-0 max-w-full flex flex-wrap items-center gap-1.5 !grid grid-cols-[minmax(0,1fr)_auto_auto] items-center gap-[5px] p-[5px] rounded-lg border border-[color:color-mix(in_srgb,var(--border-soft)_62%,transparent)] bg-[color:color-mix(in_srgb,var(--surface-panel)_46%,transparent)]",
  bulkPolicyActions:
  ...
  summaryCard:
    "summaryCard min-w-0 max-w-full rounded-[var(--radius-control)] border border-[color:color-mix(in_srgb,var(--border-soft)_58%,transparent)] bg-[color:color-mix(in_srgb,var(--surface-panel)_42%,transparent)] !grid grid-cols-[auto_minmax(0,1fr)] items-baseline gap-[5px] min-h-[26px] px-2 py-[3px]",
  summaryGrid:
  ...
  toolPermissionRow:
    "toolPermissionRow min-w-0 max-w-full rounded-[7px] border border-[color:color-mix(in_srgb,var(--border-soft)_62%,transparent)] bg-[color:color-mix(in_srgb,var(--surface-panel)_42%,transparent)] !grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2.5 px-[7px] py-[7px]",
  ts:
    "ts min-w-0",
  workspace:
  ...
  workspaceScopePanel:
    "workspaceScopePanel min-w-0 max-w-full rounded-[var(--radius-panel)] border border-[color:color-mix(in_srgb,var(--border-soft)_62%,transparent)] bg-[color:color-mix(in_srgb,var(--surface-panel)_42%,transparent)] !grid grid-cols-[repeat(4,minmax(0,1fr))] gap-[7px] p-2 max-[900px]:grid-cols-[repeat(2,minmax(0,1fr))]",
} as const;
