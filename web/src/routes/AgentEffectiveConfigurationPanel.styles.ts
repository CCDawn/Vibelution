...
const styles = {
  ...
  fieldIdentity: "grid min-w-0 [&_strong]:min-w-0 [&_strong]:truncate [&_strong]:text-[var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-sm)]",
  fieldValue: "grid min-w-0 [&_strong]:min-w-0 [&_strong]:truncate [&_strong]:text-[var(--fg-secondary)] [&_strong]:[font-family:var(--font-mono)] [&_strong]:[font-size:var(--vui-font-sm)] max-[860px]:[grid-column:1]",
  ...
  statusReady: "[color:var(--fg-secondary)]",
  ...
  inheritanceCopy: "grid min-w-0 [&_strong]:min-w-0 [&_strong]:truncate [&_strong]:text-[var(--fg-secondary)] [&_strong]:[font-size:var(--vui-font-sm)]",
  inheritanceTrigger: "[border-radius:6px] focus-visible:[outline:2px_solid_var(--accent-cool)] focus-visible:[outline-offset:2px]",
