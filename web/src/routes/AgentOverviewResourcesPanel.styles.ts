...
const styles = {
  section: `min-w-0 rounded-none border-0 border-t border-[color-mix(in_srgb,var(--vui-border-subtle)_72%,transparent)] ${vuiOpaqueRowClass} p-3`,
  header: "flex items-center justify-between gap-2",
  title: "m-0 text-sm font-semibold text-[var(--fg-primary)]",
  list: "mt-2 grid gap-1.5",
  item: "grid min-w-0 grid-cols-[minmax(0,_1fr)_auto] items-center gap-2 rounded-[var(--radius-control)] !bg-[var(--vui-surface-base)] px-2 py-1.5",
