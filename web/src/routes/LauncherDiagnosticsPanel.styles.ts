...
const styles = {
  ...
  diagnosticsBody: "grid max-h-[min(42vh,420px)] min-h-0 min-w-0 grid-cols-2 gap-2 overflow-auto px-2.5 pb-2.5 pr-1 [scrollbar-gutter:stable] max-[620px]:grid-cols-[minmax(0,1fr)]",
