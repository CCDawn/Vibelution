...
const styles: Record<string, string> = {
  ...
  agentIndexCopy:
    "vui-routes-chatcodingroute agentIndexCopy grid min-w-0 gap-0.5 overflow-hidden text-left text-[var(--vui-font-xs)] leading-tight text-[var(--fg-secondary)]",
  agentIndexDetails:
  ...
  agentIndexNameLine:
    "vui-routes-chatcodingroute agentIndexNameLine !flex min-w-0 max-w-full items-center gap-1.5 text-[var(--vui-font-xs)] font-semibold leading-tight text-[var(--fg-primary)] [&_em]:shrink-0 [&_span]:min-w-0 [&_span]:truncate",
  agentIndexOpenButton:
    "vui-routes-chatcodingroute agentIndexOpenButton min-w-0 !grid min-h-[34px] !w-full max-w-full grid-cols-[30px_minmax(0,1fr)] items-center justify-start gap-1.5 overflow-hidden rounded-[var(--radius-control)] border border-transparent bg-transparent px-1 py-0.5 text-left text-[var(--vui-font-xs)] font-semibold leading-tight text-[var(--fg-secondary)] shadow-none hover:border-[color-mix(in_srgb,var(--accent-cool)_26%,var(--vui-border-subtle))] hover:bg-[color-mix(in_srgb,var(--accent-cool)_7%,var(--vui-surface-row))] hover:text-[var(--fg-primary)] disabled:cursor-default disabled:opacity-55 [&_[data-slot=vui-button-content]]:contents [&_[data-slot=vui-button-label]]:contents",
  agentIndexRoster:
  ...
  compactDetails:
    "vui-routes-chatcodingroute compactDetails grid min-w-0 max-h-[220px] gap-1 overflow-auto rounded-[var(--radius-control)] border border-[color-mix(in_srgb,var(--vui-border-subtle)_70%,transparent)] bg-[color-mix(in_srgb,var(--vui-surface-row)_34%,transparent)] px-1.5 py-1 text-[var(--vui-font-xs)] text-[var(--fg-secondary)] [scrollbar-gutter:stable] [&>summary]:grid [&>summary]:cursor-pointer [&>summary]:list-none [&>summary]:grid-cols-[14px_minmax(0,1fr)] [&>summary]:items-center [&>summary]:gap-1 [&>summary]:font-semibold [&>summary::-webkit-details-marker]:hidden [&>summary_svg]:transition-transform [&[open]>summary_svg]:rotate-90 [&_.compactDetailsOpenLabel]:hidden [&[open]_.compactDetailsOpenLabel]:inline [&[open]_.compactDetailsClosedLabel]:hidden",
  ...
  companionCopy:
    "vui-routes-chatcodingroute companionCopy grid min-w-0 gap-0.5 text-[var(--vui-font-xs)] leading-tight text-[var(--fg-secondary)] [&>p]:min-w-0 [&>p]:truncate",
  companionTopLine:
    "vui-routes-chatcodingroute companionTopLine !grid min-w-0 grid-cols-[minmax(0,1fr)_auto] items-baseline gap-1 text-[var(--vui-font-xs)] leading-tight [&_strong]:min-w-0 [&_strong]:truncate [&_span]:shrink-0 [&_span]:text-[var(--fg-tertiary)]",
  ...
  contextLineCompact:
    "vui-routes-chatcodingroute contextLineCompact min-w-0 rounded-[var(--radius-control)] border border-[color-mix(in_srgb,var(--accent-warm)_22%,transparent)] bg-[color-mix(in_srgb,var(--vui-surface-row)_42%,transparent)] px-1.5 py-1 text-[var(--fg-secondary)]",
  conversationAvatar:
  ...
  currentSessionLine:
    "vui-routes-chatcodingroute currentSessionLine min-w-0 rounded-[var(--radius-control)] border border-[color-mix(in_srgb,var(--accent-cool)_22%,transparent)] bg-[color-mix(in_srgb,var(--vui-surface-row)_42%,transparent)] px-1.5 py-1 text-[var(--vui-font-sm)] leading-snug text-[var(--fg-primary)]",
  ...
  groupComposerBar:
    "vui-routes-chatcodingroute groupComposerBar min-w-0 !grid grid-cols-[minmax(0,1fr)_auto_auto] items-center gap-2 border-t border-[var(--vui-border-subtle)] bg-[color-mix(in_srgb,var(--surface-panel)_70%,transparent)] p-2",
  groupComposerEmpty:
  ...
  groupConversationFrame:
    "vui-routes-chatcodingroute groupConversationFrame grid h-full min-h-0 min-w-0 grid-rows-[auto_minmax(0,1fr)_auto] overflow-hidden rounded-[var(--radius-panel)] border border-[var(--vui-border-subtle)] bg-[color-mix(in_srgb,var(--surface-panel)_78%,transparent)] shadow-[var(--vui-shadow-hairline)]",
  groupConversationHeader:
    "vui-routes-chatcodingroute groupConversationHeader min-w-0 !grid grid-cols-[minmax(0,1fr)_auto] items-start gap-2 border-b border-[var(--vui-border-subtle)] bg-[color-mix(in_srgb,var(--surface-panel)_74%,transparent)] px-2 py-2 [&_div]:grid [&_div]:min-w-0 [&_div]:gap-0.5 [&_h2]:m-0 [&_h2]:min-w-0 [&_h2]:truncate [&_h2]:text-[var(--vui-font-title)] [&_h2]:font-semibold [&_h2]:leading-tight [&_h2]:text-[var(--fg-primary)] [&_p]:m-0 [&_p]:truncate [&_p]:text-[10px] [&_p]:font-medium [&_p]:leading-tight [&_p]:text-[var(--fg-tertiary)] [&_span]:min-w-0 [&_span]:truncate [&_span]:text-[var(--vui-font-xs)] [&_span]:leading-tight [&_span]:text-[var(--fg-secondary)]",
  groupDeleteButton:
  ...
  groupEmptyState:
    "vui-routes-chatcodingroute groupEmptyState grid min-h-[min(420px,calc(100dvh_-_220px))] min-w-0 place-items-center px-6 text-center text-[var(--vui-font-xs)] leading-tight text-[var(--fg-tertiary)] [&_svg]:mb-2 [&_svg]:text-[var(--accent-cool)]",
  ...
  groupMemberChip:
    "vui-routes-chatcodingroute groupMemberChip min-w-0 !grid min-h-[34px] !w-full max-w-full grid-cols-[18px_26px_minmax(0,1fr)_auto] items-center gap-1.5 overflow-hidden rounded-[var(--radius-control)] border border-[var(--vui-border-subtle)] bg-[color-mix(in_srgb,var(--vui-surface-row)_76%,transparent)] px-1.5 py-1 text-left text-[var(--vui-font-xs)] font-semibold leading-tight text-[var(--fg-secondary)]",
  ...
  groupMemberCopy:
    "vui-routes-chatcodingroute groupMemberCopy grid min-w-0 gap-0.5 overflow-hidden text-left text-[var(--vui-font-xs)] leading-tight text-[var(--fg-secondary)] [&_small]:min-w-0 [&_small]:truncate [&_strong]:min-w-0 [&_strong]:truncate",
  groupMemberPicker:
  ...
  groupMessageTimeline:
    "vui-routes-chatcodingroute groupMessageTimeline min-w-0 grid min-h-0 content-start gap-2 overflow-auto p-2 text-[var(--vui-font-sm)] leading-[var(--vui-line-readable)] text-[var(--fg-secondary)] [scrollbar-gutter:stable]",
  groupModeSelect:
  ...
  inlineMetaPill:
    "vui-routes-chatcodingroute inlineMetaPill min-w-0 min-h-[22px] max-w-full rounded-[var(--radius-control)] border border-[color-mix(in_srgb,var(--vui-border-subtle)_68%,transparent)] bg-[color-mix(in_srgb,var(--vui-surface-row)_42%,transparent)] px-1.5 py-0.5 text-[11px] font-semibold leading-none text-[var(--fg-secondary)] !grid grid-cols-[minmax(58px,0.42fr)_minmax(0,1fr)] items-baseline gap-1 [&_span]:min-w-0 [&_span]:truncate [&_strong]:min-w-0 [&_strong]:truncate [&_strong]:whitespace-nowrap",
  inlineNotice:
  ...
  inlineStat:
    "vui-routes-chatcodingroute inlineStat min-w-0 !grid grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] items-baseline gap-0.5 text-[var(--vui-font-xs)] leading-tight [&_span]:min-w-0 [&_span]:truncate [&_span]:text-[var(--fg-tertiary)] [&_strong]:min-w-0 [&_strong]:truncate",
  inlineStatGrid:
  ...
  layout:
    "vui-routes-chatcodingroute layout min-w-0 grid !gap-0 !p-0 [--chat-workbench-gap:4px] h-[calc(100dvh_-_var(--shell-topbar-height))] max-h-[calc(100dvh_-_var(--shell-topbar-height))] overflow-hidden grid-cols-[var(--chat-left-pane-width,220px)_var(--chat-workbench-gap)_minmax(0,1fr)_var(--chat-workbench-gap)_var(--chat-right-pane-width,284px)] max-[1100px]:grid-cols-[var(--chat-left-pane-width,220px)_var(--chat-workbench-gap)_minmax(0,1fr)_var(--chat-workbench-gap)_var(--chat-right-pane-width,284px)]",
  layoutCenterFirst:
    "vui-routes-chatcodingroute layoutCenterFirst min-w-0 !gap-0 !p-0 !grid-cols-[minmax(0,var(--chat-left-pane-width,0px))_var(--chat-workbench-gap)_minmax(520px,1fr)_var(--chat-workbench-gap)_minmax(0,var(--chat-right-pane-width,0px))] max-[980px]:!grid-cols-[minmax(0,var(--chat-left-pane-width,0px))_var(--chat-workbench-gap)_minmax(420px,1fr)_var(--chat-workbench-gap)_minmax(0,var(--chat-right-pane-width,0px))] max-[640px]:!grid-cols-[minmax(0,var(--chat-left-pane-width,0px))_var(--chat-workbench-gap)_minmax(280px,1fr)_var(--chat-workbench-gap)_minmax(0,var(--chat-right-pane-width,0px))]",
  leftBlock:
    "vui-routes-chatcodingroute leftBlock min-w-0 grid shrink-0 gap-1.5 rounded-[var(--radius-panel)] border border-[color-mix(in_srgb,var(--vui-border-subtle)_70%,transparent)] bg-[color-mix(in_srgb,var(--vui-surface-glass)_58%,transparent)] p-1.5 shadow-[var(--vui-shadow-hairline)] backdrop-blur-[2px]",
  leftRail:
  ...
  petShowcaseAction:
    "vui-routes-chatcodingroute petShowcaseAction min-w-0 !grid min-h-[28px] !w-full grid-cols-[14px_minmax(0,1fr)] items-center gap-1 rounded-[var(--radius-control)] px-1.5 py-0 text-[var(--vui-font-xs)] [&_[data-slot=vui-button-content]]:contents [&_[data-slot=vui-button-label]]:contents [&_span]:min-w-0 [&_span]:truncate [&_svg]:shrink-0",
  ...
  petShowcaseActions:
    "vui-routes-chatcodingroute petShowcaseActions min-w-0 flex flex-wrap items-center gap-1.5 !grid grid-cols-[repeat(3,minmax(0,1fr))] gap-[4px]",
  petShowcaseAvatar:
  ...
  petShowcaseFeedback:
    "vui-routes-chatcodingroute petShowcaseFeedback min-w-0 rounded-[var(--radius-control)] border border-[color-mix(in_srgb,var(--accent-cool)_20%,transparent)] bg-[color-mix(in_srgb,var(--accent-cool)_6%,transparent)] px-1.5 py-1 text-[var(--vui-font-xs)] leading-tight text-[var(--fg-secondary)]",
  petShowcaseFootLeft:
  ...
  sectionMetaLine:
    "vui-routes-chatcodingroute sectionMetaLine min-w-0 truncate text-[var(--vui-font-xs)] leading-tight text-[var(--fg-tertiary)]",
  sectionTitle:
  ...
  tokenStatusMetric:
    "vui-routes-chatcodingroute tokenStatusMetric !grid min-h-[54px] !w-full grid-cols-[38px_minmax(0,1fr)] items-center justify-stretch gap-1.5 overflow-visible rounded-[var(--radius-control)] border border-[color-mix(in_srgb,var(--vui-border-subtle)_72%,transparent)] bg-[color-mix(in_srgb,var(--vui-control-muted)_72%,transparent)] px-1.5 py-1 text-left",
