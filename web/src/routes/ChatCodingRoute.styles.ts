...
const styles: Record<string, string> = {
  ...
  activeSkillIdentity:
    "vui-routes-chatcodingroute activeSkillIdentity grid min-w-0 gap-1 border-[color-mix(in_srgb,var(--accent-cool)_38%,transparent)] bg-[color-mix(in_srgb,var(--accent-cool)_11%,transparent)] text-[var(--accent-cool)] border-[color-mix(in_srgb,var(--accent-cool)_34%,transparent)] bg-[color-mix(in_srgb,var(--accent-cool)_10%,var(--vui-surface-row))] [&_strong]:min-w-0 [&_strong]:whitespace-normal [&_strong]:leading-tight [overflow-wrap:anywhere]",
  activeSkillMeta:
    "vui-routes-chatcodingroute activeSkillMeta min-w-0 flex flex-wrap items-center gap-1.5 border-[color-mix(in_srgb,var(--accent-cool)_38%,transparent)] bg-[color-mix(in_srgb,var(--accent-cool)_11%,transparent)] text-[var(--accent-cool)] border-[color-mix(in_srgb,var(--accent-cool)_34%,transparent)] bg-[color-mix(in_srgb,var(--accent-cool)_10%,var(--vui-surface-row))] [&_span]:min-w-0 [&_span]:whitespace-normal [overflow-wrap:anywhere]",
  activeSkillState:
  ...
  companionCopy:
    "vui-routes-chatcodingroute companionCopy grid min-w-0 gap-1 text-[var(--vui-font-sm)] leading-snug text-[var(--fg-secondary)] [&>p]:min-w-0 [&>p]:whitespace-normal [&>p]:leading-snug [&>p]:[overflow-wrap:anywhere]",
  companionTopLine:
    "vui-routes-chatcodingroute companionTopLine !grid min-w-0 grid-cols-[minmax(0,1fr)] items-start gap-0.5 text-[var(--vui-font-xs)] leading-tight [&_strong]:min-w-0 [&_strong]:whitespace-normal [&_span]:min-w-0 [&_span]:whitespace-normal [&_span]:text-[var(--fg-tertiary)] [overflow-wrap:anywhere]",
  ...
  contextLineCompact:
    "vui-routes-chatcodingroute contextLineCompact min-w-0 rounded-[var(--radius-control)] border border-[color-mix(in_srgb,var(--vui-border-strong)_58%,transparent)] bg-[var(--vui-surface-row)] px-1.5 py-1 text-[var(--fg-secondary)] whitespace-normal leading-snug shadow-none [overflow-wrap:anywhere]",
  conversationAvatar:
  ...
  currentSessionLine:
    "vui-routes-chatcodingroute currentSessionLine min-w-0 rounded-[var(--radius-control)] border border-[color-mix(in_srgb,var(--accent-cool)_22%,transparent)] bg-[color-mix(in_srgb,var(--vui-surface-row)_88%,transparent)] px-1.5 py-1 text-[var(--vui-font-sm)] leading-snug text-[var(--fg-primary)] whitespace-normal [overflow-wrap:anywhere]",
  ...
  inlineMetaPill:
    "vui-routes-chatcodingroute inlineMetaPill min-w-0 min-h-[24px] max-w-full rounded-[var(--radius-control)] border border-[color-mix(in_srgb,var(--vui-border-subtle)_68%,transparent)] bg-[color-mix(in_srgb,var(--vui-surface-row)_86%,transparent)] px-1.5 py-1 text-[11px] font-semibold leading-tight text-[var(--fg-secondary)] !grid grid-cols-[minmax(58px,0.42fr)_minmax(0,1fr)] items-baseline gap-1 [&_span]:min-w-0 [&_span]:whitespace-normal [&_strong]:min-w-0 [&_strong]:whitespace-normal [overflow-wrap:anywhere]",
  inlineNotice:
  ...
  inlineStat:
    "vui-routes-chatcodingroute inlineStat min-w-0 !grid grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] items-baseline gap-0.5 text-[var(--vui-font-xs)] leading-tight [&_span]:min-w-0 [&_span]:whitespace-normal [&_span]:text-[var(--fg-tertiary)] [&_strong]:min-w-0 [&_strong]:whitespace-normal [overflow-wrap:anywhere]",
  inlineStatGrid:
  ...
  leftBlock:
    "vui-routes-chatcodingroute leftBlock min-w-0 grid shrink-0 gap-1.5 rounded-[var(--radius-panel)] border border-[color-mix(in_srgb,var(--vui-border-strong)_66%,transparent)] !bg-[var(--vui-surface-rail)] p-1.5 shadow-none",
  leftRail:
  ...
  petShowcaseAction:
    "vui-routes-chatcodingroute petShowcaseAction min-w-0 !grid min-h-[30px] !w-full grid-cols-[14px_minmax(0,1fr)] items-center gap-1 rounded-[var(--radius-control)] px-1.5 py-1 text-[var(--vui-font-sm)] [&_[data-slot=vui-button-content]]:contents [&_[data-slot=vui-button-label]]:contents [&_span]:min-w-0 [&_span]:whitespace-normal [&_span]:leading-tight [&_span]:[overflow-wrap:anywhere] [&_svg]:shrink-0",
  ...
  petShowcaseFeedback:
    "vui-routes-chatcodingroute petShowcaseFeedback min-w-0 rounded-[var(--radius-control)] border border-[color-mix(in_srgb,var(--accent-cool)_20%,transparent)] bg-[color-mix(in_srgb,var(--accent-cool)_6%,transparent)] px-1.5 py-1 text-[var(--vui-font-sm)] leading-snug text-[var(--fg-secondary)]",
  petShowcaseFootLeft:
  ...
  sectionMetaLine:
    "vui-routes-chatcodingroute sectionMetaLine min-w-0 whitespace-normal text-[var(--vui-font-xs)] leading-tight text-[var(--fg-tertiary)] [overflow-wrap:anywhere]",
  sectionTitle:
  ...
  sessionItem:
    "vui-routes-chatcodingroute sessionItem relative grid min-w-0 grid-cols-[minmax(0,1fr)] gap-0 rounded-[var(--radius-control)] border border-transparent bg-transparent !px-1 !py-0.5 text-left transition-colors hover:border-[color-mix(in_srgb,var(--vui-border-strong)_54%,transparent)] hover:bg-[color-mix(in_srgb,var(--vui-surface-row-hover)_72%,transparent)] hover:shadow-[var(--vui-shadow-inset-accent)] focus-within:border-[color-mix(in_srgb,var(--vui-border-strong)_54%,transparent)] focus-within:bg-[color-mix(in_srgb,var(--vui-surface-row-hover)_72%,transparent)] focus-within:shadow-[var(--vui-shadow-inset-accent)]",
  sessionItemActive:
    "vui-routes-chatcodingroute sessionItemActive border-[color-mix(in_srgb,var(--accent-cool)_34%,var(--vui-border-strong))] bg-[color-mix(in_srgb,var(--accent-cool)_8%,var(--vui-surface-row-hover))] shadow-[var(--vui-shadow-inset-accent)]",
  sessionItemContextTarget:
    "vui-routes-chatcodingroute sessionItemContextTarget border-[color-mix(in_srgb,var(--accent-cool)_28%,var(--vui-border-strong))] bg-[color-mix(in_srgb,var(--accent-cool)_6%,var(--vui-surface-row-hover))] shadow-[var(--vui-shadow-inset-accent)]",
  sessionItemError:
  ...
  tokenStatusBar:
    "vui-routes-chatcodingroute tokenStatusBar relative mt-1 block h-1 overflow-hidden rounded-full bg-[color-mix(in_srgb,var(--vui-border-subtle)_78%,transparent)] [&>span]:block [&>span]:h-full [&>span]:rounded-full [&>span]:bg-[var(--accent-cool)] [&>span]:w-[calc(var(--token-status-value)*1%)]",
  tokenStatusCopy:
    "vui-routes-chatcodingroute tokenStatusCopy grid min-w-0 gap-0.5 overflow-visible [overflow-wrap:anywhere]",
  tokenStatusLabel:
    "vui-routes-chatcodingroute tokenStatusLabel block min-w-0 max-w-full whitespace-normal text-[12px] font-semibold leading-[1.2] text-vui-fg-primary",
  tokenStatusMeta:
    "vui-routes-chatcodingroute tokenStatusMeta block min-w-0 max-w-full whitespace-normal text-[11px] leading-[1.25] text-vui-fg-secondary [overflow-wrap:anywhere]",
  tokenStatusMetric:
    "vui-routes-chatcodingroute tokenStatusMetric !grid min-h-[52px] !w-full grid-cols-[36px_minmax(0,1fr)] items-center justify-stretch gap-1.5 overflow-visible rounded-[var(--radius-control)] border border-[color-mix(in_srgb,var(--vui-border-strong)_60%,transparent)] bg-[var(--vui-surface-raised)] px-2 py-1.5 text-left shadow-none",
  ...
  tokenStatusRing:
    "vui-routes-chatcodingroute tokenStatusRing relative size-[36px] shrink-0 rounded-full bg-[conic-gradient(var(--accent-cool)_calc(var(--token-status-value)*1%),var(--vui-border-subtle)_0)]",
  tokenStatusRingCore:
    "vui-routes-chatcodingroute tokenStatusRingCore absolute inset-[5px] grid place-items-center rounded-full bg-[var(--vui-surface-panel)] text-[10px] font-bold leading-none text-vui-fg-primary",
