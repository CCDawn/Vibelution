...
const filePathClass = "m-0 mt-1 break-all text-[var(--vui-font-xs)] leading-[1.35] text-vui-fg-secondary";
const summaryClass = "m-0 mt-1 break-all text-[var(--vui-font-xs)] leading-[1.35] text-vui-fg-tertiary";
const metaBlockClass = "flex flex-wrap justify-end gap-1.5 max-[640px]:justify-start";
const pillClass = "inline-flex min-h-6 items-center whitespace-nowrap rounded-full px-2 text-[var(--vui-font-xs)]";
...
const diffTableClass = "w-max min-w-full py-1.5 font-[var(--font-mono)] text-[var(--vui-font-xs)] leading-[1.42]";
...
const footnoteClass = "m-0 border-t border-vui-border-hairline px-3.5 pb-2.5 pt-2 text-[var(--vui-font-xs)] text-vui-fg-tertiary";
