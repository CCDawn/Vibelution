...
const surfaceClass = `grid h-full min-h-0 grid-rows-[auto_minmax(0,1fr)_auto] overflow-hidden ${vuiFlatPanelClass}`;
...
const diffWrapClass = `min-h-0 overflow-auto ${vuiWorkspaceFillClass}`;
...
const columnHeaderClass = `sticky top-0 z-[2] border-b border-vui-border-hairline ${vuiToolbarFillClass} text-vui-fg-tertiary`;
