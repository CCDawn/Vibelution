...
/** Recipe host — fill geometry owned by VDenseOpsPage / VWorkbenchPage. */
const pageClass = "min-h-0 min-w-0 text-vui-fg-primary";
const headerClass =
  `mx-[var(--route-workspace-padding)] mt-[var(--route-workspace-padding)] min-w-0 max-w-full ${vuiFlatPanelClass}`;
const bodyClass =
