const pageClass = "grid h-full min-h-0 min-w-0 content-start gap-1.5 overflow-auto p-[var(--route-workspace-padding)]";
const surfaceClass = "min-w-0 rounded-[var(--radius-panel)] border border-vui-border-soft bg-[color-mix(in_srgb,var(--vui-surface-panel)_54%,transparent)]";
...
const avatarPanelClass = "inline-flex max-w-full min-w-0 items-center gap-[7px] rounded-[var(--radius-control)] bg-[color-mix(in_srgb,var(--vui-surface-row)_72%,transparent)] px-2 py-1.5";
...
const metricLabelClass = "min-w-0 truncate text-[var(--vui-font-xs)] text-vui-fg-secondary";
...
const progressTrackClass = "h-1.5 overflow-hidden rounded-[var(--radius-control)] bg-[color-mix(in_srgb,var(--vui-surface-row)_72%,transparent)]";
...
const badgeClass = "max-w-full truncate rounded-[var(--radius-control)] bg-[color-mix(in_srgb,var(--accent-cool)_12%,transparent)] px-[7px] py-1 text-[var(--vui-font-xs)] text-[var(--accent-cool)]";
