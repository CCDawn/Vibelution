...
const surfaceClass = "min-w-0 rounded-lg border border-vui-border-soft bg-[color-mix(in_srgb,var(--surface-panel)_54%,transparent)]";
...
const avatarPanelClass = "inline-flex max-w-full min-w-0 items-center gap-[7px] rounded-lg bg-[color-mix(in_srgb,var(--surface-panel-strong)_46%,transparent)] px-2 py-1.5";
...
const progressTrackClass = "h-1.5 overflow-hidden rounded-[var(--radius-control)] bg-[color-mix(in_srgb,var(--surface-panel-strong)_46%,transparent)]";
