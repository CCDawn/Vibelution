...
const styles = {
  ...
  configDeepLinkRow: "flex [justify-content:flex-start] [gap:6px] min-w-0 [flex-wrap:wrap] [&_[data-vui=\"button\"]]:[max-width:100%] [&_[data-vui=\"button\"]]:w-fit [&_[data-vui=\"button\"]]:[white-space:nowrap]",
