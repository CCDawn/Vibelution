const styles = {
  ...
  state: "grid min-h-[184px] place-items-center rounded-[var(--radius-control)] border border-dashed border-[color-mix(in_srgb,var(--vui-border-subtle)_82%,transparent)] bg-[color-mix(in_srgb,var(--vui-surface-base)_38%,transparent)] p-4 text-center",
