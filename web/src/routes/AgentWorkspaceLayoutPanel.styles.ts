const styles = {
  workspace:
    "grid h-full min-h-0 [grid-template-columns:clamp(320px,_18vw,_360px)_minmax(0,_1fr)] [gap:var(--agent-density-gap)] [padding:6px_10px_9px] max-[860px]:[grid-template-columns:1fr] max-[860px]:[align-content:start] max-[860px]:[overflow:auto]",
  directory:
