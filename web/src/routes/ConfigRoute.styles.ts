...
const styles = {
  ...
  advancedEditorPanel:
    "vui-routes-configroute advancedEditorPanel [display:grid] [gap:6px] [padding:7px] [border:1px_solid_var(--border-hairline)] [border-radius:7px] [background:var(--surface-card-subtle)] [&_summary]:[display:grid] [&_summary]:[gap:3px] [&_summary]:[cursor:pointer] [&_summary]:[color:var(--fg-primary)] [&_summary]:[font-weight:700] [&_summary_small]:[color:var(--fg-tertiary)] [&_summary_small]:[font-size:var(--vui-font-xs)] [&_summary_small]:[font-weight:500] [&_summary_small]:[line-height:1.35] [&[open]_summary]:[padding-bottom:6px]",
  agentRunItem:
    "vui-routes-configroute agentRunItem [display:grid] [grid-template-columns:minmax(150px,0.3fr)_minmax(0,1fr)_minmax(90px,auto)] [align-items:start] [gap:10px] [padding:9px] [border:1px_solid_var(--border-hairline)] [border-radius:8px] [background:var(--surface-card-subtle)] [&_div]:[display:grid] [&_div]:[gap:3px] [&_div]:[min-width:0] [&_strong]:[min-width:0] [&_strong]:[overflow-wrap:anywhere] [&_p]:[min-width:0] [&_p]:[overflow-wrap:anywhere] [&_small]:[min-width:0] [&_small]:[overflow-wrap:anywhere] [&_span]:[min-width:0] [&_span]:[overflow-wrap:anywhere] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_p]:[margin:0] [&_p]:[color:var(--fg-secondary)] [&_p]:[font-size:var(--vui-font-xs)] [&_span]:[color:var(--fg-tertiary)] [&_span]:[font-size:var(--vui-font-xs)] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)] max-[760px]:[grid-template-columns:1fr]",
  agentRunList:
  ...
  avatarCropFrame:
    "vui-routes-configroute avatarCropFrame [position:relative] [overflow:hidden] [border:1px_solid_color-mix(in_srgb,var(--accent-cool)_34%,transparent)] [background:var(--vui-gradient-route-soft),var(--vui-gradient-route-soft),var(--vui-gradient-route-soft),var(--vui-gradient-route-soft),var(--surface-card)] [background-size:18px_18px] [background-position:0_0,0_9px,9px_-9px,-9px_0] [width:min(100%,320px)] [aspect-ratio:1] [border-radius:8px] [cursor:grab] [touch-action:none] [&:active]:[cursor:grabbing]",
  avatarCropHeader:
  ...
  avatarCropPanel:
    "vui-routes-configroute avatarCropPanel [display:grid] [gap:10px] [padding:10px] [border:1px_solid_var(--border-hairline)] [border-radius:8px] [background:color-mix(in_srgb,var(--surface-card)_86%,transparent)]",
  avatarCropPreview:
    "vui-routes-configroute avatarCropPreview [position:relative] [overflow:hidden] [border:1px_solid_color-mix(in_srgb,var(--accent-cool)_34%,transparent)] [background:var(--vui-gradient-route-soft),var(--vui-gradient-route-soft),var(--vui-gradient-route-soft),var(--vui-gradient-route-soft),var(--surface-card)] [background-size:18px_18px] [background-position:0_0,0_9px,9px_-9px,-9px_0] [width:112px] [height:112px] [border-radius:999px]",
  avatarCropPreviewWrap:
    "vui-routes-configroute avatarCropPreviewWrap [display:grid] [justify-items:center] [gap:6px]",
  avatarCropWorkspace:
    "vui-routes-configroute avatarCropWorkspace [display:grid] [grid-template-columns:minmax(220px,320px)_minmax(92px,120px)] [align-items:center] [gap:14px]",
  avatarCropZoomField:
  ...
  avatarImageEditor:
    "vui-routes-configroute avatarImageEditor [display:grid] [gap:10px]",
  avatarImageMeta:
  ...
  avatarImagePlaceholder:
    "vui-routes-configroute avatarImagePlaceholder [width:56px] [height:56px] [flex:0_0_auto] [border-radius:999px] [border:1px_solid_var(--border-hairline)] [background:var(--surface-card)] [display:grid] [place-items:center] [color:var(--fg-tertiary)]",
  avatarImagePreview:
    "vui-routes-configroute avatarImagePreview [width:56px] [height:56px] [flex:0_0_auto] [border-radius:999px] [border:1px_solid_var(--border-hairline)] [background:var(--surface-card)] [object-fit:cover]",
  avatarImageUploadCue:
    "vui-routes-configroute avatarImageUploadCue [position:absolute] [right:-1px] [bottom:-1px] [display:grid] [place-items:center] [width:20px] [height:20px] [border:1px_solid_var(--border-hairline)] [border-radius:999px] [background:color-mix(in_srgb,var(--surface-panel-strong)_86%,transparent)] [color:var(--fg-primary)] [box-shadow:var(--vui-shadow-soft)]",
  avatarImageValue:
    "vui-routes-configroute avatarImageValue [display:flex] [align-items:center] [gap:8px] [min-width:0] [color:var(--fg-secondary)] [font-size:var(--vui-font-xs)] [overflow-wrap:anywhere]",
  buttonBlock:
    "vui-routes-configroute buttonBlock [width:100%]",
  cardBadges:
  ...
  cardSummaryLine:
    "vui-routes-configroute cardSummaryLine [display:flex] [align-items:center] [gap:6px] [flex-wrap:wrap] [color:var(--fg-tertiary)] [font-size:var(--vui-font-xs)] [min-width:0] [&_span]:[min-width:0] [&_span]:[max-width:100%] [&_span]:[padding:3px_7px] [&_span]:[border:1px_solid_var(--border-hairline)] [&_span]:[border-radius:999px] [&_span]:[background:var(--surface-card-subtle)] [&_span]:[overflow:hidden] [&_span]:[text-overflow:ellipsis] [&_span]:[white-space:nowrap]",
  cardTitle:
  ...
  configDenseSection:
    "vui-routes-configroute configDenseSection [&>_.treeGrid]:[grid-template-columns:repeat(auto-fit,minmax(186px,1fr))] [&>_.treeGrid]:[gap:5px] [&_.treeFieldCardView]:[grid-template-columns:minmax(92px,0.42fr)_minmax(0,1fr)] [&_.treeFieldCardView]:[gap:3px_6px] [&_.treeFieldCardView]:[min-height:30px] [&_.treeFieldCardView]:[padding:5px] [&_.treeFieldCardEdit]:[gap:4px] [&_.treeFieldCardEdit]:[padding:6px] [&_.treeObjectCell_.treeObjectBlock]:[min-height:36px] [&_.treeObjectCell_.treeObjectBlock]:[padding:6px] [&_.treeObjectCell_.treeNestedBlock]:[min-height:36px] [&_.treeObjectCell_.treeNestedBlock]:[padding:6px] [&_.treeObjectCell_.treeToggle]:[min-height:28px]",
  configDiscoverySection:
    "vui-routes-configroute configDiscoverySection [align-self:end] [min-height:0] [&>_.treeGrid]:[align-content:start] [&>_.treeGrid]:[grid-template-columns:repeat(6,minmax(128px,1fr))] [&>_.treeGrid]:[gap:6px] [&_.treeFieldCardView]:[grid-template-columns:minmax(108px,0.42fr)_minmax(0,1fr)] [&_.treeFieldCardView]:[min-height:38px] [&_.treeFieldCardView]:[padding:5px_6px] [&_.treeFieldLabel]:[overflow:hidden] [&_.treeFieldLabel]:[text-overflow:ellipsis] [&_.treeFieldLabel]:[white-space:nowrap] [&_.treeFieldValue]:[overflow:hidden] [&_.treeFieldValue]:[text-overflow:ellipsis] [&_.treeFieldValue]:[white-space:nowrap] max-[1380px]:[&>_.treeGrid]:[grid-template-columns:repeat(3,minmax(180px,1fr))] max-[1120px]:[&>_.treeGrid]:[grid-template-columns:repeat(auto-fit,minmax(190px,1fr))] max-[720px]:[min-height:0]",
  configEditorSection:
  ...
  field:
    "vui-routes-configroute field [display:grid] [gap:4px] [&_span]:[overflow-wrap:anywhere] [&>_span]:[color:var(--fg-tertiary)] [&>_span]:[font-size:var(--vui-font-xs)] [&_input]:[width:100%] [&_input]:[min-width:0] [&_input]:[border:1px_solid_var(--border-soft)] [&_input]:[border-radius:var(--control-radius)] [&_input]:[background:var(--surface-input)] [&_input]:[color:var(--fg-primary)] [&_input]:[padding:6px_8px] [&_input]:[font:inherit] [&_input]:[font-size:var(--vui-font-xs)] [&_select]:[width:100%] [&_select]:[min-width:0] [&_select]:[border:1px_solid_var(--border-soft)] [&_select]:[border-radius:var(--control-radius)] [&_select]:[background:var(--surface-input)] [&_select]:[color:var(--fg-primary)] [&_select]:[padding:6px_8px] [&_select]:[font:inherit] [&_select]:[font-size:var(--vui-font-xs)] [&_textarea]:[width:100%] [&_textarea]:[min-width:0] [&_textarea]:[border:1px_solid_var(--border-soft)] [&_textarea]:[border-radius:var(--control-radius)] [&_textarea]:[background:var(--surface-input)] [&_textarea]:[color:var(--fg-primary)] [&_textarea]:[padding:6px_8px] [&_textarea]:[font:inherit] [&_textarea]:[font-size:var(--vui-font-xs)] [&_input]:[min-height:var(--control-height)] [&_select]:[min-height:var(--control-height)]",
  fieldHint:
  ...
  findingCard:
    "vui-routes-configroute findingCard [border:1px_solid_var(--border-hairline)] [border-radius:8px] [background:var(--surface-card-muted)] [display:grid] [gap:10px] [padding:12px]",
  findingEvidence:
    "vui-routes-configroute findingEvidence [display:grid] [grid-template-columns:repeat(2,minmax(0,1fr))] [gap:8px] [&_span]:[min-width:0] [&_span]:[padding:9px] [&_span]:[border:1px_solid_var(--border-hairline)] [&_span]:[border-radius:8px] [&_span]:[background:var(--surface-card-subtle)] [&_span]:[display:grid] [&_span]:[gap:4px] [&_span]:[color:var(--fg-primary)] [&_span]:[font-size:var(--vui-font-xs)] [&_span]:[overflow-wrap:anywhere] [&_strong]:[color:var(--fg-tertiary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_strong]:[font-weight:600] [&_strong]:[text-transform:uppercase] [&_strong]:[letter-spacing:0.06em] max-[720px]:[grid-template-columns:1fr]",
  findingHeader:
  ...
  findingRecommendation:
    "vui-routes-configroute findingRecommendation [min-width:0] [padding:9px] [border:1px_solid_var(--border-hairline)] [border-radius:8px] [background:var(--surface-card-subtle)] [&_strong]:[color:var(--fg-tertiary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_strong]:[font-weight:600] [&_strong]:[text-transform:uppercase] [&_strong]:[letter-spacing:0.06em] [display:grid] [gap:5px] [margin:0] [color:var(--fg-secondary)] [font-size:var(--vui-font-xs)]",
  formActions:
  ...
  inlineBadge:
    "vui-routes-configroute inlineBadge [display:inline-flex] [align-items:center] [justify-content:center] [min-height:24px] [padding:0_8px] [border-radius:999px] [border:1px_solid_transparent] [font-size:var(--vui-font-xs)] [white-space:nowrap] [color:var(--fg-secondary)] [background:var(--surface-card-muted)]",
  inlineBadgeMuted:
    "vui-routes-configroute inlineBadgeMuted [color:var(--fg-tertiary)] [background:var(--surface-card-subtle)] [border-color:var(--border-hairline)]",
  inlineBadgeSuccess:
  ...
  loadingMetricGrid:
    "vui-routes-configroute loadingMetricGrid [&_strong]:[display:block] [&_strong]:[border-radius:6px] [&_strong]:[background:var(--vui-gradient-route-soft)] [display:grid] [grid-template-columns:repeat(4,minmax(0,1fr))] [gap:7px] [&_span]:[display:grid] [&_span]:[gap:5px] [&_span]:[min-height:54px] [&_span]:[padding:8px] [&_span]:[border:1px_solid_var(--border-hairline)] [&_span]:[border-radius:8px] [&_span]:[background:var(--surface-card-subtle)] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)] [&_small]:[text-transform:uppercase] [&_strong]:[min-height:16px]",
  loadingNavActive:
  ...
  logHelperMetaGrid:
    "vui-routes-configroute logHelperMetaGrid [display:grid] [grid-template-columns:repeat(4,minmax(0,1fr))] [gap:8px] [&_span]:[min-width:0] [&_span]:[padding:10px] [&_span]:[border:1px_solid_var(--border-hairline)] [&_span]:[border-radius:8px] [&_span]:[background:var(--surface-card-subtle)] [&_span]:[display:grid] [&_span]:[gap:4px] [&_span]:[color:var(--fg-tertiary)] [&_span]:[font-size:var(--vui-font-xs)] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:0.9rem] [&_strong]:[overflow-wrap:anywhere] max-[720px]:[grid-template-columns:1fr]",
  logHelperSignal:
  ...
  modelCenterSummaryBar:
    "vui-routes-configroute modelCenterSummaryBar [display:flex] [align-items:center] [gap:5px] [flex-wrap:wrap] [margin:6px_var(--config-section-x)_0] [&_span]:[display:inline-flex] [&_span]:[align-items:center] [&_span]:[gap:4px] [&_span]:[min-height:25px] [&_span]:[padding:0_8px] [&_span]:[border:1px_solid_var(--border-hairline)] [&_span]:[border-radius:999px] [&_span]:[background:var(--surface-card-muted)] [&_span]:[color:var(--fg-tertiary)] [&_span]:[font-size:var(--vui-font-xs)] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_.summaryBarWarning]:[border-color:color-mix(in_srgb,var(--state-warning)_34%,var(--border-hairline))] [&_.summaryBarWarning]:[color:var(--state-warning)] [&_.summaryBarWarning_strong]:[color:var(--state-warning)]",
  modelInventoryTable:
  ...
  modelLibraryTestBar:
    "vui-routes-configroute modelLibraryTestBar [display:flex] [align-items:end] [gap:8px] [flex-wrap:wrap] [padding:8px_10px] [border:1px_solid_var(--border-hairline)] [border-radius:8px] [background:var(--surface-card-muted)]",
  ...
  notice:
    "vui-routes-configroute notice [margin:0] [color:var(--fg-secondary)] [line-height:1.38] [padding:7px_9px] [border-radius:8px] [border:1px_solid_var(--border-hairline)] [background:var(--surface-card-muted)]",
  noticeError:
  ...
  profileTableWrap:
    "vui-routes-configroute profileTableWrap [width:100%] [overflow-x:auto] [border:1px_solid_var(--border-hairline)] [border-radius:7px] [background:var(--surface-card-muted)] [scrollbar-gutter:stable]",
  profileTaskCell:
  ...
  quickActionItem:
    "vui-routes-configroute quickActionItem [border:1px_solid_var(--border-hairline)] [border-radius:8px] [background:var(--surface-card-muted)] [display:grid] [grid-template-columns:minmax(0,1fr)_auto] [align-items:center] [gap:10px] [padding:11px] [color:inherit] [text-decoration:none] hover:[border-color:color-mix(in_srgb,var(--accent-warm)_32%,transparent)] hover:[background:var(--surface-card-hover)] [&_div]:[display:grid] [&_div]:[gap:6px] [&_div]:[min-width:0] [&_strong]:[overflow-wrap:anywhere] [&_small]:[overflow-wrap:anywhere] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:0.9rem] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)] [&_small]:[line-height:1.45]",
  quickActionList:
    "vui-routes-configroute quickActionList [display:grid] [gap:10px]",
  rawConfigPanel:
    "vui-routes-configroute rawConfigPanel [&_p]:[margin:0] [&_p]:[color:var(--fg-secondary)] [&_p]:[line-height:1.38] [display:grid] [gap:6px] [padding:7px_8px] [border:1px_solid_var(--border-hairline)] [border-radius:7px] [background:var(--surface-card-muted)] [&_summary]:[cursor:pointer] [&_summary]:[color:var(--fg-primary)] [&_summary]:[font-weight:600]",
  rawToml:
    "vui-routes-configroute rawToml [overflow:auto] [overflow-wrap:anywhere] [font-family:Consolas,'SFMono-Regular',monospace] [font-size:var(--vui-font-xs)] [margin:0] [padding:8px] [border:1px_solid_var(--border-hairline)] [border-radius:8px] [background:var(--surface-code)] [color:var(--fg-secondary)] [line-height:1.55]",
  readonlyCodeField:
    "vui-routes-configroute readonlyCodeField [display:flex] [align-items:center] [min-height:var(--control-height)] [width:100%] [min-width:0] [padding:6px_8px] [border:1px_solid_var(--border-hairline)] [border-radius:var(--control-radius)] [background:var(--surface-code)] [color:var(--fg-secondary)] [font-family:var(--font-mono)] [font-size:var(--vui-font-xs)] [line-height:1.25] [overflow-wrap:anywhere]",
  returnButton:
  ...
  sectionHeaderMeta:
    "vui-routes-configroute sectionHeaderMeta [display:inline-flex] [align-items:center] [gap:6px] [min-height:30px] [padding:0_8px] [border:1px_solid_var(--border-hairline)] [border-radius:999px] [background:var(--surface-card-subtle)]",
  ...
  sidebarResizeCorner:
    "vui-routes-configroute sidebarResizeCorner [position:absolute] [z-index:3] [opacity:0.34] [transition:opacity_140ms_ease,background-color_140ms_ease] hover:[opacity:0.88] hover:[background:color-mix(in_srgb,var(--accent-warm)_20%,transparent)] [right:0] [bottom:0] [width:18px] [height:18px] [cursor:nwse-resize] [border-radius:999px_0_8px_0] [background:color-mix(in_srgb,var(--surface-card)_8%,transparent)] max-[1120px]:[display:none]",
  sidebarResizeX:
  ...
  statusBadge:
    "vui-routes-configroute statusBadge [display:inline-flex] [align-items:center] [justify-content:center] [min-height:24px] [padding:0_8px] [border-radius:999px] [border:1px_solid_transparent] [font-size:var(--vui-font-xs)] [white-space:nowrap] [color:var(--fg-secondary)] [background:var(--surface-card-muted)]",
  statusBadgePending:
  ...
  themeBackgroundDropButton:
    "vui-routes-configroute themeBackgroundDropButton [position:relative] [display:block] [min-width:0] [border-radius:6px] [cursor:pointer] [&:hover_.themeBackgroundImagePreview]:[border-color:color-mix(in_srgb,var(--accent-warm)_34%,var(--border-hairline))] [&:hover_.themeBackgroundImagePreview]:[background:color-mix(in_srgb,var(--accent-warm)_9%,var(--surface-card))] [&:hover_.themeBackgroundImagePlaceholder]:[border-color:color-mix(in_srgb,var(--accent-warm)_34%,var(--border-hairline))] [&:hover_.themeBackgroundImagePlaceholder]:[background:color-mix(in_srgb,var(--accent-warm)_9%,var(--surface-card))] [&_input]:[position:absolute] [&_input]:[inset:0] [&_input]:[opacity:0] [&_input]:[pointer-events:none]",
  ...
  themeBackgroundImageEditor:
    "vui-routes-configroute themeBackgroundImageEditor [display:grid] [grid-template-columns:minmax(260px,0.34fr)_minmax(420px,1fr)] [gap:12px] [align-items:start] max-[720px]:[grid-template-columns:1fr]",
  ...
  themeBackgroundImagePlaceholder:
    "vui-routes-configroute themeBackgroundImagePlaceholder [width:100%] [aspect-ratio:16/9] [min-height:104px] [border:1px_solid_var(--border-hairline)] [border-radius:6px] [background:var(--surface-card)] [display:grid] [place-items:center] [color:var(--fg-tertiary)]",
  themeBackgroundImagePreview:
    "vui-routes-configroute themeBackgroundImagePreview [width:100%] [aspect-ratio:16/9] [min-height:104px] [border:1px_solid_var(--border-hairline)] [border-radius:6px] [background:var(--surface-card)] [object-fit:cover]",
  themeBackgroundImageValue:
    "vui-routes-configroute themeBackgroundImageValue [display:grid] [grid-template-columns:1fr] [align-items:start] [gap:7px] [min-width:0] [color:var(--fg-secondary)] [font-size:var(--vui-font-xs)] [overflow-wrap:anywhere] max-[720px]:[grid-template-columns:1fr]",
  themeBackgroundPresetButton:
    "vui-routes-configroute themeBackgroundPresetButton [position:relative] [display:grid] [grid-template-rows:minmax(68px,auto)_auto] [gap:6px] [min-width:0] [min-height:0] [padding:6px] [border:1px_solid_var(--border-hairline)] [border-radius:6px] [background:color-mix(in_srgb,var(--surface-card)_82%,transparent)] [color:var(--fg-secondary)] [cursor:pointer] [text-align:left] hover:[border-color:color-mix(in_srgb,var(--accent-warm)_36%,var(--border-hairline))] hover:[background:color-mix(in_srgb,var(--accent-warm)_9%,var(--surface-card))] disabled:[cursor:not-allowed] disabled:[opacity:0.6] [&[data-active='true']]:[border-color:color-mix(in_srgb,var(--accent-warm)_62%,var(--border-strong))] [&[data-active='true']]:[background:color-mix(in_srgb,var(--accent-warm)_12%,var(--surface-card))] [&[data-active='true']]:[box-shadow:var(--vui-shadow-inset-accent)] [&_img]:[width:100%] [&_img]:[aspect-ratio:16/9] [&_img]:[height:auto] [&_img]:[border-radius:4px] [&_img]:[object-fit:cover] [&>_span]:[min-width:0] [&>_span]:[overflow:hidden] [&>_span]:[color:var(--fg-secondary)] [&>_span]:[font-size:var(--vui-font-xs)] [&>_span]:[font-weight:700] [&>_span]:[line-height:1.2] [&>_span]:[text-overflow:ellipsis] [&>_span]:[white-space:nowrap] [&>_em]:[position:absolute] [&>_em]:[top:9px] [&>_em]:[right:9px] [&>_em]:[padding:2px_6px] [&>_em]:[border:1px_solid_color-mix(in_srgb,var(--accent-warm)_40%,transparent)] [&>_em]:[border-radius:999px] [&>_em]:[background:color-mix(in_srgb,var(--surface-panel-strong)_74%,transparent)] [&>_em]:[color:var(--fg-primary)] [&>_em]:[font-size:var(--vui-font-xs)] [&>_em]:[font-style:normal] [&>_em]:[font-weight:800] [&>_em]:[line-height:1.2]",
  ...
  treeFieldCard:
    "vui-routes-configroute treeFieldCard [border:1px_solid_var(--border-hairline)] [border-radius:7px] [background:var(--surface-card-muted)] [display:grid] [gap:4px] [padding:6px]",
  treeFieldCardEdit:
    "vui-routes-configroute treeFieldCardEdit [align-content:start] [gap:5px] [padding:7px_8px]",
  treeFieldCardView:
    "vui-routes-configroute treeFieldCardView [grid-template-columns:minmax(124px,0.25fr)_minmax(0,1fr)] [align-items:start] [gap:4px_8px] [min-height:34px] [padding:6px] [&_.treeFieldHead]:[min-width:0] [&_.treeFieldHead]:[justify-content:start] [&_.treeFieldHead]:[gap:5px] [&_.treeFieldLabel]:[overflow:hidden] [&_.treeFieldLabel]:[text-overflow:ellipsis] [&_.treeFieldLabel]:[white-space:nowrap] [&_.treeHint]:[display:-webkit-box] [&_.treeHint]:[overflow:hidden] [&_.treeHint]:[-webkit-box-orient:vertical] [&_.treeHint]:[grid-column:1/-1] [&_.treeHint]:[grid-row:2] [&_.treeHint]:[-webkit-line-clamp:2] [&_.treeFieldValue]:[grid-column:2] [&_.treeFieldValue]:[grid-row:1] [&_.treeFieldValue]:[min-width:0] [&_.treeFieldValue]:[width:100%] [&_.treeFieldValue]:[padding:5px_7px] [&_.treeFieldValue]:[border:1px_solid_var(--border-hairline)] [&_.treeFieldValue]:[border-radius:6px] [&_.treeFieldValue]:[background:color-mix(in_srgb,var(--surface-code)_58%,var(--surface-card-muted))] [&_.treeFieldValue]:[font-family:var(--font-mono)] max-[720px]:[grid-template-columns:1fr] max-[720px]:[&_.treeFieldValue]:[grid-column:1] max-[720px]:[&_.treeFieldValue]:[grid-row:auto]",
  treeFieldHead:
  ...
  treeFieldValue:
    "vui-routes-configroute treeFieldValue [color:var(--fg-secondary)] [overflow-wrap:anywhere] [line-height:1.34] [font-size:var(--vui-font-xs)]",
  treeGrid:
    "vui-routes-configroute treeGrid [display:grid] [gap:6px] [grid-template-columns:repeat(auto-fit,minmax(260px,1fr))] [align-items:start] max-[1120px]:[grid-template-columns:repeat(auto-fit,minmax(210px,1fr))] max-[720px]:[grid-template-columns:1fr]",
  treeHint:
    "vui-routes-configroute treeHint [margin:0] [color:var(--fg-tertiary)] [font-size:var(--vui-font-xs)] [line-height:1.35]",
  treeNestedBlock:
    "vui-routes-configroute treeNestedBlock [border:1px_solid_var(--border-hairline)] [border-radius:7px] [background:var(--surface-card-muted)] [display:grid] [gap:5px] [padding:7px]",
  treeNestedHeader:
  ...
  treeObjectBlock:
    "vui-routes-configroute treeObjectBlock [border:1px_solid_var(--border-hairline)] [border-radius:7px] [background:var(--surface-card-muted)] [display:grid] [gap:5px] [padding:7px]",
  treeObjectCell:
  ...
  userProfileAvatarFields:
    "vui-routes-configroute userProfileAvatarFields [display:grid] [gap:6px] [min-width:0] [grid-template-columns:minmax(210px,0.4fr)_minmax(320px,0.6fr)] [&_.treeFieldCardView_.treeHint]:[display:none] max-[720px]:[grid-template-columns:1fr]",
