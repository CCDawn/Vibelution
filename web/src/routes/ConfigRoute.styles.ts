...
const styles = {
  ...
  page:
    "vui-routes-configroute page [--control-height:36px] [--vui-control-height-sm:36px] [--control-radius:var(--radius-control)] [--config-row-gap:10px] [--config-section-x:12px] [--config-section-y:10px] [--config-settings-nav-width:clamp(15rem,16vw,17.5rem)] [display:grid] [grid-template-columns:var(--config-settings-nav-width)_auto_minmax(0,1fr)] [grid-template-rows:minmax(0,1fr)] [gap:0] [height:100%] [min-height:0] [padding:0] [overflow:hidden] [isolation:isolate] [background:var(--vui-surface-workspace)] max-[720px]:[grid-template-columns:1fr] max-[720px]:[grid-template-rows:auto_minmax(0,1fr)] max-[720px]:[height:auto] max-[720px]:[overflow:visible] max-[720px]:[--config-settings-nav-width:100%]",
  settingsNavResizeHandle:
    "vui-routes-configroute settingsNavResizeHandle relative z-20 h-full w-1 shrink-0 cursor-col-resize touch-none border-0 bg-transparent p-0 outline-none max-[720px]:hidden before:pointer-events-none before:absolute before:inset-y-0 before:left-1/2 before:w-px before:-translate-x-1/2 before:bg-transparent before:opacity-0 before:transition before:content-[''] hover:before:bg-[color-mix(in_srgb,var(--accent-cool)_42%,transparent)] hover:before:opacity-100 focus-visible:before:bg-[color-mix(in_srgb,var(--accent-cool)_42%,transparent)] focus-visible:before:opacity-100 after:absolute after:inset-y-0 after:left-1/2 after:w-3 after:-translate-x-1/2 after:content-['']",
  settingsNavResizeHandleActive:
    "vui-routes-configroute settingsNavResizeHandleActive before:bg-[color-mix(in_srgb,var(--accent-cool)_62%,transparent)] before:opacity-100",
  primaryButton:
