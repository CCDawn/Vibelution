...
const panelSurface =
  "[border:1px_solid_var(--border-soft)] [border-radius:var(--radius-panel)] [background:color-mix(in_srgb,var(--surface-panel)_96%,var(--surface-page))] [box-shadow:var(--vui-shadow-hairline)]";
const rowSurface =
  "[border:1px_solid_var(--border-hairline)] [border-radius:8px] [background:color-mix(in_srgb,var(--surface-card)_94%,var(--surface-page))]";
...
const sectionHeaderSurface =
  "[border-bottom:1px_solid_var(--border-hairline)] [background:color-mix(in_srgb,var(--vui-surface-panel)_78%,transparent)]";
...
const styles = {
  ...
  avatarCropPanel:
    "vui-routes-configroute avatarCropPanel [display:grid] [gap:10px] [min-width:0] [padding:10px] [border:1px_solid_var(--border-hairline)] [border-radius:8px] [background:color-mix(in_srgb,var(--vui-surface-row)_86%,transparent)]",
  avatarCropPreview:
  ...
  avatarImageUploadCue:
    "vui-routes-configroute avatarImageUploadCue [position:absolute] [right:-1px] [bottom:-1px] [display:grid] [place-items:center] [width:20px] [height:20px] [border:1px_solid_var(--border-hairline)] [border-radius:999px] [background:color-mix(in_srgb,var(--vui-surface-panel)_86%,transparent)] [color:var(--fg-primary)] [box-shadow:var(--vui-shadow-soft)]",
  avatarImageValue:
  ...
  page:
    "vui-routes-configroute page [--control-height:31px] [--control-radius:var(--radius-control)] [--config-row-gap:7px] [--config-section-x:10px] [--config-section-y:8px] [display:grid] [grid-template-columns:var(--sidebar-width,306px)_minmax(0,1fr)] [gap:6px] [height:100%] [min-height:0] [padding:6px] [overflow:hidden] [background:color-mix(in_srgb,var(--vui-surface-base)_78%,transparent)] max-[1120px]:[grid-template-columns:1fr] max-[720px]:[padding-inline:14px]",
  primaryButton:
  ...
  sectionHeaderMeta:
    "vui-routes-configroute sectionHeaderMeta [display:inline-flex] [align-items:center] [gap:6px] [min-height:30px] [padding:0_8px] [border:1px_solid_var(--border-hairline)] [border-radius:999px] [background:var(--vui-surface-row)]",
  ...
  sectionToolbarGroup:
    "vui-routes-configroute sectionToolbarGroup [display:inline-flex] [align-items:center] [gap:4px] [padding:3px] [border:1px_solid_var(--border-hairline)] [border-radius:999px] [background:var(--vui-surface-row)] [flex-wrap:wrap] [justify-content:end]",
  segmentButton:
  ...
  sidebarResizeCorner:
    "vui-routes-configroute sidebarResizeCorner [position:absolute] [z-index:3] [opacity:0.34] [transition:opacity_140ms_ease,background-color_140ms_ease] hover:[opacity:0.88] hover:[background:color-mix(in_srgb,var(--accent-warm)_20%,transparent)] [right:0] [bottom:0] [width:18px] [height:18px] [cursor:nwse-resize] [border-radius:999px_0_8px_0] [background:color-mix(in_srgb,var(--vui-surface-row)_8%,transparent)] max-[1120px]:[display:none]",
  sidebarResizeX:
  ...
  treeFieldCard:
    "vui-routes-configroute treeFieldCard [border:1px_solid_var(--border-hairline)] [border-radius:7px] [background:var(--vui-surface-row)] [display:grid] [gap:4px] [padding:6px]",
  treeFieldCardEdit:
    "vui-routes-configroute treeFieldCardEdit [align-content:start] [gap:5px] [padding:7px_8px]",
  treeFieldCardView:
    "vui-routes-configroute treeFieldCardView [grid-template-columns:minmax(124px,0.25fr)_minmax(0,1fr)] [align-items:start] [gap:4px_8px] [min-height:34px] [padding:6px] [&_.treeFieldHead]:[min-width:0] [&_.treeFieldHead]:[justify-content:start] [&_.treeFieldHead]:[gap:5px] [&_.treeFieldLabel]:[overflow:hidden] [&_.treeFieldLabel]:[text-overflow:ellipsis] [&_.treeFieldLabel]:[white-space:nowrap] [&_.treeHint]:[display:-webkit-box] [&_.treeHint]:[overflow:hidden] [&_.treeHint]:[-webkit-box-orient:vertical] [&_.treeHint]:[grid-column:1/-1] [&_.treeHint]:[grid-row:2] [&_.treeHint]:[-webkit-line-clamp:2] [&_.treeFieldValue]:[grid-column:2] [&_.treeFieldValue]:[grid-row:1] [&_.treeFieldValue]:[min-width:0] [&_.treeFieldValue]:[width:100%] [&_.treeFieldValue]:[padding:5px_7px] [&_.treeFieldValue]:[border:1px_solid_var(--border-hairline)] [&_.treeFieldValue]:[border-radius:6px] [&_.treeFieldValue]:[background:color-mix(in_srgb,var(--surface-code)_58%,var(--vui-surface-row))] [&_.treeFieldValue]:[font-family:var(--font-mono)] max-[720px]:[grid-template-columns:1fr] max-[720px]:[&_.treeFieldValue]:[grid-column:1] max-[720px]:[&_.treeFieldValue]:[grid-row:auto]",
  treeFieldHead:
