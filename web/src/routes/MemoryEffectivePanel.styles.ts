...
const styles = {
  ...
  effectiveGrid:
    "effectiveGrid min-h-0 min-w-0 flex-1 grid gap-2 overflow-hidden grid-cols-[repeat(auto-fit,minmax(min(100%,16rem),1fr))] [&_.overviewPanel]:min-h-0 [&_.overviewPanel]:overflow-hidden [&_.panelLead]:line-clamp-2",
