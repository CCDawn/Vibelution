...
const styles = {
  ...
  /** Align with VStateSurface unavailable tone tokens (compact inline callout). */
  sourceCollectionResultWarning:
    "sourceCollectionResultWarning min-w-0 rounded-[var(--radius-control)] border border-[color-mix(in_srgb,var(--state-warning)_34%,var(--vui-border-subtle))] bg-[color-mix(in_srgb,var(--state-warning)_8%,var(--vui-surface-row))] px-2 py-1.5 [font-size:var(--vui-font-xs)] leading-[var(--vui-line-readable)] text-[var(--fg-secondary)]",
