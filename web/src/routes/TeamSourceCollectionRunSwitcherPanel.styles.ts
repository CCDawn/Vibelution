const styles = {
  ...
  sourceCollectionRunSwitcherMain:
    "sourceCollectionRunSwitcherMain min-w-0 grid min-w-0 grid-cols-[max-content_minmax(220px,360px)] items-center gap-2 text-[var(--vui-font-xs)] font-[760] text-[var(--fg-secondary)] max-[900px]:grid-cols-[1fr]",
