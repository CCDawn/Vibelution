const styles = {
  ...
  compressionPolicySubgrid: "grid [gap:7px] min-w-0 [grid-template-columns:repeat(4,_minmax(0,_1fr))] [padding:7px] [border:1px_solid_color-mix(in_srgb,_var(--accent-cool)_14%,_var(--vui-border-subtle))] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--vui-surface-row)_70%,_transparent)] max-[860px]:[grid-template-columns:1fr]",
