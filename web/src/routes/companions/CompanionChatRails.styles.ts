...
const railPortrait = "min-h-[210px] rounded-[var(--vui-radius-panel-soft)] border border-vui-border-subtle";
const personNameRow = "flex min-w-0 items-start justify-between gap-2";
const personNameCopy = "min-w-0 [&>h1]:m-0 [&>h1]:truncate [&>h1]:text-lg [&>h1]:font-[820] [&>p]:m-0 [&>p]:mt-1 [&>p]:line-clamp-2 [&>p]:[font-size:var(--vui-font-xs)] [&>p]:leading-[1.45] [&>p]:text-[var(--accent-cool)]";
