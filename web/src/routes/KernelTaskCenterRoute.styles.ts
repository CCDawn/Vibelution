...
const taskRowClass = "grid !h-auto !min-h-[72px] w-full min-w-0 max-w-full content-start justify-self-stretch gap-1 overflow-hidden whitespace-normal rounded-md border border-vui-border-soft bg-[color-mix(in_srgb,var(--surface-panel-muted)_74%,transparent)] px-2 py-1.5 text-left text-vui-fg-primary hover:border-[var(--border-strong)] hover:bg-[color-mix(in_srgb,var(--surface-panel-strong)_82%,transparent)] [&_[data-slot=vui-button-content]]:grid [&_[data-slot=vui-button-content]]:min-w-0 [&_[data-slot=vui-button-content]]:w-full [&_[data-slot=vui-button-content]]:items-start [&_[data-slot=vui-button-content]]:justify-stretch [&_[data-slot=vui-button-content]]:gap-1 [&_[data-slot=vui-button-label]]:contents [&_[data-slot=vui-button-label]]:overflow-visible [&_[data-slot=vui-button-label]]:whitespace-normal";
...
const deliveryRowClass = "grid min-w-0 gap-1 rounded-lg bg-[color-mix(in_srgb,var(--surface-card-subtle)_64%,transparent)] p-[7px]";
