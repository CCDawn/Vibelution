...
const mutedLineClass = "min-w-0 break-words text-[var(--vui-font-xs)] leading-[1.35] text-vui-fg-secondary";
const warningLineClass = "min-w-0 break-words text-[var(--vui-font-xs)] not-italic leading-[1.35] text-[var(--state-warning)]";
