...
import { VButton, VNativeInput, VNativeTextarea, VTooltip } from "../components/vui";
import {
...
export function MemoryManagementEditor({
  ...
  return (
    <VTooltip content={copy.managementHint} width="wide">
      <section
        className={styles.managementPanel}
        aria-label={`${copy.management} · ${copy.managementHint}`}
        tabIndex={0}
      >
