...
const styles = {
  critical:
    "vui-routes-configproviderwizard critical rounded-md border border-[color-mix(in_srgb,var(--state-error)_38%,var(--vui-border-subtle))] bg-[color-mix(in_srgb,var(--state-error)_8%,var(--vui-surface-row))] px-2 py-1.5 text-[var(--vui-font-sm)] text-[var(--state-error)]",
  ...
  field: "vui-routes-configproviderwizard field grid min-w-0 gap-1 text-[var(--vui-font-xs)] font-semibold text-vui-fg-secondary",
  ...
  muted: "vui-routes-configproviderwizard muted text-[var(--vui-font-xs)] text-vui-fg-tertiary",
