...
const styles = {
  templateButton: "!h-auto !min-h-20 !w-full !justify-start !text-left !px-3 !py-2 [&_strong]:whitespace-normal [&_strong]:break-words",
  critical:
  ...
  templateGrid: "vui-routes-configproviderwizard templateGrid grid min-w-0 [grid-template-columns:repeat(auto-fit,minmax(min(100%,14rem),1fr))] gap-1",
