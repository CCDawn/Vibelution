...
const controlLabelClass = "py-0 pl-[7px] pr-[5px] text-[0.74rem] text-vui-fg-secondary max-[760px]:hidden";
const intakeSegmentedClass = "inline-flex gap-1";
const intakeButtonClass = [
  "min-h-[26px] rounded-full border-0 bg-transparent px-2 text-[0.76rem] text-vui-fg-secondary",
