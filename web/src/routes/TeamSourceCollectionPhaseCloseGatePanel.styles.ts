const styles = {
  phaseCloseGateAction:
    "phaseCloseGateAction inline-flex w-fit max-w-full items-center gap-1.5 self-start text-[var(--vui-font-xs)] font-[760]",
  phaseCloseGateFacts:
    "phaseCloseGateFacts min-w-0 flex flex-wrap items-center gap-1.5 text-[var(--vui-font-xs)] text-[var(--fg-secondary)] [&_span]:inline-flex [&_span]:min-w-0 [&_span]:max-w-full [&_span]:items-center [&_span]:gap-1 [&_span]:rounded-[7px] [&_span]:border [&_span]:border-[color:var(--border-soft)] [&_span]:bg-[color:var(--source-workbench-card)] [&_span]:px-2 [&_span]:py-1 [&_strong]:min-w-0 [&_strong]:truncate [&_strong]:text-[var(--fg-primary)]",
  ...
  phaseCloseGateReasons:
    "phaseCloseGateReasons min-w-0 grid gap-1 text-[var(--vui-font-xs)] leading-tight text-[var(--fg-secondary)] [&_span]:min-w-0 [&_span]:break-words [&_span]:[overflow-wrap:anywhere]",
  phaseCloseGateTag:
    "phaseCloseGateTag inline-flex min-h-6 w-fit max-w-full items-center gap-1 rounded-full border border-[var(--vui-border-subtle)] bg-[var(--vui-control-muted)] px-2 text-[var(--vui-font-xs)] font-[760] leading-none text-[var(--fg-secondary)]",
