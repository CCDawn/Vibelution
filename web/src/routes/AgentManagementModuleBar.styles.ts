const styles = {
  moduleBar:
    "flex h-[52px] min-w-0 items-stretch justify-between gap-4 border-b border-[var(--vui-border-subtle)] bg-[color-mix(in_srgb,var(--vui-surface-page)_92%,transparent)] px-4",
