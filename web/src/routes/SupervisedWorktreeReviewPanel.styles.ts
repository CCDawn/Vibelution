...
const closedLoopStatusClass = "grid min-h-[30px] min-w-0 grid-cols-[auto_minmax(56px,auto)_minmax(0,1fr)] items-center gap-[7px] rounded-[7px] border border-vui-border-subtle bg-vui-surface-row px-2 py-1 text-[var(--vui-font-xs)] max-[640px]:grid-cols-1";
...
const worktreeRunItemClass = "grid min-h-8 min-w-0 grid-cols-[minmax(0,1.25fr)_minmax(78px,0.55fr)_minmax(0,1fr)] items-center gap-2 rounded-[7px] border border-vui-border-subtle bg-vui-surface-row px-2 py-1 text-left text-[var(--vui-font-xs)] text-vui-fg-primary max-[640px]:grid-cols-1";
...
const worktreeRunStatusClass = "inline-flex min-h-5 max-w-full items-center justify-self-start truncate rounded-full border border-vui-border-soft bg-vui-control-muted px-[7px] text-[var(--vui-font-xs)] leading-[1.25] text-vui-fg-secondary";
