...
const secondaryPillClass = "inline-flex min-h-6 items-center justify-center rounded-[var(--radius-control)] border border-vui-border-soft bg-vui-control-muted px-2 text-xs font-semibold text-vui-fg-secondary";
...
const noticeTextClass = "m-0 break-words [font-size:var(--vui-font-xs)] leading-[1.45] text-vui-fg-secondary";
...
const worktreeRunStatusClass = "inline-flex min-h-5 max-w-full items-center justify-self-start truncate rounded-full border border-vui-border-soft bg-vui-control-muted px-[7px] [font-size:var(--vui-font-xs)] leading-[1.25] text-vui-fg-secondary";
const worktreeRunMetaClass = "inline-flex min-w-0 items-center justify-self-end truncate text-right [font-size:var(--vui-font-xs)] leading-[1.25] text-vui-fg-tertiary max-[640px]:justify-self-start max-[640px]:text-left";
const worktreeReviewGateClass = "grid min-w-0 gap-1.5 rounded-[7px] border border-[color-mix(in_srgb,var(--accent-cool)_26%,var(--vui-border-subtle))] bg-[color-mix(in_srgb,var(--accent-cool)_8%,var(--vui-surface-row))] px-2.5 py-2";
...
const inlineActionClass = "inline-flex min-h-10 items-center justify-center gap-2 rounded-[var(--radius-control)] border border-vui-border-soft bg-vui-control-muted px-3.5 [font-size:var(--vui-font-xs)] font-semibold text-vui-fg-primary disabled:cursor-not-allowed disabled:opacity-55";
...
const metaRowClass = "grid min-w-0 grid-cols-[minmax(90px,auto)_minmax(0,1fr)] gap-2 [font-size:var(--vui-font-xs)] text-vui-fg-secondary";
