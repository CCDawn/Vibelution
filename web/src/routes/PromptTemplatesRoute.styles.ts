...
const bulkSelectClass = "min-h-[26px] min-w-0 max-w-full flex-[1_1_96px] rounded-lg border border-vui-border-soft bg-[var(--surface-input-strong)] font-inherit text-vui-fg-primary";
...
const detailCardClass = "grid min-h-0 min-w-0 content-start gap-1.5 rounded-lg border border-[color-mix(in_srgb,var(--border-soft)_64%,transparent)] bg-transparent p-2 grid-rows-[auto_minmax(0,1fr)_auto]";
const agentListClass = "grid min-h-0 min-w-0 content-start gap-1.5 rounded-lg border border-[color-mix(in_srgb,var(--border-soft)_64%,transparent)] bg-transparent p-2";
...
const agentItemClass = "grid min-w-0 grid-cols-[minmax(0,1fr)_auto] gap-x-2.5 gap-y-1 rounded-[var(--radius-control)] border border-vui-border-soft bg-[color-mix(in_srgb,var(--surface-card)_78%,transparent)] px-2 py-1.5 [&_*]:min-w-0";
