...
const templateMetaClass =
  `flex min-w-0 max-w-full flex-wrap gap-1 overflow-hidden [&_span]:inline-flex [&_span]:min-h-5 [&_span]:min-w-0 [&_span]:max-w-full [&_span]:items-center [&_span]:justify-center [&_span]:truncate [&_span]:whitespace-nowrap [&_span]:rounded-sm [&_span]:${vuiOpaqueRowClass} [&_span]:px-1.5 [&_span]:[font-size:var(--vui-font-xs)] [&_span]:text-vui-fg-tertiary`;
...
const actionsClass = "min-[1400px]:col-span-full flex flex-wrap justify-end gap-2";
