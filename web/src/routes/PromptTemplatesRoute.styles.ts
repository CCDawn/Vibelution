...
const contentTextareaClass = `h-full min-h-0 w-full min-w-0 resize-none self-stretch ${fieldSurfaceClass} p-2.5 font-[var(--font-mono)] text-[var(--vui-font-xs)] leading-[1.5] text-vui-fg-primary`;
