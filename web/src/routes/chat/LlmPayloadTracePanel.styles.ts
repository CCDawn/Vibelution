...
const styles = {
  ...
  llmPayloadTraceItem: `vui-routes-chatcodingroute llmPayloadTraceItem grid min-w-0 gap-0.5 ${vuiOpaqueRowClass} px-2 py-1 [font-size:var(--vui-font-xs)] leading-tight [&_strong]:min-w-0 [&_strong]:truncate [&_strong]:font-semibold [&_strong]:text-[var(--fg-primary)]`,
