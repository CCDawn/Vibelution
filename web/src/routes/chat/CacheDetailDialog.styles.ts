...
const styles: Record<string, string> = {
  ...
  cacheDetailDonutCenter:
    "vui-routes-chatcodingroute cacheDetailDonutCenter pointer-events-none absolute inset-0 m-auto grid size-[min(96px,38%)] min-w-0 place-self-center place-items-center rounded-full border border-[var(--vui-border-subtle)] bg-[var(--vui-surface-panel)] p-2 text-center shadow-[var(--vui-shadow-hairline)] [&_strong]:[font-size:var(--vui-font-lg)] [&_strong]:font-semibold [&_strong]:text-[var(--fg-primary)] [&_span]:[font-size:var(--vui-font-xs)] [&_span]:text-[var(--fg-tertiary)]",
  ...
  cacheDetailSegmentMeta:
    "vui-routes-chatcodingroute cacheDetailSegmentMeta min-w-0 flex flex-wrap items-center gap-1 [font-size:var(--vui-font-xs)] leading-tight [&_b]:rounded-full [&_b]:border [&_b]:border-[var(--vui-border-subtle)] [&_b]:bg-[var(--vui-surface-row)] [&_b]:px-1.5 [&_b]:py-0.5 [&_b]:font-medium [&_b]:text-[var(--fg-secondary)] [&_b[data-status=observed\\_hit]]:border-[color-mix(in_srgb,var(--state-success)_34%,var(--vui-border-subtle))] [&_b[data-status=observed\\_hit]]:text-[var(--state-success)] [&_b[data-status=observed\\_miss]]:border-[color-mix(in_srgb,var(--state-warning)_34%,var(--vui-border-subtle))] [&_b[data-status=observed\\_miss]]:text-[var(--state-warning)] [&_b[data-status=observed\\_partial]]:text-[var(--state-warning)] [&_b[data-status=not\\_observed]]:text-[var(--fg-tertiary)]",
