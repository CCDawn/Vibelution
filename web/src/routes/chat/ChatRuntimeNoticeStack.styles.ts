const styles = {
  stack:
    "min-w-0 rounded-[var(--radius-panel)] border border-[var(--vui-border-subtle)] bg-[color-mix(in_srgb,var(--surface-panel)_72%,transparent)] p-2 shadow-none",
  notice:
    "min-w-0 rounded-[var(--radius-panel)] border border-[var(--vui-border-subtle)] bg-[color-mix(in_srgb,var(--surface-panel)_54%,transparent)] p-2 shadow-none !grid grid-cols-[16px_minmax(0,1fr)] items-start gap-[7px]",
  body:
  ...
  toneMuted:
    "bg-[color-mix(in_srgb,var(--surface-panel)_58%,transparent)] text-[var(--fg-tertiary)]",
  toneSuccess:
