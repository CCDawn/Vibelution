...
const styles = {
  ...
  toolApprovalHost:
    "vui-routes-chatsessionworkspacepanel toolApprovalHost sticky top-0 z-[6] shrink-0 border-b border-[color-mix(in_srgb,var(--accent-warm)_22%,var(--vui-border-subtle))] bg-[var(--vui-surface-panel)] p-1.5",
