...
const styles = {
  ...
  resolutionError: "vui-routes-configmodelmigrationpanel resolutionError m-0 min-w-0 text-[var(--vui-font-xs)] text-[var(--state-error)]",
  ...
  resolutionWarning: "vui-routes-configmodelmigrationpanel resolutionWarning m-0 min-w-0 text-[var(--vui-font-xs)] text-[var(--state-warning)]",
