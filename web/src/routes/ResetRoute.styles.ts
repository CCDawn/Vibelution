...
const workspaceClass = "grid min-h-0 min-w-0 max-w-full grid-cols-[minmax(320px,560px)_minmax(260px,420px)] items-start justify-start gap-2 overflow-y-auto overflow-x-hidden px-2.5 pb-2.5 pt-2 max-[760px]:grid-cols-[minmax(0,1fr)]";
const primaryColumnClass = "grid min-w-0 max-w-[560px] content-start gap-2";
const statusStripClass = `grid min-w-0 max-w-[560px] grid-cols-[auto_minmax(0,1fr)] items-start gap-2 overflow-hidden ${panelSurface} p-2`;
const launcherPanelClass = `grid min-w-0 max-w-[560px] content-start gap-2 ${panelSurface} p-2.5`;
const riskPanelClass = `grid min-w-0 max-w-[420px] content-start gap-2 ${panelSurface} p-2.5`;
