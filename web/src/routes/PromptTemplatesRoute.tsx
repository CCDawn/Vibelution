...
const panelDescriptionClass = "m-0 mt-0.5 text-[0.76rem] leading-[1.28] text-vui-fg-secondary";
...
const bulkSummaryClass = "inline-flex min-h-[26px] min-w-0 items-center gap-1.5 text-[0.75rem] text-vui-fg-secondary";
const bulkSummaryTitleClass = "text-vui-fg-primary";
const bulkSelectFieldClass = "inline-flex min-h-[26px] min-w-0 items-center gap-1.5 text-[0.75rem] text-vui-fg-secondary";
...
const templateMetaClass = "flex flex-wrap gap-1 [&_span]:inline-flex [&_span]:min-h-5 [&_span]:max-w-full [&_span]:items-center [&_span]:justify-center [&_span]:rounded-full [&_span]:border [&_span]:border-vui-border-soft [&_span]:bg-[var(--surface-card)] [&_span]:px-1.5 [&_span]:text-[0.61rem] [&_span]:text-vui-fg-tertiary";
...
const detailLabelClass = "text-[0.61rem] text-vui-fg-tertiary";
const detailValueClass = "min-w-0 truncate text-[0.82rem] text-vui-fg-primary";
const fieldClass = "grid min-w-0 gap-[5px]";
const fieldLabelClass = "text-[0.75rem] font-bold text-vui-fg-tertiary";
...
const helperTextClass = "m-0 text-[0.76rem] leading-[1.3] text-vui-fg-secondary";
...
const agentCodeClass = "text-[0.68rem] text-vui-fg-tertiary";
const agentMetaClass = "truncate text-[0.72rem] text-vui-fg-tertiary";
const actionsClass = "flex flex-wrap justify-end gap-2";
const noticeClass = "m-0 text-[0.76rem] leading-[1.3] text-[var(--state-success)]";
const errorTextClass = "m-0 text-[0.76rem] leading-[1.3] text-[var(--state-danger)]";
