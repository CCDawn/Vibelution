export default {
  ...
  item: "rounded border border-[var(--vui-border-subtle)] px-2 py-1.5 text-xs",
  ...
  relation: "rounded border border-[var(--vui-border-subtle)] px-2 py-1.5 text-xs break-all text-[var(--fg-primary)]",
