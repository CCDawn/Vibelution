export default {
  ...
  item: "rounded border border-[var(--vui-border-subtle)] px-2 py-1.5 [font-size:var(--vui-font-2xs)]",
  itemTitle: "font-medium break-all text-[var(--fg-primary)]",
  itemDetail: "break-all text-[var(--fg-secondary)]",
  relationEmpty: "m-0 [font-size:var(--vui-font-2xs)] text-[var(--fg-secondary)]",
  relation: "rounded border border-[var(--vui-border-subtle)] px-2 py-1.5 [font-size:var(--vui-font-2xs)] break-all text-[var(--fg-primary)]",
