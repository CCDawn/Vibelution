export default {
  ...
  metric: "rounded border border-[var(--border-subtle)] px-2 py-1.5",
  ...
  item: "flex items-center justify-between gap-2 rounded border border-[var(--border-subtle)] px-2 py-1.5 text-xs",
  itemText: "min-w-0",
