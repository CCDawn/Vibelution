const styles: Record<string, string> = {
  ...
  header:
    "flex flex-wrap items-start justify-between gap-3 [&_h2]:m-0 [&_h2]:mt-1 [&_h2]:text-[22px] [&_h2]:leading-[1.3]",
  ...
  anchorNav:
    "grid grid-cols-2 gap-1.5 @min-[430px]:grid-cols-4 [&_a]:flex [&_a]:min-w-0 [&_a]:items-center [&_a]:gap-[7px] [&_a]:rounded-[var(--vui-radius-control)] [&_a]:border [&_a]:border-[var(--vui-border-subtle)] [&_a]:bg-[var(--vui-surface-panel)] [&_a]:px-2.5 [&_a]:py-[9px] [&_a]:text-xs [&_a]:text-inherit [&_a]:no-underline [&_span]:grid [&_span]:h-5 [&_span]:w-5 [&_span]:shrink-0 [&_span]:place-items-center [&_span]:rounded-full [&_span]:bg-[var(--vui-surface-inset)] [&_span]:text-[var(--fg-secondary)]",
  section:
  ...
  factGrid:
    "grid grid-cols-2 gap-2 [&_section]:grid [&_section]:gap-1 [&_span]:text-xs [&_span]:font-[650] [&_span]:tracking-[0.02em] [&_span]:text-[var(--fg-secondary)]",
  warning:
  ...
  explanation:
    "grid gap-2.5 [&_dl]:m-0 [&_dl]:grid [&_dl]:grid-cols-1 [&_dl]:gap-2 [&_dl>div]:grid [&_dl>div]:gap-[3px] [&_dt]:text-xs [&_dt]:text-[var(--fg-secondary)] [&_dd]:m-0",
  ...
  reviewGrid:
    "grid grid-cols-2 gap-1.5 @min-[400px]:grid-cols-3 [&>div]:grid [&>div]:min-w-0 [&>div]:content-start [&>div]:gap-1 [&>div]:rounded-[var(--vui-radius-control)] [&>div]:bg-[var(--vui-surface-inset)] [&>div]:p-2 [&_span]:text-[11px] [&_span]:text-[var(--fg-secondary)] [&_small]:text-[11px] [&_small]:text-[var(--fg-secondary)] [&_p]:text-xs [&_p]:leading-[1.45]",
  selection:
    "grid grid-cols-1 gap-2.5 [&>div]:grid [&>div]:content-start [&>div]:gap-1.25 [&>div]:rounded-[var(--vui-radius-control)] [&>div]:bg-[var(--vui-surface-inset)] [&>div]:p-2.5 [&>div>span]:text-xs [&>div>span]:font-[650] [&>div>span]:tracking-[0.02em] [&>div>span]:text-[var(--fg-secondary)]",
  plan: "grid gap-2.5",
  planGrid:
