...
describe("ConfigRoute layout contract", () => {
  ...
  it("keeps the settings workbench readable over custom backgrounds with a bounded draft editor", () => {
    ...
    expect(styles.page).toContain("[background:color-mix(in_srgb,var(--vui-surface-base)_78%,transparent)]");
    expect(stylesSource).toContain("configStatusBand:");
    expect(stylesSource).toContain("sidebar:");
    expect(styles.configStatusBand).toContain("color-mix(in_srgb,var(--surface-panel)_96%,var(--surface-page))");
    expect(styles.sidebar).toContain("color-mix(in_srgb,var(--surface-panel)_96%,var(--surface-page))");
    ...
    expect(styles.sidebarStatusCompact).toContain(
      "[background:color-mix(in_srgb,var(--surface-card)_94%,var(--surface-page))]",
    );
  ...
  it("keeps extracted Config panels on local VUI/Tailwind surface contracts", () => {
    ...
    expect(extractedPanelStylesSource).toContain("color-mix(in_srgb,var(--surface-panel)_96%,var(--surface-page))");
    expect(extractedPanelStylesSource).toContain("color-mix(in_srgb,var(--surface-card)_94%,var(--surface-page))");
    ...
    expect(overviewPanelStyles.sectionSurface).toContain(
      "color-mix(in_srgb,var(--surface-panel)_96%,var(--surface-page))",
    );
    ...
    expect(healthDiagnosticsPanelStyles.findingCard).toContain(
      "color-mix(in_srgb,var(--surface-card)_94%,var(--surface-page))",
    );
