const styles = {
  controlStrip:
    "grid min-w-0 grid-cols-[max-content_minmax(0,1fr)] items-center gap-[7px] rounded-[var(--radius-panel)] border border-vui-border-subtle bg-vui-surface-glass p-2 shadow-[var(--vui-shadow-hairline)] max-[980px]:grid-cols-[1fr]",
  managementNav:
  ...
  summaryCard:
    "grid min-w-0 gap-[2px] rounded-[var(--radius-control)] border border-vui-border-subtle bg-vui-surface-row px-2 py-1.5 [&>span]:truncate [&>span]:text-[var(--vui-font-xs)] [&>span]:font-semibold [&>span]:text-vui-fg-tertiary [&>strong]:truncate [&>strong]:text-[var(--vui-font-md)] [&>strong]:font-extrabold [&>strong]:leading-tight [&>strong]:text-vui-fg-primary",
  agentScopeBar:
    "grid min-w-0 grid-cols-[minmax(170px,1fr)_minmax(180px,230px)_minmax(150px,190px)_minmax(180px,auto)] items-center gap-[7px] rounded-[var(--radius-panel)] border border-[color:color-mix(in_srgb,var(--accent-cool)_24%,var(--vui-border-subtle))] bg-[color:color-mix(in_srgb,var(--accent-cool)_7%,var(--vui-surface-glass))] p-2 shadow-[var(--vui-shadow-hairline)] max-[1120px]:grid-cols-[minmax(0,1fr)_minmax(180px,230px)] max-[700px]:grid-cols-[1fr]",
  scopeCopy:
