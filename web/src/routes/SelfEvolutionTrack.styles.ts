export const selfEvolutionTrackStyles: Record<string, string> = {
  ...
  loadingPanel:
    "grid min-h-0 content-start gap-2 rounded-lg border border-[var(--border-soft)] bg-[var(--surface-card)] p-3 [&_strong]:text-[0.78rem] [&_strong]:text-[var(--fg-secondary)]",
  loadingStatGrid:
    "grid grid-cols-3 gap-1.5 [&_span]:grid [&_span]:min-w-0 [&_span]:gap-1 [&_span]:rounded-[7px] [&_span]:border [&_span]:border-[var(--border-hairline)] [&_span]:px-[7px] [&_span]:py-1.5 [&_span]:text-[0.72rem] [&_span]:text-[var(--fg-tertiary)] [&_strong]:font-mono [&_strong]:text-[0.84rem] [&_strong]:text-[var(--fg-primary)]",
  ...
  detailRow:
    "flex items-center justify-between gap-3 border-b border-[color-mix(in_srgb,var(--accent-warm)_8%,transparent)] pb-2 max-[760px]:flex-col max-[760px]:items-stretch [&_span]:text-[0.78rem] [&_span]:text-[var(--fg-tertiary)] [&_strong]:overflow-wrap-anywhere [&_strong]:text-[0.92rem] [&_strong]:text-[var(--fg-primary)]",
  ...
  eyebrow: "m-0 mb-1 text-[0.74rem] uppercase tracking-[0.08em] text-[var(--fg-tertiary)]",
  sectionTitle: "m-0 text-base text-[var(--fg-primary)]",
  subsurfaceTitle: "m-0 text-[0.98rem] text-[var(--fg-primary)]",
  subsectionTitle: "m-0 text-[0.82rem] uppercase tracking-[0.06em] text-[var(--fg-tertiary)]",
  ...
  statusPill:
    "inline-flex min-h-7 items-center justify-center whitespace-nowrap rounded-full border border-[color-mix(in_srgb,var(--accent-warm)_18%,transparent)] bg-[color-mix(in_srgb,var(--accent-warm)_12%,transparent)] px-2.5 text-[0.78rem] text-[var(--accent-warm-2)] max-[760px]:w-fit",
  secondaryPill:
    "inline-flex min-h-7 items-center justify-center whitespace-nowrap rounded-full border border-[color-mix(in_srgb,var(--accent-warm)_18%,transparent)] bg-[var(--surface-panel-strong)] px-2.5 text-[0.78rem] text-[var(--fg-secondary)] max-[760px]:w-fit",
  counter:
    "inline-flex min-h-7 items-center justify-center whitespace-nowrap rounded-full border border-[color-mix(in_srgb,var(--accent-warm)_18%,transparent)] bg-[var(--surface-panel-strong)] px-2.5 text-[0.78rem] text-[var(--fg-secondary)] max-[760px]:w-fit",
  ...
  listItem:
    "grid gap-2 rounded-lg border border-[var(--border-soft)] bg-[var(--surface-card)] px-[13px] py-3 [&_strong]:overflow-wrap-anywhere [&_strong]:text-[0.84rem] [&_strong]:text-[var(--fg-primary)]",
  listItemSelected:
  ...
  petAvatarBadge:
    "absolute bottom-2.5 left-2.5 inline-flex min-h-7 items-center gap-1.5 rounded-full border border-[color-mix(in_srgb,var(--accent-warm)_18%,transparent)] bg-[var(--surface-panel-strong)] px-2.5 text-[0.78rem] text-[var(--fg-secondary)]",
  petCompanionCopy: "grid gap-1.5 [&_p]:m-0 [&_p]:text-[0.92rem] [&_p]:leading-normal [&_p]:text-[var(--fg-primary)] [&_span]:m-0 [&_span]:text-[0.82rem] [&_span]:leading-normal [&_span]:text-[var(--fg-secondary)]",
  ...
  stripItem:
    "grid min-h-[58px] gap-1 rounded-lg border border-[var(--border-soft)] bg-[var(--surface-card)] px-2.5 py-[9px] [&_span]:text-[0.78rem] [&_span]:text-[var(--fg-tertiary)] [&_strong]:overflow-wrap-anywhere [&_strong]:text-[0.92rem] [&_strong]:text-[var(--fg-primary)]",
  ...
  transactionDateFilterBar:
    "flex flex-wrap items-center gap-2 [&>span]:text-[0.76rem] [&>span]:leading-tight [&>span]:text-[var(--fg-tertiary)]",
  transactionVisibleSummary:
    "inline-flex min-h-[30px] items-center whitespace-nowrap font-mono text-[0.74rem] leading-tight text-[var(--fg-tertiary)]",
  transactionFilterButton:
    "inline-flex min-h-[34px] cursor-pointer items-center gap-2 rounded-lg border border-[color-mix(in_srgb,var(--accent-warm)_18%,transparent)] bg-[var(--surface-panel-strong)] px-2.5 text-[var(--fg-secondary)] [&_strong]:min-w-[22px] [&_strong]:text-right [&_strong]:font-mono [&_strong]:text-[0.76rem] [&_strong]:text-[var(--fg-primary)]",
  ...
  transactionDetailsToggle:
    "inline-flex min-h-7 cursor-pointer items-center gap-1.5 whitespace-nowrap rounded-full border border-[color-mix(in_srgb,var(--accent-warm)_18%,transparent)] bg-[color-mix(in_srgb,var(--surface-panel-strong)_78%,transparent)] px-[9px] text-[0.78rem] text-[var(--fg-secondary)] aria-expanded:border-[color-mix(in_srgb,var(--accent-cool)_30%,transparent)] aria-expanded:text-[var(--accent-cool)]",
  transactionDateGroup:
    "grid gap-2 pt-0.5 [&+&]:mt-1 [&+&]:border-t [&+&]:border-[color-mix(in_srgb,var(--accent-warm)_12%,transparent)] [&+&]:pt-3",
  transactionDateHeader:
    "flex min-h-[30px] items-center justify-between gap-2.5 px-0.5 max-[760px]:flex-col max-[760px]:items-stretch [&_strong]:text-[0.82rem] [&_strong]:text-[var(--fg-primary)] [&_span]:text-[0.74rem] [&_span]:leading-tight [&_span]:text-[var(--fg-tertiary)]",
  ...
  transactionTitleStack:
    "grid min-w-0 gap-1 [&_span]:overflow-wrap-anywhere [&_span]:font-mono [&_span]:text-[0.72rem] [&_span]:leading-tight [&_span]:text-[var(--fg-tertiary)]",
  transactionMetaGrid:
    "grid grid-cols-4 gap-1.5 max-[1180px]:grid-cols-2 [&_span]:min-w-0 [&_span]:overflow-wrap-anywhere [&_span]:rounded-[7px] [&_span]:border [&_span]:border-[var(--border-hairline)] [&_span]:bg-[color-mix(in_srgb,var(--surface-panel-strong)_72%,transparent)] [&_span]:px-2 [&_span]:py-1.5 [&_span]:text-[0.73rem] [&_span]:leading-tight [&_span]:text-[var(--fg-secondary)]",
  transactionGoalPreview: "m-0 overflow-wrap-anywhere text-[0.78rem] leading-normal text-[var(--fg-secondary)]",
  ...
  transactionDetailRow:
    "grid min-w-0 gap-1 [&_span]:text-[0.72rem] [&_span]:text-[var(--fg-tertiary)] [&_strong]:overflow-wrap-anywhere [&_strong]:text-[0.78rem] [&_strong]:leading-snug [&_strong]:text-[var(--fg-secondary)]",
