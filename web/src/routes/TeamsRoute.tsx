                  ...
                  <TeamStageCard
                    ...
                    actions={
                      <VButton
                        type="button"
                        density="compact"
                        variant={module.actionTone === "primary" ? "primary" : "secondary"}
                        icon={renderSourceCollectionStageActionIcon(module.actionIcon)}
                        isDisabled={module.actionDisabled}
                        onPress={module.onAction}
