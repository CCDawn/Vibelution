const styles = {
  copyNotice:
    "copyNotice min-w-0 inline-flex w-fit max-w-full items-center gap-1.5 rounded-[var(--radius-control)] border border-[var(--vui-border-subtle)] bg-[var(--vui-surface-row)] p-1.5 text-[var(--vui-font-xs)] leading-tight text-[var(--fg-secondary)] [&>span]:min-w-0 [&>span]:break-words",
  countPill:
  ...
  detailActions:
    "detailActions min-w-0 flex w-fit max-w-full flex-wrap items-center gap-1.5 rounded-[var(--radius-control)] border border-[var(--vui-border-subtle)] bg-[var(--vui-surface-row)] p-1.5",
  detailHeader:
  ...
  emptyDetail:
    "emptyDetail min-w-0 grid min-h-[96px] content-center gap-1.5 rounded-[var(--radius-control)] border border-dashed border-[var(--vui-border-subtle)] bg-[var(--vui-surface-row)] p-2 text-[var(--vui-font-xs)] leading-tight text-[var(--fg-tertiary)]",
  factGrid:
  ...
  generatedAt:
    "generatedAt min-w-0",
  impactPanel:
    "impactPanel min-w-0 rounded-[var(--radius-panel)] border border-[var(--vui-border-subtle)] bg-[var(--vui-surface-panel)] p-2 [&>p]:min-w-0 [&>p]:break-words",
  manageDetailPanel:
  ...
  rawPanel:
    "rawPanel min-w-0 rounded-[var(--radius-panel)] border border-[var(--vui-border-subtle)] bg-[var(--vui-surface-panel)] p-2 [&_pre]:max-w-full [&_pre]:whitespace-pre-wrap [&_pre]:break-words",
  sectionPanel:
    "sectionPanel min-w-0 rounded-[var(--radius-panel)] border border-[var(--vui-border-subtle)] bg-[var(--vui-surface-panel)] p-2 [&>p]:min-w-0 [&>p]:break-words",
  statusPill:
  ...
  visibilityPanel:
    "visibilityPanel min-w-0 rounded-[var(--radius-panel)] border border-[var(--vui-border-subtle)] bg-[var(--vui-surface-panel)] p-2",
} as const;
