...
const styles: Record<string, string> = {
  ...
  canvasShell:
    "canvasShell min-w-0 grid h-full min-h-0 grid-rows-[auto_auto_minmax(0,1fr)] overflow-hidden bg-[color-mix(in_srgb,var(--vui-surface-row)_54%,transparent)] text-[var(--fg-primary)] gap-2 p-2 max-[430px]:p-1.5",
  canvasViewport:
  ...
  inspectorBody:
    "inspectorBody min-w-0 h-full text-[var(--vui-font-sm)] leading-[var(--vui-line-readable)] text-[var(--fg-secondary)] !grid grid-cols-[76px_minmax(0,1fr)] min-h-0 overflow-hidden max-[430px]:grid-cols-1 max-[430px]:grid-rows-[auto_minmax(0,1fr)]",
  inspectorContent:
  ...
  issueCard:
    "issueCard min-w-0 rounded-[var(--radius-panel)] border border-[var(--vui-border-subtle)] bg-[color-mix(in_srgb,var(--vui-surface-row)_62%,transparent)] p-2",
  issueCardBody:
    "issueCardBody min-w-0 rounded-[var(--radius-panel)] border border-[var(--vui-border-subtle)] bg-[color-mix(in_srgb,var(--vui-surface-row)_54%,transparent)] p-2 text-[var(--vui-font-sm)] leading-[var(--vui-line-readable)] text-[var(--fg-secondary)]",
  issueCardError:
  ...
  issueCardHeader:
    "issueCardHeader min-w-0 rounded-[var(--radius-panel)] border border-[var(--vui-border-subtle)] bg-[color-mix(in_srgb,var(--vui-surface-row)_54%,transparent)] p-2 flex flex-wrap items-center gap-1.5",
  issueCardWarning:
  ...
  issuePanel:
    "issuePanel min-w-0 rounded-[var(--radius-panel)] border border-[var(--vui-border-subtle)] bg-[color-mix(in_srgb,var(--vui-surface-row)_64%,transparent)] p-2",
  issueSummary:
    "issueSummary min-w-0 rounded-[var(--radius-panel)] border border-[var(--vui-border-subtle)] bg-[color-mix(in_srgb,var(--vui-surface-row)_58%,transparent)] p-2 !grid grid-cols-[repeat(2,minmax(0,1fr))] gap-2.5 max-[430px]:grid-cols-1",
  issueSummaryError:
  ...
  organizationAuditCard:
    "organizationAuditCard min-w-0 rounded-[var(--radius-panel)] border border-[var(--vui-border-subtle)] bg-[color-mix(in_srgb,var(--vui-surface-row)_58%,transparent)] p-2",
  ...
  organizationPanel:
    "organizationPanel min-w-0 rounded-[var(--radius-panel)] border border-[var(--vui-border-subtle)] bg-[color-mix(in_srgb,var(--vui-surface-row)_64%,transparent)] p-2",
  organizationProposalCard:
    "organizationProposalCard min-w-0 rounded-[var(--radius-panel)] border border-[var(--vui-border-subtle)] bg-[color-mix(in_srgb,var(--vui-surface-row)_58%,transparent)] p-2",
  ...
  organizationSummaryGrid:
    "organizationSummaryGrid min-w-0 rounded-[var(--radius-panel)] border border-[var(--vui-border-subtle)] bg-[color-mix(in_srgb,var(--vui-surface-row)_58%,transparent)] p-2 grid gap-2 !grid grid-cols-[repeat(3,minmax(0,1fr))] gap-2 max-[430px]:grid-cols-1",
  primaryButton:
  ...
  readonlyDetailHeader:
    "readonlyDetailHeader min-w-0 rounded-[var(--radius-panel)] border border-[var(--vui-border-subtle)] bg-[color-mix(in_srgb,var(--vui-surface-row)_58%,transparent)] p-2 flex flex-wrap items-center gap-1.5",
  readonlySpecGrid:
  ...
  selectionSummary:
    "selectionSummary min-w-0 rounded-[var(--radius-panel)] border border-[var(--vui-border-subtle)] bg-[color-mix(in_srgb,var(--vui-surface-row)_58%,transparent)] p-2",
  statusPill:
