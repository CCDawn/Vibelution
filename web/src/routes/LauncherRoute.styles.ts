...
const panelHeaderText =
  "[&_span]:text-[var(--vui-font-xs)] [&_span]:uppercase [&_span]:tracking-[0.06em] [&_span]:text-vui-fg-tertiary [&_strong]:min-w-0 [&_strong]:truncate [&_strong]:text-[var(--vui-font-xs)] [&_strong]:text-vui-fg-primary";
...
export const launcherRouteStyles = {
  ...
  dangerZone:
    `mx-3 mt-1.5 grid min-w-0 grid-cols-[max-content_minmax(0,1fr)_max-content] items-center gap-2 rounded-lg border border-[color-mix(in_srgb,var(--danger)_30%,transparent)] bg-[color-mix(in_srgb,var(--danger)_5%,var(--vui-surface-panel))] px-[9px] py-1.5 max-[860px]:grid-cols-[minmax(0,1fr)] [&_span]:whitespace-nowrap [&_span]:text-[var(--vui-font-xs)] [&_span]:font-bold [&_span]:text-[color-mix(in_srgb,var(--danger)_72%,var(--vui-fg-primary))] [&_small]:min-w-0 [&_small]:truncate [&_small]:text-[var(--vui-font-xs)] [&_small]:text-vui-fg-secondary max-[860px]:[&_small]:whitespace-normal max-[860px]:[&_small]:overflow-visible max-[860px]:[&_small]:overflow-wrap-anywhere`,
  ...
  guardStrip:
    "my-1.5 grid min-w-0 grid-cols-[minmax(82px,max-content)_minmax(128px,max-content)_minmax(0,1fr)] items-center gap-[7px] rounded-[7px] border border-[var(--border-soft)] bg-[color-mix(in_srgb,var(--surface-card)_88%,transparent)] px-2 py-1.5 data-[tone=success]:border-[color-mix(in_srgb,var(--state-success)_34%,var(--border-soft))] data-[tone=warning]:border-[color-mix(in_srgb,var(--state-warning)_40%,var(--border-soft))] max-[620px]:grid-cols-[minmax(0,1fr)] [&_span]:text-[var(--vui-font-xs)] [&_span]:uppercase [&_span]:tracking-[0.06em] [&_span]:text-[var(--fg-tertiary)] [&_strong]:min-w-0 [&_strong]:truncate [&_strong]:text-[var(--vui-font-xs)] [&_strong]:text-[var(--fg-primary)] [&_small]:min-w-0 [&_small]:truncate [&_small]:text-[var(--vui-font-xs)] [&_small]:text-[var(--fg-secondary)]",
  specGrid:
    "mt-2 grid min-w-0 grid-cols-[minmax(72px,max-content)_minmax(0,1fr)] gap-x-2.5 gap-y-1.5 [&_dt]:m-0 [&_dt]:min-w-0 [&_dt]:text-[var(--vui-font-xs)] [&_dt]:uppercase [&_dt]:tracking-[0.06em] [&_dt]:text-[var(--fg-tertiary)] [&_dd]:m-0 [&_dd]:min-w-0 [&_dd]:truncate [&_dd]:text-[var(--vui-font-xs)] [&_dd]:leading-tight [&_dd]:text-[var(--fg-primary)]",
  diagnosticsGrid:
    "grid min-w-0 grid-cols-[minmax(72px,max-content)_minmax(0,1fr)] gap-x-2.5 gap-y-1.5 px-2.5 pb-2.5 [&_dt]:m-0 [&_dt]:min-w-0 [&_dt]:text-[var(--vui-font-xs)] [&_dt]:uppercase [&_dt]:tracking-[0.06em] [&_dt]:text-[var(--fg-tertiary)] [&_dd]:m-0 [&_dd]:min-w-0 [&_dd]:truncate [&_dd]:text-[var(--vui-font-xs)] [&_dd]:leading-tight [&_dd]:text-[var(--fg-primary)]",
  ...
  statusHead:
    "grid min-w-0 grid-cols-[minmax(140px,0.9fr)_minmax(92px,0.62fr)_minmax(160px,0.95fr)_minmax(0,1.7fr)] items-center gap-[7px] border-b border-[var(--border-soft)] bg-[color-mix(in_srgb,var(--surface-card)_94%,var(--surface-page))] px-2 py-1.5 text-[var(--vui-font-xs)] uppercase tracking-[0.06em] text-[var(--fg-tertiary)] max-[860px]:grid-cols-[minmax(118px,0.9fr)_minmax(82px,0.7fr)_minmax(0,1.4fr)] max-[860px]:[&>span:nth-child(3)]:hidden max-[620px]:grid-cols-[minmax(0,1fr)] max-[620px]:[&>span:nth-child(n+3)]:hidden",
  statusRow:
    "grid min-w-0 grid-cols-[minmax(140px,0.9fr)_minmax(92px,0.62fr)_minmax(160px,0.95fr)_minmax(0,1.7fr)] items-center gap-[7px] border-t border-[color-mix(in_srgb,var(--border-soft)_72%,transparent)] bg-[color-mix(in_srgb,var(--surface-page)_74%,var(--surface-card))] px-2 py-1.5 text-[var(--vui-font-xs)] text-[var(--fg-secondary)] first:border-t-0 data-[tone=success]:border-l-2 data-[tone=success]:border-l-[var(--state-success)] data-[tone=warning]:border-l-2 data-[tone=warning]:border-l-[var(--state-warning)] data-[tone=error]:border-l-2 data-[tone=error]:border-l-[var(--state-error)] max-[860px]:grid-cols-[minmax(118px,0.9fr)_minmax(82px,0.7fr)_minmax(0,1.4fr)] max-[860px]:[&>span:nth-child(3)]:hidden max-[620px]:grid-cols-[minmax(0,1fr)] max-[620px]:[&>span:nth-child(n+3)]:hidden [&_span]:min-w-0 [&_span]:truncate [&_strong]:text-[var(--fg-primary)]",
  guardianHead:
    "grid min-w-0 grid-cols-[minmax(178px,1fr)_minmax(120px,0.7fr)_minmax(84px,0.52fr)_minmax(0,1.7fr)] items-center gap-[7px] border-b border-[var(--border-soft)] bg-[color-mix(in_srgb,var(--surface-card)_94%,var(--surface-page))] px-2 py-1.5 text-[var(--vui-font-xs)] uppercase tracking-[0.06em] text-[var(--fg-tertiary)] max-[860px]:grid-cols-[minmax(140px,1fr)_minmax(96px,0.65fr)_minmax(82px,0.5fr)_minmax(0,1.4fr)] max-[620px]:grid-cols-[minmax(0,1fr)] max-[620px]:[&>span:nth-child(n+3)]:hidden",
  guardianRow:
  ...
  commandLine:
    `mt-2 grid min-w-0 grid-cols-[88px_minmax(0,1fr)] gap-x-2 gap-y-[5px] ${rowSurface} px-[9px] py-[7px] max-[620px]:grid-cols-[minmax(0,1fr)] ${panelHeaderText} [&_small]:col-start-2 [&_small]:min-w-0 [&_small]:truncate [&_small]:text-[var(--vui-font-xs)] [&_small]:text-vui-fg-secondary max-[620px]:[&_small]:col-start-1`,
  recoveryLine:
    `mt-2 grid min-w-0 grid-cols-[88px_minmax(0,1fr)] gap-x-2 gap-y-[5px] ${rowSurface} px-[9px] py-[7px] data-[tone=success]:border-[color-mix(in_srgb,var(--state-success)_36%,transparent)] data-[tone=warning]:border-[color-mix(in_srgb,var(--state-warning)_42%,transparent)] max-[620px]:grid-cols-[minmax(0,1fr)] ${panelHeaderText} [&_small]:col-start-2 [&_small]:min-w-0 [&_small]:truncate [&_small]:text-[var(--vui-font-xs)] [&_small]:text-vui-fg-secondary max-[620px]:[&_small]:col-start-1`,
  compactList: "mt-2 grid min-w-0 gap-[5px] [&>small]:text-[var(--fg-secondary)]",
  compactItem:
    "grid min-w-0 grid-cols-[minmax(150px,0.74fr)_minmax(0,1fr)] gap-2 border-b border-[color-mix(in_srgb,var(--border-soft)_68%,transparent)] py-[5px] data-[tone=success]:[&_strong]:text-[var(--state-success)] data-[tone=error]:[&_strong]:text-[var(--state-error)] max-[620px]:grid-cols-[minmax(0,1fr)] [&_strong]:min-w-0 [&_strong]:truncate [&_strong]:text-[var(--vui-font-xs)] [&_strong]:text-[var(--fg-primary)] [&_small]:min-w-0 [&_small]:truncate [&_small]:text-[var(--vui-font-xs)] [&_small]:text-[var(--fg-secondary)]",
  guardianSummary:
    "mt-2 grid min-w-0 grid-cols-[minmax(0,1fr)_repeat(3,max-content)_auto] items-center gap-2 text-[var(--vui-font-xs)] text-[var(--fg-secondary)] max-[860px]:grid-cols-2 max-[860px]:[&_span]:col-span-full max-[620px]:grid-cols-[minmax(0,1fr)] [&_span]:min-w-0 [&_span]:truncate [&_strong]:min-w-0 [&_strong]:truncate [&_strong]:font-semibold [&_strong]:text-[var(--fg-primary)]",
  diagnosticsPanel:
    "col-auto block min-h-0 p-0 [&_summary]:flex [&_summary]:min-w-0 [&_summary]:cursor-pointer [&_summary]:items-baseline [&_summary]:justify-between [&_summary]:gap-2.5 [&_summary]:px-2.5 [&_summary]:py-2 [&_summary]:text-[var(--fg-secondary)] [&_summary_span]:text-[var(--vui-font-xs)] [&_summary_span]:uppercase [&_summary_span]:tracking-[0.08em] [&_summary_span]:text-[var(--fg-tertiary)] [&_summary_strong]:text-[var(--fg-primary)]",
