...
const rowSurfaceHover = "hover:border-vui-border-soft hover:bg-[color-mix(in_srgb,var(--vui-surface-row-hover)_84%,transparent)]";
const mutedControl =
...
export const launcherRouteStyles = {
  ...
  statusHead:
    "grid min-w-0 grid-cols-[minmax(140px,0.9fr)_minmax(92px,0.62fr)_minmax(160px,0.95fr)_minmax(0,1.7fr)] items-center gap-[7px] border-b border-[var(--border-soft)] bg-[color-mix(in_srgb,var(--vui-surface-row)_94%,var(--vui-surface-base))] px-2 py-1.5 text-[var(--vui-font-xs)] uppercase tracking-[0.06em] text-[var(--fg-tertiary)] max-[860px]:grid-cols-[minmax(118px,0.9fr)_minmax(82px,0.7fr)_minmax(0,1.4fr)] max-[860px]:[&>span:nth-child(3)]:hidden max-[620px]:grid-cols-[minmax(0,1fr)] max-[620px]:[&>span:nth-child(n+3)]:hidden",
  statusRow:
    "grid min-w-0 grid-cols-[minmax(140px,0.9fr)_minmax(92px,0.62fr)_minmax(160px,0.95fr)_minmax(0,1.7fr)] items-center gap-[7px] border-t border-[color-mix(in_srgb,var(--border-soft)_72%,transparent)] bg-[color-mix(in_srgb,var(--vui-surface-base)_74%,var(--vui-surface-row))] px-2 py-1.5 text-[var(--vui-font-xs)] text-[var(--fg-secondary)] first:border-t-0 data-[tone=success]:border-l-2 data-[tone=success]:border-l-[var(--state-success)] data-[tone=warning]:border-l-2 data-[tone=warning]:border-l-[var(--state-warning)] data-[tone=error]:border-l-2 data-[tone=error]:border-l-[var(--state-error)] max-[860px]:grid-cols-[minmax(118px,0.9fr)_minmax(82px,0.7fr)_minmax(0,1.4fr)] max-[860px]:[&>span:nth-child(3)]:hidden max-[620px]:grid-cols-[minmax(0,1fr)] max-[620px]:[&>span:nth-child(n+3)]:hidden [&_span]:min-w-0 [&_span]:truncate [&_strong]:text-[var(--fg-primary)]",
  guardianHead:
    "grid min-w-0 grid-cols-[minmax(178px,1fr)_minmax(120px,0.7fr)_minmax(84px,0.52fr)_minmax(0,1.7fr)] items-center gap-[7px] border-b border-[var(--border-soft)] bg-[color-mix(in_srgb,var(--vui-surface-row)_94%,var(--vui-surface-base))] px-2 py-1.5 text-[var(--vui-font-xs)] uppercase tracking-[0.06em] text-[var(--fg-tertiary)] max-[860px]:grid-cols-[minmax(140px,1fr)_minmax(96px,0.65fr)_minmax(82px,0.5fr)_minmax(0,1.4fr)] max-[620px]:grid-cols-[minmax(0,1fr)] max-[620px]:[&>span:nth-child(n+3)]:hidden",
  guardianRow:
