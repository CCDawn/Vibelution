...
const statusFilterLabelClass = "whitespace-nowrap text-[0.72rem] font-bold";
...
const eyebrowClass = "m-0 mb-0.5 text-[0.72rem] font-bold uppercase tracking-[0.08em] text-vui-fg-tertiary";
...
const taskRowMetaClass = "grid gap-[3px] text-[0.76rem] leading-[1.35] text-vui-fg-secondary";
const monoCodeClass = "break-words text-[0.75rem] text-vui-fg-tertiary";
...
const metricLabelClass = "text-[0.68rem] uppercase tracking-[0.06em] text-vui-fg-tertiary";
const metricValueClass = "min-w-0 truncate text-[0.82rem] text-vui-fg-primary";
const selectionNoticeClass = "rounded-lg border border-[color-mix(in_srgb,var(--state-warning)_28%,transparent)] bg-[color-mix(in_srgb,var(--state-warning)_8%,transparent)] px-2 py-[7px] text-[0.76rem] leading-[1.35] text-vui-fg-secondary";
...
const sectionCountClass = "text-[0.76rem] text-vui-fg-tertiary";
...
const mutedLineClass = "text-[0.78rem] leading-[1.35] text-vui-fg-secondary";
const warningLineClass = "text-[0.78rem] not-italic leading-[1.35] text-[var(--state-warning)]";
...
const timelineKindClass = "text-[0.82rem] text-vui-fg-primary";
const timelineSummaryClass = "m-0 my-[3px] text-[0.78rem] leading-[1.35] text-vui-fg-secondary";
const chipsClass = "mt-[5px] flex flex-wrap gap-[5px]";
const chipCodeClass = "rounded-full border border-vui-border-soft bg-[var(--surface-code)] px-1.5 py-[3px] text-[0.75rem] text-vui-fg-tertiary";
const refListClass = "mt-[5px] flex flex-wrap gap-[5px]";
const emptyInlineClass = "text-[0.78rem] leading-[1.35] text-vui-fg-secondary";
const statusPillBaseClass = "inline-flex min-h-[22px] items-center whitespace-nowrap rounded-full border border-vui-border-soft px-[7px] text-[0.72rem]";
...
const emptyDetailClass = "text-[0.78rem] text-vui-fg-secondary";
