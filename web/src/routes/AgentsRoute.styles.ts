...
const styles = {
  activityTimelineItem:
    "grid [gap:4px] min-w-0 max-w-full [padding:7px_8px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_p]:min-w-0 [&_p]:[overflow:hidden] [&_p]:[text-overflow:ellipsis] [&_small]:min-w-0 [&_small]:[overflow:hidden] [&_small]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_small]:[white-space:nowrap] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_p]:[display:-webkit-box] [&_p]:[margin:0] [&_p]:[color:var(--fg-secondary)] [&_p]:[font-size:var(--vui-font-xs)] [&_p]:[line-height:1.35] [&_p]:[-webkit-box-orient:vertical] [&_p]:[-webkit-line-clamp:2] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)]",
  activityTimelineItem_context:
    "[border-color:color-mix(in_srgb,_var(--fg-tertiary)_22%,_var(--border-soft))]",
  activityTimelineItem_inbox:
    "[border-color:color-mix(in_srgb,_var(--state-success)_28%,_var(--border-soft))] [background:color-mix(in_srgb,_var(--state-success)_5%,_var(--surface-panel))]",
  activityTimelineItem_run:
    "[border-color:color-mix(in_srgb,_var(--accent-cool)_28%,_var(--border-soft))] [background:color-mix(in_srgb,_var(--accent-cool)_5%,_var(--surface-panel))]",
  activityTimelineItem_sub_run:
    "[border-color:color-mix(in_srgb,_var(--accent-warm)_28%,_var(--border-soft))] [background:color-mix(in_srgb,_var(--accent-warm)_5%,_var(--surface-panel))]",
  ...
  agentRoleTag:
    "inline-flex [align-items:center] [justify-content:center] [border:1px_solid_var(--border-soft)] [border-radius:999px] [font-weight:700] [white-space:nowrap] [justify-self:start] [min-height:22px] [max-width:100%] [padding:0_7px] [font-size:var(--vui-font-xs)] [line-height:1] [overflow:hidden] [text-overflow:ellipsis]",
  agentRoleTag_chat:
    "[border-color:color-mix(in_srgb,_var(--accent-warm)_34%,_var(--border-soft))] [background:color-mix(in_srgb,_var(--accent-warm)_12%,_transparent)] [color:var(--accent-warm-2)]",
  agentRoleTag_general:
    "[border-color:color-mix(in_srgb,_var(--fg-tertiary)_24%,_var(--border-soft))] [background:color-mix(in_srgb,_var(--fg-tertiary)_8%,_transparent)] [color:var(--fg-secondary)]",
  agentRoleTag_memory:
    "[border-color:color-mix(in_srgb,_var(--fg-tertiary)_30%,_var(--border-soft))] [background:color-mix(in_srgb,_var(--fg-tertiary)_10%,_transparent)] [color:var(--fg-secondary)]",
  agentRoleTag_research:
    "[border-color:color-mix(in_srgb,_var(--accent-cool)_36%,_var(--border-soft))] [background:color-mix(in_srgb,_var(--accent-cool)_13%,_transparent)] [color:var(--accent-cool-2)]",
  agentRoleTag_self:
    "[border-color:color-mix(in_srgb,_var(--state-success)_34%,_var(--border-soft))] [background:color-mix(in_srgb,_var(--state-success)_12%,_transparent)] [color:var(--state-success)]",
  agentRoleTag_supervised:
    "[border-color:color-mix(in_srgb,_var(--state-warning)_36%,_var(--border-soft))] [background:color-mix(in_srgb,_var(--state-warning)_12%,_transparent)] [color:var(--state-warning)]",
  agentRoleTag_tool:
    "[border-color:color-mix(in_srgb,_var(--fg-tertiary)_30%,_var(--border-soft))] [background:color-mix(in_srgb,_var(--fg-tertiary)_10%,_transparent)] [color:var(--fg-secondary)]",
  agentRow:
    "grid [grid-template-columns:minmax(180px,_1.3fr)_minmax(120px,_0.86fr)_minmax(110px,_0.82fr)_minmax(88px,_0.48fr)_minmax(104px,_0.72fr)_minmax(128px,_0.68fr)] [gap:8px] [align-items:center] min-w-0 max-w-full [width:100%] [min-height:44px] [padding:var(--agent-row-pad-y)_8px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:8px] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [color:var(--fg-primary)] [text-align:left] [transition:border-color_160ms_ease,_background_160ms_ease] hover:[border-color:var(--border-strong)] hover:[background:color-mix(in_srgb,_var(--surface-panel-hover)_70%,_transparent)] [&_span]:min-w-0 [&_span]:[overflow:hidden] [&_span]:[text-overflow:ellipsis] max-[860px]:[grid-template-columns:1fr] max-[860px]:[align-items:start]",
  agentRowActive:
  ...
  agentTableHead:
    "grid [grid-template-columns:minmax(180px,_1.3fr)_minmax(120px,_0.86fr)_minmax(110px,_0.82fr)_minmax(88px,_0.48fr)_minmax(104px,_0.72fr)_minmax(128px,_0.68fr)] [gap:8px] [align-items:center] min-w-0 [position:sticky] [top:0] [z-index:1] [padding:0_8px_5px] [color:var(--fg-tertiary)] [font-size:var(--vui-font-xs)] [text-transform:uppercase] [background:var(--surface-panel)] max-[860px]:hidden",
  avatarEditorActions:
  ...
  boundarySummaryGrid:
    "grid [align-content:start] [gap:5px] min-w-0 max-w-full [grid-template-columns:repeat(3,_minmax(0,_1fr))] [&_span]:grid [&_span]:[gap:2px] [&_span]:min-w-0 [&_span]:[padding:7px_8px] [&_span]:[border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [&_span]:[border-radius:var(--radius-control)] [&_span]:[background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_small]:min-w-0 [&_small]:[overflow:hidden] [&_small]:[text-overflow:ellipsis] [&_small]:[white-space:nowrap] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)]",
  bulkFieldHeader:
  ...
  bulkSelectionList:
    "flex [flex-wrap:wrap] [gap:6px] min-w-0 [&_span]:[max-width:100%] [&_span]:[overflow:hidden] [&_span]:[padding:3px_7px] [&_span]:[border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [&_span]:[border-radius:var(--radius-control)] [&_span]:[background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [&_span]:[color:var(--fg-secondary)] [&_span]:[font-size:var(--vui-font-xs)] [&_span]:[text-overflow:ellipsis] [&_span]:[white-space:nowrap]",
  capabilityPreviewPanel:
    "grid [grid-template-columns:minmax(150px,_1.35fr)_repeat(4,_minmax(0,_1fr))] [gap:6px] min-w-0 [padding:8px] [border:1px_solid_color-mix(in_srgb,_var(--accent-warm)_20%,_var(--border-soft))] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--accent-warm)_5%,_transparent)] [&_div]:grid [&_div]:[gap:2px] [&_div]:min-w-0 [&_span]:min-w-0 [&_span]:[overflow:hidden] [&_span]:[text-overflow:ellipsis] [&_span]:[white-space:nowrap] [&_small]:min-w-0 [&_small]:[overflow:hidden] [&_small]:[text-overflow:ellipsis] [&_small]:[white-space:nowrap] [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_span]:[color:var(--fg-primary)] [&_span]:[font-size:var(--vui-font-xs)] [&_span]:[font-weight:760] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)] [&_strong]:[align-self:stretch] [&_strong]:[padding:5px_6px] [&_strong]:[border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [&_strong]:[border-radius:var(--radius-control)] [&_strong]:[background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [&_strong]:[color:var(--fg-secondary)] [&_strong]:[font-size:var(--vui-font-xs)]",
  checkField:
    "flex [align-items:center] [gap:8px] min-w-0 max-w-full [min-height:30px] [padding:0_8px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [color:var(--fg-secondary)] [font-size:var(--vui-font-xs)] [&_input]:[flex:0_0_auto] [&_span]:min-w-0 [&_span]:[overflow:hidden] [&_span]:[text-overflow:ellipsis] [&_span]:[white-space:nowrap]",
  cleanPill:
  ...
  compressionInlineCheck:
    "inline-flex [align-items:center] [gap:7px] min-w-0 [min-height:30px] [padding:0_8px] [border:1px_solid_var(--border-soft)] [border-radius:var(--radius-control)] [background:var(--surface-panel)] [color:var(--fg-secondary)] [font-size:var(--vui-font-xs)] [font-weight:700] [&_input]:[flex:0_0_auto] [&_input]:[width:16px] [&_input]:[height:16px] [&_input]:[min-height:16px] [&_input]:[margin:0] [&_span]:min-w-0 [&_span]:[overflow:hidden] [&_span]:[color:inherit] [&_span]:[text-overflow:ellipsis] [&_span]:[white-space:nowrap]",
  ...
  compressionPolicySubgrid:
    "grid [gap:7px] min-w-0 [grid-template-columns:repeat(4,_minmax(0,_1fr))] [padding:7px] [border:1px_solid_color-mix(in_srgb,_var(--accent-cool)_14%,_var(--border-soft))] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--surface-panel)_70%,_transparent)] max-[860px]:[grid-template-columns:1fr]",
  ...
  configEditor:
    "grid [gap:8px] min-w-0 max-w-full [padding:10px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:8px] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)]",
  contextModeGrid:
  ...
  countPill:
    "inline-flex [align-items:center] [justify-content:center] [min-height:26px] [padding:0_7px] [border:1px_solid_var(--border-soft)] [border-radius:999px] [font-size:var(--vui-font-xs)] [font-weight:700] [white-space:nowrap]",
  createAgentGrid:
    "grid [grid-template-columns:repeat(2,_minmax(0,_1fr))] [gap:7px] min-w-0 max-[860px]:[grid-template-columns:1fr]",
  createAgentPanel:
    "grid [align-content:start] [gap:8px] min-w-0 min-h-0 [padding:10px] [border:1px_solid_color-mix(in_srgb,_var(--accent-cool)_26%,_var(--border-soft))] [border-radius:8px] [background:color-mix(in_srgb,_var(--accent-cool)_6%,_transparent)] [overflow:auto] [&_p]:[margin:0] [&_p]:[color:var(--fg-secondary)] [&_p]:[font-size:var(--vui-font-xs)] [&_p]:[line-height:1.42] [&_p]:[overflow-wrap:anywhere]",
  ...
  createToolBundleOption:
    "grid [grid-template-columns:auto_minmax(0,_1fr)] [align-items:flex-start] [gap:7px] min-w-0 [padding:8px] [border:1px_solid_var(--border-soft)] [border-radius:8px] [background:color-mix(in_srgb,_var(--surface-panel)_78%,_transparent)] [&_input]:[margin-top:2px] [&_span]:grid [&_span]:[gap:2px] [&_span]:min-w-0 [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_strong]:[white-space:nowrap]",
  createToolBundlePreview:
    "[padding:7px_8px] [border:1px_solid_var(--border-soft)] [border-radius:8px] [background:color-mix(in_srgb,_var(--surface-panel)_72%,_transparent)] [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap]",
  createToolBundleSelected:
    "grid [grid-template-columns:auto_minmax(0,_1fr)] [align-items:flex-start] [gap:7px] min-w-0 [padding:8px] [border:1px_solid_var(--border-soft)] [border-radius:8px] [border-color:color-mix(in_srgb,_var(--accent-cool)_44%,_var(--border-soft))] [background:color-mix(in_srgb,_var(--accent-cool)_10%,_var(--surface-panel))] [&_input]:[margin-top:2px] [&_span]:grid [&_span]:[gap:2px] [&_span]:min-w-0 [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_strong]:[white-space:nowrap]",
  dangerButton:
  ...
  detailPanelCreating:
    "max-[1040px]:hidden",
  detailSection:
    "min-w-0 max-w-full [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:8px] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [&_svg]:[grid-area:icon] [&_svg]:[color:var(--accent-cool)] grid [gap:8px] [padding:10px]",
  detailTab:
  ...
  detailTabs:
    "grid [grid-template-columns:repeat(3,_minmax(0,_1fr))] [gap:4px] min-w-0 [padding:4px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:8px] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] max-[860px]:[grid-template-columns:1fr]",
  dirtyPill:
  ...
  emptyState:
    "grid [place-items:start] [align-content:start] [justify-items:start] [gap:6px] [min-height:72px] [padding:10px] [border:1px_dashed_var(--border-soft)] [border-radius:8px] [color:var(--fg-secondary)] [text-align:left] [&_svg]:[width:17px] [&_svg]:[height:17px] [&_svg]:[color:var(--accent-cool)] [&_strong]:[color:var(--fg-primary)] [&_p]:[margin:0] [&_p]:[max-width:52ch] [&_p]:[font-size:var(--vui-font-xs)] [&_p]:[line-height:1.34] [&_p]:[overflow-wrap:anywhere]",
  emptyText:
  ...
  groupButton:
    "grid max-w-full [grid-template-columns:minmax(0,_1fr)_auto_auto] [align-items:center] [gap:8px] [width:100%] [min-height:34px] [padding:6px_9px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:8px] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [color:var(--fg-secondary)] [text-align:left] [transition:border-color_160ms_ease,_background_160ms_ease,_color_160ms_ease] hover:[border-color:var(--border-strong)] hover:[color:var(--fg-primary)] hover:[background:color-mix(in_srgb,_var(--surface-panel-hover)_70%,_transparent)] [&_span]:inline-flex [&_span]:[align-items:center] [&_span]:[gap:8px] [&_span]:min-w-0 [&_span]:[overflow:hidden] [&_span]:[text-overflow:ellipsis] [&_span]:[white-space:nowrap] [&_strong]:inline-flex [&_strong]:[align-items:center] [&_strong]:[justify-content:center] [&_strong]:[min-width:22px] [&_strong]:[min-height:22px] [&_strong]:[border-radius:999px] [&_strong]:[font-style:normal] [&_strong]:[font-size:var(--vui-font-xs)] [&_em]:inline-flex [&_em]:[align-items:center] [&_em]:[justify-content:center] [&_em]:[min-width:22px] [&_em]:[min-height:22px] [&_em]:[border-radius:999px] [&_em]:[font-style:normal] [&_em]:[font-size:var(--vui-font-xs)] [&_strong]:[background:color-mix(in_srgb,_var(--accent-cool)_12%,_transparent)] [&_strong]:[color:var(--accent-cool)] [&_em]:[gap:4px] [&_em]:[padding:0_7px] [&_em]:[background:color-mix(in_srgb,_var(--accent-warm)_12%,_transparent)] [&_em]:[color:var(--accent-warm-2)]",
  groupButtonActive:
  ...
  healthGuidePanel:
    "grid [gap:7px] min-w-0 [padding:8px] [border:1px_solid_var(--border-soft)] [border-radius:var(--radius-control)] [background:var(--surface-panel)] [&_div]:grid [&_div]:[gap:2px] [&_div]:min-w-0 [&_span]:[color:var(--fg-tertiary)] [&_span]:[font-size:var(--vui-font-xs)] [&_span]:[font-weight:760] [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_p]:[margin:0] [&_p]:[color:var(--fg-secondary)] [&_p]:[font-size:var(--vui-font-xs)] [&_p]:[line-height:1.38] [&_strong]:[margin-right:6px] [&_strong]:[color:var(--fg-tertiary)] [&_strong]:[font-size:var(--vui-font-xs)]",
  healthGuide_blocking:
    "[border-color:color-mix(in_srgb,_var(--state-error)_28%,_transparent)] [background:color-mix(in_srgb,_var(--state-error)_7%,_var(--surface-panel))]",
  healthGuide_info:
    "[border-color:color-mix(in_srgb,_var(--accent-warm)_28%,_transparent)] [background:color-mix(in_srgb,_var(--accent-warm)_7%,_var(--surface-panel))]",
  healthGuide_ok:
    "[border-color:color-mix(in_srgb,_var(--state-success)_24%,_transparent)] [background:color-mix(in_srgb,_var(--state-success)_7%,_var(--surface-panel))]",
  healthGuide_warning:
    "[border-color:color-mix(in_srgb,_var(--accent-warm)_28%,_transparent)] [background:color-mix(in_srgb,_var(--accent-warm)_7%,_var(--surface-panel))]",
  healthPill:
    "inline-flex [align-items:center] [justify-content:center] [min-height:26px] [padding:0_7px] [border:1px_solid_var(--border-soft)] [border-radius:999px] [font-size:var(--vui-font-xs)] [font-weight:700] [white-space:nowrap]",
  ...
  iconButton:
    "grid w-[26px] h-[26px] [place-items:center] [width:26px] [height:26px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [color:var(--fg-secondary)] [font:inherit] [font-size:1rem] [cursor:pointer]",
  inboxMessageItem:
    "grid [gap:5px] min-w-0 max-w-full [padding:7px_8px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_p]:min-w-0 [&_p]:[overflow:hidden] [&_p]:[text-overflow:ellipsis] [&_small]:min-w-0 [&_small]:[overflow:hidden] [&_small]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_small]:[white-space:nowrap] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_p]:[display:-webkit-box] [&_p]:[margin:0] [&_p]:[color:var(--fg-secondary)] [&_p]:[font-size:var(--vui-font-xs)] [&_p]:[line-height:1.35] [&_p]:[-webkit-box-orient:vertical] [&_p]:[-webkit-line-clamp:2] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)]",
  ...
  inlineAdd:
    "grid [grid-template-columns:minmax(0,_1fr)_auto] [gap:6px] min-w-0 [&_input]:min-w-0 [&_input]:[min-height:32px] [&_input]:[border-radius:var(--radius-control)] [&_input]:[font:inherit] [&_input]:[font-size:var(--vui-font-xs)] [&_input]:[width:100%] [&_input]:[padding:0_8px] [&_input]:[border:1px_solid_var(--border-soft)] [&_input]:[background:color-mix(in_srgb,_var(--surface-input)_84%,_transparent)] [&_input]:[color:var(--fg-primary)] [&_[data-vui=\"button\"]]:[white-space:nowrap]",
  issueItem:
    "grid [gap:4px] min-w-0 [padding:7px_8px] [border:1px_solid_var(--border-soft)] [border-radius:8px] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_p]:[margin:0] [&_p]:[color:var(--fg-secondary)] [&_p]:[font-size:var(--vui-font-xs)] [&_p]:[line-height:1.4]",
  issueItem_blocking:
  ...
  issue_warning:
    "[border-color:color-mix(in_srgb,_var(--accent-warm)_30%,_transparent)] [background:color-mix(in_srgb,_var(--accent-warm)_10%,_transparent)] [color:var(--accent-warm-2)]",
  llmSlotField:
    "grid [gap:5px] min-w-0 [padding:7px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_88%,_transparent)] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--surface-panel)_78%,_transparent)] [&_span]:grid [&_span]:[grid-template-columns:minmax(0,_1fr)_auto] [&_span]:[align-items:center] [&_span]:[gap:8px] [&_span]:min-w-0 [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[color:var(--fg-secondary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_small]:[display:-webkit-box] [&_small]:[min-height:32px] [&_small]:[overflow:hidden] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)] [&_small]:[line-height:1.32] [&_small]:[-webkit-box-orient:vertical] [&_small]:[-webkit-line-clamp:2] [&_select]:[width:100%] [&_select]:min-w-0 [&_select]:[min-height:30px] [&_select]:[border:1px_solid_var(--border-soft)] [&_select]:[border-radius:var(--radius-control)] [&_select]:[background:var(--surface-panel)] [&_select]:[color:var(--fg-primary)] [&_select]:[font:inherit] [&_select]:[font-size:var(--vui-font-xs)] [&_select]:[padding:0_8px] [&_select]:focus:[outline:2px_solid_color-mix(in_srgb,_var(--accent-cool)_24%,_transparent)] [&_select]:focus:[border-color:color-mix(in_srgb,_var(--accent-cool)_48%,_transparent)]",
  llmSlotGrid:
    "grid [grid-template-columns:repeat(2,_minmax(0,_1fr))] [gap:8px] min-w-0",
  maintenanceIntro:
    "grid [grid-template-columns:minmax(0,_0.8fr)_minmax(0,_1.2fr)] [align-items:center] [gap:10px] min-w-0 [padding:9px_10px] [border:1px_solid_var(--border-soft)] [border-radius:8px] [background:color-mix(in_srgb,_var(--surface-panel)_72%,_transparent)] [&_div]:grid [&_div]:[gap:2px] [&_div]:min-w-0 [&_p]:[margin:0] [&_p]:min-w-0 [&_p]:[overflow:hidden] [&_p]:[text-overflow:ellipsis] [&_p]:[color:var(--fg-secondary)] [&_p]:[font-size:var(--vui-font-xs)] [&_p]:[line-height:1.36]",
  ...
  managementBriefPanel:
    "grid [gap:7px] min-w-0 [padding:9px] [border:1px_solid_color-mix(in_srgb,_var(--accent-cool)_24%,_var(--border-soft))] [border-radius:8px] [background:color-mix(in_srgb,_var(--accent-cool)_5%,_transparent)]",
  managementChecklist:
  ...
  memoryPolicyGrid:
    "grid [grid-template-columns:repeat(2,_minmax(0,_1fr))] [gap:7px] min-w-0 [&_section]:grid [&_section]:[align-content:start] [&_section]:[gap:6px] [&_section]:min-w-0 [&_section]:[padding:8px] [&_section]:[border:1px_solid_var(--border-soft)] [&_section]:[border-radius:var(--radius-control)] [&_section]:[background:var(--surface-panel)] [&_span]:[color:var(--fg-tertiary)] [&_span]:[font-size:var(--vui-font-xs)] max-[860px]:[grid-template-columns:1fr]",
  modeList:
  ...
  policyGrid:
    "grid [grid-template-columns:repeat(3,_minmax(0,_1fr))] [gap:6px] [&_div]:min-w-0 [&_div]:[border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [&_div]:[border-radius:8px] [&_div]:[background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [&_div]:grid [&_div]:[grid-template-columns:auto_minmax(0,_1fr)] [&_div]:[grid-template-rows:auto_auto] [&_div]:[column-gap:8px] [&_div]:[row-gap:2px] [&_div]:[padding:7px_8px_8px] [&_svg]:[grid-column:1] [&_svg]:[grid-row:1_/_3] [&_svg]:[color:var(--accent-cool)] [&_span]:[grid-column:2] [&_span]:[grid-row:1] [&_span]:[color:var(--fg-tertiary)] [&_span]:[font-size:var(--vui-font-xs)] [&_strong]:[grid-column:2] [&_strong]:[grid-row:2] [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] max-[860px]:[grid-template-columns:1fr]",
  policyHint:
    "[margin:0] [color:var(--fg-secondary)] [font-size:var(--vui-font-xs)] [line-height:1.42] [overflow-wrap:anywhere]",
  policySummaryGrid:
    "grid [grid-template-columns:repeat(4,_minmax(0,_1fr))] [gap:6px] min-w-0 max-w-full [&_span]:min-w-0 [&_span]:[padding:6px_7px] [&_span]:[border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [&_span]:[border-radius:var(--radius-control)] [&_span]:[background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [&_span]:[color:var(--fg-secondary)] [&_span]:[font-size:var(--vui-font-xs)] [&_span]:[overflow:hidden] [&_span]:[text-overflow:ellipsis] [&_span]:[white-space:nowrap] [&_strong]:[color:var(--fg-primary)]",
  primaryButton:
  ...
  resetOptionField:
    "grid [grid-template-columns:auto_minmax(0,_1fr)] [align-items:start] [gap:8px] min-w-0 [min-height:58px] [padding:7px_8px] [border:1px_solid_var(--border-soft)] [border-radius:var(--radius-control)] [background:var(--surface-panel)] [color:var(--fg-secondary)] [&_input]:[margin-top:3px] [&_span]:grid [&_span]:[gap:2px] [&_span]:min-w-0 [&_strong]:min-w-0 [&_strong]:[overflow-wrap:anywhere] [&_small]:min-w-0 [&_small]:[overflow-wrap:anywhere] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)] [&_small]:[line-height:1.32]",
  resetOptionGrid:
    "grid [grid-template-columns:repeat(3,_minmax(0,_1fr))] [gap:6px] min-w-0 max-[860px]:[grid-template-columns:1fr]",
  resetZone:
    "grid [gap:8px] min-w-0 [padding:10px] [border:1px_solid_color-mix(in_srgb,_var(--state-warning)_28%,_var(--border-soft))] [border-radius:8px] [background:color-mix(in_srgb,_var(--state-warning)_7%,_transparent)] [&_svg]:[color:var(--state-warning)]",
  returnBanner:
  ...
  roomCheckField:
    "grid [grid-template-columns:auto_minmax(0,_1fr)] [align-items:center] [gap:8px] min-w-0 max-w-full [min-height:36px] [padding:6px_8px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [color:var(--fg-secondary)] [&_input]:[margin:0] [&_span]:grid [&_span]:[gap:2px] [&_span]:min-w-0 [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_small]:min-w-0 [&_small]:[overflow:hidden] [&_small]:[text-overflow:ellipsis] [&_small]:[white-space:nowrap] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)]",
  roomMembershipList:
    "grid [align-content:start] [gap:7px] min-w-0 [max-height:220px] [overflow:auto] [padding-right:3px]",
  route:
    "grid max-w-full [grid-template-rows:auto_auto_minmax(0,_1fr)] [height:100%] min-h-0 [overflow-x:hidden] [--agent-density-gap:6px] [--agent-panel-pad:10px] [--agent-row-pad-y:6px] [--agent-control-height:26px] max-[860px]:[height:100%] max-[860px]:min-h-0 max-[860px]:[grid-template-rows:auto_auto_minmax(0,_1fr)] max-[860px]:[overflow:hidden] max-[860px]:[overflow-x:hidden]",
  rowSelect:
    "grid [place-items:center] [width:28px] [height:36px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:8px] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [color:var(--fg-secondary)] [cursor:pointer] hover:[border-color:var(--border-strong)] hover:[color:var(--accent-warm-2)] [&_input]:[position:absolute] [&_input]:[width:1px] [&_input]:[height:1px] [&_input]:[opacity:0] [&_input]:[pointer-events:none]",
  runHistoryItem:
    "grid [gap:3px] min-w-0 max-w-full [padding:7px_8px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_span]:min-w-0 [&_span]:[overflow:hidden] [&_span]:[text-overflow:ellipsis] [&_span]:[white-space:nowrap] [&_small]:min-w-0 [&_small]:[overflow:hidden] [&_small]:[text-overflow:ellipsis] [&_small]:[white-space:nowrap] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_span]:[color:var(--fg-secondary)] [&_span]:[font-size:var(--vui-font-xs)] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)]",
  runHistoryList:
    "grid [align-content:start] [gap:5px] min-w-0 [max-height:260px] [overflow:auto] [padding-right:3px]",
  runtimeEvidenceHint:
    "grid [grid-template-columns:auto_auto_minmax(0,_1fr)] [gap:8px] [align-items:center] min-w-0 max-w-full [padding:8px_10px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_span]:min-w-0 [&_span]:[overflow:hidden] [&_span]:[text-overflow:ellipsis] [&_span]:[white-space:nowrap] [&_code]:min-w-0 [&_code]:[overflow:hidden] [&_code]:[text-overflow:ellipsis] [&_code]:[white-space:nowrap] [&_strong]:[color:var(--fg-tertiary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_strong]:[font-weight:700] [&_strong]:[text-transform:uppercase] [&_span]:[color:var(--fg-secondary)] [&_span]:[font-size:var(--vui-font-xs)] [&_span]:[font-weight:700] [&_code]:[color:var(--fg-primary)] [&_code]:[font-family:var(--font-mono,_ui-monospace,_SFMono-Regular,_Consolas,_monospace)] [&_code]:[font-size:var(--vui-font-xs)]",
  runtimeFocusHeader:
    "grid [grid-template-columns:minmax(0,_1fr)_auto] [gap:10px] [align-items:center] min-w-0",
  runtimeFocusMeta:
    "[&_code]:min-w-0 [&_code]:[overflow:hidden] [&_code]:[text-overflow:ellipsis] [&_code]:[white-space:nowrap] grid [grid-template-columns:repeat(3,_minmax(0,_1fr))] [gap:6px] min-w-0 [&_span]:grid [&_span]:[gap:3px] [&_span]:min-w-0 [&_span]:[padding:6px_7px] [&_span]:[border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [&_span]:[border-radius:var(--radius-control)] [&_span]:[background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [&_strong]:[color:var(--fg-tertiary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_strong]:[font-weight:700] [&_strong]:[text-transform:uppercase] [&_code]:[color:var(--fg-secondary)] [&_code]:[font-family:var(--font-mono,_ui-monospace,_SFMono-Regular,_Consolas,_monospace)] [&_code]:[font-size:var(--vui-font-xs)]",
  runtimeFocusPanel:
    "grid [gap:8px] min-w-0 [padding:10px] [border:1px_solid_color-mix(in_srgb,_var(--accent-cool)_28%,_var(--border-soft))] [border-radius:8px] [background:color-mix(in_srgb,_var(--accent-cool)_6%,_var(--surface-panel))] [box-shadow:none] [&_p]:min-w-0 [&_p]:[overflow:hidden] [&_p]:[text-overflow:ellipsis] [&_p]:[white-space:nowrap] [&_p]:[margin:0] [&_p]:[color:var(--fg-secondary)] [&_p]:[font-size:var(--vui-font-xs)]",
  runtimeNextStep:
  ...
  runtime_unknown:
    "[border-color:color-mix(in_srgb,_var(--fg-tertiary)_24%,_transparent)] [background:color-mix(in_srgb,_var(--fg-tertiary)_8%,_transparent)] [color:var(--fg-secondary)]",
  searchBox:
    "flex [align-items:center] [gap:8px] [min-height:32px] [padding:0_9px] [border:1px_solid_var(--border-soft)] [border-radius:8px] [background:color-mix(in_srgb,_var(--surface-input)_84%,_transparent)] [color:var(--fg-tertiary)] focus-within:[border-color:color-mix(in_srgb,_var(--accent-cool)_44%,_transparent)] focus-within:[box-shadow:var(--focus-ring)] focus-within:[color:var(--fg-secondary)] [&_input]:min-w-0 [&_input]:[width:100%] [&_input]:[border:0] [&_input]:[outline:0] [&_input]:[background:transparent] [&_input]:[color:var(--fg-primary)] [&_input]:[font:inherit] [&_input]:[font-size:var(--vui-font-xs)]",
  secondaryButton:
    "inline-flex w-fit max-w-full [align-items:center] [justify-content:center] [gap:7px] [min-height:30px] [padding:0_10px] [border-radius:var(--radius-control)] [font-weight:700] [border:1px_solid_var(--border-soft)] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [color:var(--fg-secondary)] disabled:[cursor:not-allowed] disabled:[opacity:0.55]",
  segmentActive:
  ...
  segmentButton:
    "inline-flex [align-items:center] [justify-content:center] [min-height:24px] [padding:0_7px] [border:1px_solid_transparent] [border-radius:calc(var(--radius-control)_-_2px)] [background:transparent] [color:var(--fg-tertiary)] [font-size:var(--vui-font-xs)] [font-weight:700] [white-space:nowrap] hover:[background:var(--surface-panel-hover)] hover:[color:var(--fg-secondary)]",
  segmentedControl:
    "inline-grid max-w-full [grid-template-columns:repeat(3,_minmax(56px,_auto))] [gap:3px] [padding:3px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)]",
  storagePanel:
    "grid [gap:5px] min-w-0 max-w-full [padding:8px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:8px] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [&_code]:min-w-0 [&_code]:[overflow:hidden] [&_code]:[color:var(--fg-secondary)] [&_code]:[font-size:var(--vui-font-xs)] [&_code]:[text-overflow:ellipsis] [&_code]:[white-space:nowrap]",
  successText:
  ...
  toolBundleItem:
    "grid [grid-template-columns:minmax(0,_1fr)_auto] [grid-template-rows:auto_auto] [align-items:center] [gap:4px_8px] min-w-0 max-w-full [padding:7px_8px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [&_span]:[grid-column:1] [&_span]:[grid-row:1] [&_span]:grid [&_span]:[gap:2px] [&_span]:min-w-0 [&_p]:[grid-column:1] [&_p]:[grid-row:2] [&_p]:[margin:0] [&_p]:min-w-0 [&_p]:[overflow:hidden] [&_p]:[color:var(--fg-secondary)] [&_p]:[font-size:var(--vui-font-xs)] [&_p]:[line-height:1.35] [&_p]:[text-overflow:ellipsis] [&_p]:[white-space:nowrap] [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_small]:min-w-0 [&_small]:[overflow:hidden] [&_small]:[text-overflow:ellipsis] [&_small]:[white-space:nowrap] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)] max-[860px]:[grid-template-columns:1fr]",
  toolBundleList:
  ...
  toolBundlePanel:
    "grid [gap:7px] min-w-0 [padding:8px] [border:1px_solid_var(--border-soft)] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--surface-panel)_72%,_transparent)]",
  ...
  toolGovernanceItem:
    "grid [grid-template-columns:minmax(0,_1fr)_auto] [align-items:center] [gap:8px] min-w-0 max-w-full [padding:8px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [&_div]:first-child:grid [&_div]:first-child:[gap:3px] [&_div]:first-child:min-w-0 [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_span]:min-w-0 [&_span]:[overflow:hidden] [&_span]:[text-overflow:ellipsis] [&_span]:[white-space:nowrap] [&_small]:min-w-0 [&_small]:[overflow:hidden] [&_small]:[text-overflow:ellipsis] [&_small]:[white-space:nowrap] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_span]:[color:var(--fg-secondary)] [&_span]:[font-size:var(--vui-font-xs)] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)]",
  toolGovernanceList:
    "grid [align-content:start] [gap:7px] min-w-0 [max-height:220px] [overflow:auto] [padding-right:3px]",
  toolPermissionGroup:
    "grid [gap:6px] min-w-0 max-w-full [padding:7px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)]",
  ...
  toolPermissionRow:
    "grid [grid-template-columns:minmax(0,_1fr)_auto] [align-items:center] [gap:8px] min-w-0 max-w-full [min-height:40px] [padding:6px_8px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [&_span]:grid [&_span]:[gap:2px] [&_span]:min-w-0 [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_small]:min-w-0 [&_small]:[overflow:hidden] [&_small]:[text-overflow:ellipsis] [&_small]:[white-space:nowrap] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)]",
  workspaceScopePanel:
    "grid [grid-template-columns:minmax(0,_1fr)_auto_auto] [align-items:center] [gap:6px] min-w-0 max-w-full [padding:7px_8px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--surface-panel)_58%,_transparent)] [&_div]:grid [&_div]:[gap:2px] [&_div]:min-w-0 [&_span]:min-w-0 [&_span]:[overflow:hidden] [&_span]:[text-overflow:ellipsis] [&_span]:[white-space:nowrap] [&_small]:min-w-0 [&_small]:[overflow:hidden] [&_small]:[text-overflow:ellipsis] [&_small]:[white-space:nowrap] [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_span]:[color:var(--fg-tertiary)] [&_span]:[font-size:var(--vui-font-xs)] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_small]:[color:var(--fg-secondary)] [&_small]:[font-size:var(--vui-font-xs)] max-[860px]:[grid-template-columns:1fr]",
} as const;
