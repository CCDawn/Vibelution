...
const styles: Record<string, string> = {
  ...
  agentRoleTag_tool:
    "[border-color:color-mix(in_srgb,_var(--fg-tertiary)_30%,_var(--border-soft))] [background:color-mix(in_srgb,_var(--fg-tertiary)_10%,_transparent)] [color:var(--fg-secondary)]",
  agentRow:
    "grid [grid-template-columns:minmax(180px,_1.3fr)_minmax(120px,_0.86fr)_minmax(110px,_0.82fr)_minmax(88px,_0.48fr)_minmax(104px,_0.72fr)_minmax(128px,_0.68fr)] [gap:8px] [align-items:center] min-w-0 [width:100%] [min-height:44px] [padding:var(--agent-row-pad-y)_8px] [border:1px_solid_var(--border-soft)] [border-radius:8px] [background:var(--surface-card)] [color:var(--fg-primary)] [text-align:left] [transition:border-color_160ms_ease,_background_160ms_ease,_box-shadow_160ms_ease] hover:[border-color:var(--border-strong)] hover:[background:var(--surface-panel-hover)] [&_span]:min-w-0 [&_span]:[overflow:hidden] [&_span]:[text-overflow:ellipsis] max-[860px]:[grid-template-columns:1fr] max-[860px]:[align-items:start]",
  agentRowActive:
    "[border-color:color-mix(in_srgb,_var(--accent-warm)_34%,_transparent)] [box-shadow:none] [background:color-mix(in_srgb,_var(--accent-warm)_9%,_var(--surface-panel-strong))]",
  agentRowBulkSelected:
    "[background:color-mix(in_srgb,_var(--accent-cool)_10%,_var(--surface-panel-strong))]",
  agentRowShell:
  ...
  avatarEditorActions:
    "flex [flex-wrap:wrap] [gap:7px] min-w-0 [&_[data-vui=\"button\"]]:[white-space:nowrap]",
  avatarEditorAnchor:
  ...
  avatarEditorPanel:
    "[position:absolute] [top:52px] [left:0] [z-index:5] grid [gap:9px] [width:min(320px,_82vw)] [padding:10px] [border:1px_solid_color-mix(in_srgb,_var(--accent-cool)_26%,_var(--border-soft))] [border-radius:8px] [background:var(--surface-panel)] [box-shadow:var(--shadow-soft)] [&_p]:[margin:0] [&_p]:[color:var(--fg-secondary)] [&_p]:[font-size:var(--vui-font-xs)] [&_p]:[line-height:1.4]",
  avatarLibraryHeader:
  ...
  boundarySummaryGrid:
    "grid [align-content:start] [gap:5px] min-w-0 [grid-template-columns:repeat(3,_minmax(0,_1fr))] [&_span]:grid [&_span]:[gap:2px] [&_span]:min-w-0 [&_span]:[padding:7px_8px] [&_span]:[border:1px_solid_var(--border-soft)] [&_span]:[border-radius:var(--radius-control)] [&_span]:[background:var(--surface-panel)] [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_small]:min-w-0 [&_small]:[overflow:hidden] [&_small]:[text-overflow:ellipsis] [&_small]:[white-space:nowrap] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)]",
  bulkFieldHeader:
  ...
  checkField:
    "flex [align-items:center] [gap:8px] min-w-0 [min-height:30px] [padding:0_8px] [border:1px_solid_var(--border-soft)] [border-radius:var(--radius-control)] [background:var(--surface-panel)] [color:var(--fg-secondary)] [font-size:var(--vui-font-xs)] [&_input]:[flex:0_0_auto] [&_span]:min-w-0 [&_span]:[overflow:hidden] [&_span]:[text-overflow:ellipsis] [&_span]:[white-space:nowrap]",
  cleanPill:
  ...
  configDeepLinkRow:
    "flex [justify-content:flex-end] [gap:6px] min-w-0 [&_[data-vui=\"button\"]]:[white-space:nowrap]",
  configEditor:
    "grid [gap:8px] min-w-0 [padding:10px] [border:1px_solid_var(--border-soft)] [border-radius:8px] [background:var(--surface-card)]",
  contextModeGrid:
  ...
  dangerButton:
    "inline-flex [align-items:center] [justify-content:center] [gap:7px] [min-height:30px] [padding:0_10px] [border-radius:var(--radius-control)] [font-weight:700] [border:1px_solid_color-mix(in_srgb,_var(--state-error)_40%,_transparent)] [background:color-mix(in_srgb,_var(--state-error)_10%,_var(--surface-panel))] [color:var(--state-error)] disabled:[cursor:not-allowed] disabled:[opacity:0.55]",
  dangerZone:
  ...
  editorActions:
    "flex [justify-content:flex-end] [gap:6px] min-w-0",
  editorGrid:
  ...
  groupButton:
    "grid [grid-template-columns:minmax(0,_1fr)_auto_auto] [align-items:center] [gap:8px] [width:100%] [min-height:34px] [padding:6px_9px] [border:1px_solid_var(--border-soft)] [border-radius:8px] [background:var(--surface-card)] [color:var(--fg-secondary)] [text-align:left] [transition:border-color_160ms_ease,_background_160ms_ease,_color_160ms_ease] hover:[border-color:var(--border-strong)] hover:[color:var(--fg-primary)] hover:[background:var(--surface-panel-hover)] [&_span]:inline-flex [&_span]:[align-items:center] [&_span]:[gap:8px] [&_span]:min-w-0 [&_span]:[overflow:hidden] [&_span]:[text-overflow:ellipsis] [&_span]:[white-space:nowrap] [&_strong]:inline-flex [&_strong]:[align-items:center] [&_strong]:[justify-content:center] [&_strong]:[min-width:22px] [&_strong]:[min-height:22px] [&_strong]:[border-radius:999px] [&_strong]:[font-style:normal] [&_strong]:[font-size:var(--vui-font-xs)] [&_em]:inline-flex [&_em]:[align-items:center] [&_em]:[justify-content:center] [&_em]:[min-width:22px] [&_em]:[min-height:22px] [&_em]:[border-radius:999px] [&_em]:[font-style:normal] [&_em]:[font-size:var(--vui-font-xs)] [&_strong]:[background:color-mix(in_srgb,_var(--accent-cool)_12%,_transparent)] [&_strong]:[color:var(--accent-cool)] [&_em]:[gap:4px] [&_em]:[padding:0_7px] [&_em]:[background:color-mix(in_srgb,_var(--accent-warm)_12%,_transparent)] [&_em]:[color:var(--accent-warm-2)]",
  groupButtonActive:
    "[border-color:color-mix(in_srgb,_var(--accent-warm)_34%,_transparent)] [box-shadow:none] [background:color-mix(in_srgb,_var(--accent-warm)_10%,_var(--surface-panel-strong))] [color:var(--fg-primary)]",
  groupList:
  ...
  inboxMessageItemFocused:
    "[border-color:color-mix(in_srgb,_var(--accent-cool)_44%,_transparent)] [box-shadow:none] [background:var(--surface-panel-strong)]",
  inboxMessageList:
    "grid [align-content:start] [gap:5px] min-w-0 [max-height:280px] [overflow:auto] [padding-right:3px]",
  inboxMessageTop:
  ...
  policyGrid:
    "grid [grid-template-columns:repeat(3,_minmax(0,_1fr))] [gap:6px] [&_div]:min-w-0 [&_div]:[border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [&_div]:[border-radius:8px] [&_div]:[background:color-mix(in_srgb,_var(--surface-card)_72%,_transparent)] [&_div]:grid [&_div]:[grid-template-columns:auto_minmax(0,_1fr)] [&_div]:[grid-template-areas:\"icon_label\"_\"icon_value\"] [&_div]:[column-gap:8px] [&_div]:[row-gap:2px] [&_div]:[padding:7px_8px_8px] [&_svg]:[grid-area:icon] [&_svg]:[color:var(--accent-cool)] [&_span]:[grid-area:label] [&_span]:[color:var(--fg-tertiary)] [&_span]:[font-size:var(--vui-font-xs)] [&_strong]:[grid-area:value] [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] max-[860px]:[grid-template-columns:1fr]",
  policyHint:
    "[margin:0] [color:var(--fg-secondary)] [font-size:var(--vui-font-xs)] [line-height:1.42] [overflow-wrap:anywhere]",
  policySummaryGrid:
    "grid [grid-template-columns:repeat(4,_minmax(0,_1fr))] [gap:6px] min-w-0 [&_span]:min-w-0 [&_span]:[padding:6px_7px] [&_span]:[border:1px_solid_var(--border-soft)] [&_span]:[border-radius:var(--radius-control)] [&_span]:[background:var(--surface-panel)] [&_span]:[color:var(--fg-secondary)] [&_span]:[font-size:var(--vui-font-xs)] [&_span]:[overflow:hidden] [&_span]:[text-overflow:ellipsis] [&_span]:[white-space:nowrap] [&_strong]:[color:var(--fg-primary)]",
  primaryButton:
    "inline-flex [align-items:center] [justify-content:center] [gap:7px] [min-height:30px] [padding:0_10px] [border-radius:var(--radius-control)] [font-weight:700] [border:1px_solid_color-mix(in_srgb,_var(--accent-cool)_38%,_transparent)] [background:color-mix(in_srgb,_var(--accent-cool)_16%,_var(--surface-panel))] [color:var(--accent-cool)] disabled:[cursor:not-allowed] disabled:[opacity:0.55]",
  promptConfigField:
    "[gap:6px]",
  promptConfigRow:
  ...
  roomCheckField:
    "grid [grid-template-columns:auto_minmax(0,_1fr)] [align-items:center] [gap:8px] min-w-0 [min-height:36px] [padding:6px_8px] [border:1px_solid_var(--border-soft)] [border-radius:var(--radius-control)] [background:var(--surface-panel)] [color:var(--fg-secondary)] [&_input]:[margin:0] [&_span]:grid [&_span]:[gap:2px] [&_span]:min-w-0 [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_small]:min-w-0 [&_small]:[overflow:hidden] [&_small]:[text-overflow:ellipsis] [&_small]:[white-space:nowrap] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)]",
  roomMembershipList:
    "grid [align-content:start] [gap:7px] min-w-0 [max-height:220px] [overflow:auto] [padding-right:3px]",
  route:
    "grid [grid-template-rows:auto_auto_minmax(0,_1fr)] [height:100%] min-h-0 [--agent-density-gap:6px] [--agent-panel-pad:10px] [--agent-row-pad-y:6px] [--agent-control-height:26px] [background:var(--bg-canvas)] max-[860px]:[height:100%] max-[860px]:min-h-0 max-[860px]:[grid-template-rows:auto_auto_minmax(0,_1fr)] max-[860px]:[overflow:hidden]",
  rowSelect:
  ...
  runtimePill:
    "inline-flex [align-items:center] [justify-content:center] [min-height:26px] [padding:0_7px] [border:1px_solid_var(--border-soft)] [border-radius:999px] [font-size:var(--vui-font-xs)] [font-weight:700] [white-space:nowrap]",
  runtimePolicyGrid:
    "grid [grid-template-columns:repeat(2,_minmax(0,_1fr))] [gap:7px] min-w-0 [&_section]:grid [&_section]:[align-content:start] [&_section]:[gap:7px] [&_section]:min-w-0 [&_section]:[padding:8px] [&_section]:[border:1px_solid_var(--border-soft)] [&_section]:[border-radius:var(--radius-control)] [&_section]:[background:var(--surface-panel)] [&_span]:[color:var(--fg-tertiary)] [&_span]:[font-size:var(--vui-font-xs)] [&_span]:[font-weight:700] max-[860px]:[grid-template-columns:1fr]",
  runtime_archived:
  ...
  secondaryButton:
    "inline-flex [align-items:center] [justify-content:center] [gap:7px] [min-height:30px] [padding:0_10px] [border-radius:var(--radius-control)] [font-weight:700] [border:1px_solid_var(--border-soft)] [background:var(--surface-panel)] [color:var(--fg-secondary)] disabled:[cursor:not-allowed] disabled:[opacity:0.55]",
  segmentActive:
  ...
  segmentedControl:
    "inline-grid [grid-template-columns:repeat(3,_minmax(56px,_auto))] [gap:3px] [padding:3px] [border:1px_solid_var(--border-soft)] [border-radius:var(--radius-control)] [background:var(--surface-card)]",
  storagePanel:
    "grid [gap:5px] min-w-0 [padding:8px] [border:1px_solid_var(--border-soft)] [border-radius:8px] [background:color-mix(in_srgb,_var(--surface-card)_86%,_var(--bg-canvas))] [&_code]:min-w-0 [&_code]:[overflow:hidden] [&_code]:[color:var(--fg-secondary)] [&_code]:[font-size:var(--vui-font-xs)] [&_code]:[text-overflow:ellipsis] [&_code]:[white-space:nowrap]",
  successText:
  ...
  timelineActions:
    "flex [flex-wrap:wrap] [gap:5px] min-w-0 [&_[data-vui=\"button\"]]:[max-width:100%] [&_[data-vui=\"button\"]]:[white-space:nowrap]",
  title:
  ...
  toolBundleActions:
    "[grid-area:actions] inline-flex [align-items:center] [gap:5px] min-w-0",
  toolBundleItem:
    "grid [grid-template-columns:minmax(0,_1fr)_auto] [grid-template-areas:\"title_actions\"_\"desc_actions\"] [align-items:center] [gap:4px_8px] min-w-0 [padding:7px_8px] [border:1px_solid_var(--border-soft)] [border-radius:var(--radius-control)] [background:var(--surface-panel)] [&_span]:[grid-area:title] [&_span]:grid [&_span]:[gap:2px] [&_span]:min-w-0 [&_p]:[grid-area:desc] [&_p]:[margin:0] [&_p]:min-w-0 [&_p]:[overflow:hidden] [&_p]:[color:var(--fg-secondary)] [&_p]:[font-size:var(--vui-font-xs)] [&_p]:[line-height:1.35] [&_p]:[text-overflow:ellipsis] [&_p]:[white-space:nowrap] [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_small]:min-w-0 [&_small]:[overflow:hidden] [&_small]:[text-overflow:ellipsis] [&_small]:[white-space:nowrap] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)] max-[860px]:[grid-template-columns:1fr]",
  toolBundleList:
  ...
  toolGovernanceItem:
    "grid [grid-template-columns:minmax(0,_1fr)_auto] [align-items:center] [gap:8px] min-w-0 [padding:8px] [border:1px_solid_var(--border-soft)] [border-radius:var(--radius-control)] [background:var(--surface-panel)] [&_div]:first-child:grid [&_div]:first-child:[gap:3px] [&_div]:first-child:min-w-0 [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_span]:min-w-0 [&_span]:[overflow:hidden] [&_span]:[text-overflow:ellipsis] [&_span]:[white-space:nowrap] [&_small]:min-w-0 [&_small]:[overflow:hidden] [&_small]:[text-overflow:ellipsis] [&_small]:[white-space:nowrap] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_span]:[color:var(--fg-secondary)] [&_span]:[font-size:var(--vui-font-xs)] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)]",
  toolGovernanceList:
    "grid [align-content:start] [gap:7px] min-w-0 [max-height:220px] [overflow:auto] [padding-right:3px]",
  toolPermissionGroup:
    "grid [gap:6px] min-w-0 [padding:7px] [border:1px_solid_color-mix(in_srgb,_var(--border-soft)_88%,_transparent)] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--surface-panel-strong)_76%,_var(--surface-panel))]",
  ...
  toolPermissionRow:
    "grid [grid-template-columns:minmax(0,_1fr)_auto] [align-items:center] [gap:8px] min-w-0 [min-height:40px] [padding:6px_8px] [border:1px_solid_var(--border-soft)] [border-radius:var(--radius-control)] [background:var(--surface-panel)] [&_span]:grid [&_span]:[gap:2px] [&_span]:min-w-0 [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_small]:min-w-0 [&_small]:[overflow:hidden] [&_small]:[text-overflow:ellipsis] [&_small]:[white-space:nowrap] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)]",
  workspace:
