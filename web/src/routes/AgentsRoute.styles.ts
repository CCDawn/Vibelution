...
const styles = {
  ...
  agentRoleTag_tool:
    "[border-color:color-mix(in_srgb,_var(--fg-tertiary)_30%,_var(--vui-border-subtle))] [background:color-mix(in_srgb,_var(--fg-tertiary)_10%,_transparent)] [color:var(--fg-secondary)]",
  agentRow:
    "grid [grid-template-columns:minmax(180px,_1.3fr)_minmax(120px,_0.86fr)_minmax(110px,_0.82fr)_minmax(88px,_0.48fr)_minmax(104px,_0.72fr)_minmax(128px,_0.68fr)] [gap:8px] [align-items:center] min-w-0 max-w-full [width:100%] [min-height:44px] [padding:var(--agent-row-pad-y)_8px] [border:1px_solid_color-mix(in_srgb,_var(--vui-border-subtle)_76%,_transparent)] [border-radius:var(--radius-control)] [background:var(--vui-surface-row)] [color:var(--fg-primary)] [text-align:left] [transition:border-color_160ms_ease,_background_160ms_ease] hover:[border-color:var(--border-strong)] hover:[background:var(--vui-surface-row-hover)] [&_span]:min-w-0 [&_span]:[overflow:hidden] [&_span]:[text-overflow:ellipsis] max-[860px]:[grid-template-columns:1fr] max-[860px]:[align-items:start]",
  agentRowActive:
  ...
  detailPanelCreating:
    "max-[1040px]:hidden",
  detailSection:
    "min-w-0 max-w-full [border:1px_solid_color-mix(in_srgb,_var(--vui-border-subtle)_76%,_transparent)] [border-radius:var(--radius-panel)] [background:var(--vui-surface-panel)] [&_svg]:[grid-area:icon] [&_svg]:[color:var(--accent-cool)] grid [gap:8px] [padding:10px]",
  detailTab:
  ...
  runtime_unknown:
    "[border-color:color-mix(in_srgb,_var(--fg-tertiary)_24%,_transparent)] [background:color-mix(in_srgb,_var(--fg-tertiary)_8%,_transparent)] [color:var(--fg-secondary)]",
  searchBox:
    "flex [align-items:center] [gap:8px] [min-height:32px] [padding:0_9px] [border:1px_solid_var(--vui-border-subtle)] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--vui-surface-workspace)_84%,_transparent)] [color:var(--fg-tertiary)] focus-within:[border-color:color-mix(in_srgb,_var(--accent-cool)_44%,_transparent)] focus-within:[box-shadow:var(--focus-ring)] focus-within:[color:var(--fg-secondary)] [&_input]:min-w-0 [&_input]:[width:100%] [&_input]:[border:0] [&_input]:[outline:0] [&_input]:[background:transparent] [&_input]:[color:var(--fg-primary)] [&_input]:[font:inherit] [&_input]:[font-size:var(--vui-font-xs)]",
  secondaryButton:
