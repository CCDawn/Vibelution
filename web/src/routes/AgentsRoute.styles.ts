...
const styles = {
  ...
  agentAvatar:
    "grid [place-items:center] [flex:0_0_auto] [border-radius:50%] [color:var(--fg-primary)] [background:color-mix(in_srgb,_var(--accent-cool)_10%,_var(--surface-card))] [font-family:var(--font-display)] [font-weight:800] [box-shadow:none] [overflow:hidden] [width:30px] [height:30px] [font-size:var(--vui-font-xs)]",
  agentAvatarImage:
  ...
  bulkSelectionList:
    "flex [flex-wrap:wrap] [gap:6px] min-w-0 [&_span]:[max-width:100%] [&_span]:[overflow:hidden] [&_span]:[padding:3px_7px] [&_span]:[border:1px_solid_var(--border-soft)] [&_span]:[border-radius:var(--radius-control)] [&_span]:[background:var(--surface-card)] [&_span]:[color:var(--fg-secondary)] [&_span]:[font-size:var(--vui-font-xs)] [&_span]:[text-overflow:ellipsis] [&_span]:[white-space:nowrap]",
  capabilityPreviewPanel:
    "grid [grid-template-columns:minmax(150px,_1.35fr)_repeat(4,_minmax(0,_1fr))] [gap:6px] min-w-0 [padding:8px] [border:1px_solid_color-mix(in_srgb,_var(--accent-warm)_20%,_var(--border-soft))] [border-radius:var(--radius-control)] [background:color-mix(in_srgb,_var(--accent-warm)_5%,_var(--surface-panel))] [&_div]:grid [&_div]:[gap:2px] [&_div]:min-w-0 [&_span]:min-w-0 [&_span]:[overflow:hidden] [&_span]:[text-overflow:ellipsis] [&_span]:[white-space:nowrap] [&_small]:min-w-0 [&_small]:[overflow:hidden] [&_small]:[text-overflow:ellipsis] [&_small]:[white-space:nowrap] [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_span]:[color:var(--fg-primary)] [&_span]:[font-size:var(--vui-font-xs)] [&_span]:[font-weight:760] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)] [&_strong]:[align-self:stretch] [&_strong]:[padding:5px_6px] [&_strong]:[border:1px_solid_var(--border-soft)] [&_strong]:[border-radius:var(--radius-control)] [&_strong]:[background:var(--surface-card)] [&_strong]:[color:var(--fg-secondary)] [&_strong]:[font-size:var(--vui-font-xs)]",
  checkField:
  ...
  managementBriefPanel:
    "grid [gap:7px] min-w-0 [padding:9px] [border:1px_solid_color-mix(in_srgb,_var(--accent-cool)_24%,_var(--border-soft))] [border-radius:8px] [background:color-mix(in_srgb,_var(--accent-cool)_5%,_var(--surface-card))]",
  managementChecklist:
  ...
  policyGrid:
    "grid [grid-template-columns:repeat(3,_minmax(0,_1fr))] [gap:6px] [&_div]:min-w-0 [&_div]:[border:1px_solid_color-mix(in_srgb,_var(--border-soft)_76%,_transparent)] [&_div]:[border-radius:8px] [&_div]:[background:color-mix(in_srgb,_var(--surface-card)_72%,_transparent)] [&_div]:grid [&_div]:[grid-template-columns:auto_minmax(0,_1fr)] [&_div]:[grid-template-rows:auto_auto] [&_div]:[column-gap:8px] [&_div]:[row-gap:2px] [&_div]:[padding:7px_8px_8px] [&_svg]:[grid-column:1] [&_svg]:[grid-row:1_/_3] [&_svg]:[color:var(--accent-cool)] [&_span]:[grid-column:2] [&_span]:[grid-row:1] [&_span]:[color:var(--fg-tertiary)] [&_span]:[font-size:var(--vui-font-xs)] [&_strong]:[grid-column:2] [&_strong]:[grid-row:2] [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] max-[860px]:[grid-template-columns:1fr]",
  policyHint:
  ...
  resetZone:
    "grid [gap:8px] min-w-0 [padding:10px] [border:1px_solid_color-mix(in_srgb,_var(--state-warning)_28%,_var(--border-soft))] [border-radius:8px] [background:color-mix(in_srgb,_var(--state-warning)_7%,_var(--surface-card))] [&_svg]:[color:var(--state-warning)]",
  returnBanner:
  ...
  rowSelect:
    "grid [place-items:center] [width:28px] [height:36px] [border:1px_solid_var(--border-soft)] [border-radius:8px] [background:var(--surface-card)] [color:var(--fg-secondary)] [cursor:pointer] hover:[border-color:var(--border-strong)] hover:[color:var(--accent-warm-2)] [&_input]:[position:absolute] [&_input]:[width:1px] [&_input]:[height:1px] [&_input]:[opacity:0] [&_input]:[pointer-events:none]",
  runHistoryItem:
  ...
  runtimeFocusMeta:
    "[&_code]:min-w-0 [&_code]:[overflow:hidden] [&_code]:[text-overflow:ellipsis] [&_code]:[white-space:nowrap] grid [grid-template-columns:repeat(3,_minmax(0,_1fr))] [gap:6px] min-w-0 [&_span]:grid [&_span]:[gap:3px] [&_span]:min-w-0 [&_span]:[padding:6px_7px] [&_span]:[border:1px_solid_var(--border-soft)] [&_span]:[border-radius:var(--radius-control)] [&_span]:[background:var(--surface-card)] [&_strong]:[color:var(--fg-tertiary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_strong]:[font-weight:700] [&_strong]:[text-transform:uppercase] [&_code]:[color:var(--fg-secondary)] [&_code]:[font-family:var(--font-mono,_ui-monospace,_SFMono-Regular,_Consolas,_monospace)] [&_code]:[font-size:var(--vui-font-xs)]",
  runtimeFocusPanel:
