...
const styles = {
  ...
  route:
    "grid max-w-full [grid-template-rows:auto_auto_minmax(0,_1fr)] [height:100%] min-h-0 [overflow-x:hidden] [--agent-density-gap:0px] [--agent-panel-pad:8px] [--agent-row-pad-y:6px] [--agent-control-height:24px] [&_[data-vui-product=\"agent-workspace-panel\"]]:max-w-full [&_[data-vui-product=\"agent-workspace-panel\"]]:overflow-hidden [&_[data-vui-product=\"agent-workspace-panel\"]]:[scrollbar-gutter:stable] [&_[data-vui-product=\"agent-workspace-panel\"]]:[overflow-wrap:anywhere] [&_[data-vui=\"button\"]]:w-fit [&_[data-vui=\"button\"]]:[max-width:100%] [&_[data-vui=\"button\"]]:[white-space:nowrap] max-[860px]:[height:100%] max-[860px]:min-h-0 max-[860px]:[grid-template-rows:auto_auto_minmax(0,_1fr)] max-[860px]:[overflow:hidden] max-[860px]:[overflow-x:hidden] max-[860px]:[&_[data-vui-product=\"agent-workspace-panel\"]]:overflow-visible",
  rowSelect:
