...
const styles = {
  ...
  agentTableHead:
    "grid [grid-template-columns:minmax(180px,_1.3fr)_minmax(120px,_0.86fr)_minmax(110px,_0.82fr)_minmax(88px,_0.48fr)_minmax(104px,_0.72fr)_minmax(128px,_0.68fr)] [gap:8px] [align-items:center] min-w-0 [position:sticky] [top:0] [z-index:1] [padding:0_8px_5px] [color:var(--fg-tertiary)] [font-size:var(--vui-font-xs)] [text-transform:uppercase] !bg-[var(--vui-surface-panel)] max-[860px]:hidden",
  avatarEditorActions:
  ...
  compressionInlineCheck: `inline-flex [align-items:center] [gap:7px] min-w-0 [min-height:30px] [padding:0_8px] ${vuiOpaqueRowClass} [color:var(--fg-secondary)] [font-size:var(--vui-font-xs)] [font-weight:700] [&_input]:[flex:0_0_auto] [&_input]:[width:16px] [&_input]:[height:16px] [&_input]:[min-height:16px] [&_input]:[margin:0] [&_span]:min-w-0 [&_span]:[overflow:hidden] [&_span]:[color:inherit] [&_span]:[text-overflow:ellipsis] [&_span]:[white-space:nowrap]`,
  ...
  referenceItem: `[&_small]:[grid-area:meta] [&_small]:min-w-0 [&_small]:[overflow:hidden] [&_small]:[color:var(--fg-tertiary)] [&_small]:[font-size:var(--vui-font-xs)] [&_small]:[text-overflow:ellipsis] [&_small]:[white-space:nowrap] grid [gap:4px] min-w-0 [padding:7px_8px] ${vuiOpaqueRowClass} [&_strong]:min-w-0 [&_strong]:[overflow:hidden] [&_strong]:[color:var(--fg-primary)] [&_strong]:[font-size:var(--vui-font-xs)] [&_strong]:[text-overflow:ellipsis] [&_strong]:[white-space:nowrap] [&_span]:[margin:0] [&_span]:[color:var(--fg-secondary)] [&_span]:[font-size:var(--vui-font-xs)] [&_span]:[line-height:1.4]`,
  referenceList:
    "grid [align-content:start] [gap:5px] min-w-0",
  referenceMetaRow:
    "grid [grid-template-columns:minmax(0,_1fr)_auto] [align-items:center] [gap:6px] min-w-0",
  ...
  toolBundlePanel:
    "grid [gap:7px] min-w-0 [padding:8px] [border:1px_solid_var(--vui-border-subtle)] [border-radius:var(--radius-control)] !bg-[var(--vui-surface-panel)]",
