...
describe("TeamsRoute layout contract", () => {
  ...
  it("renders a dense list canvas inspector workflow", () => {
    ...
    expect(routeSource).toContain("renderSourceCollectionStageAgentStrip(module.id)");
    ...
    expect(routeSource).toContain("sourceCollectionStageAgentStrip");
    expect(routeSource).toContain("sourceCollectionStageAgentChips");
    expect(routeSource).toContain("sourceCollectionStageAgentChip");
    ...
    expect(routeStyles.sourceCollectionStageAgentStrip).toBeTypeOf("string");
    expect(routeStyles.sourceCollectionStageAgentStripReady).toBeTypeOf("string");
    expect(routeStyles.sourceCollectionStageAgentStripMissing).toBeTypeOf("string");
    expect(routeStyles.sourceCollectionStageAgentStripBlocked).toBeTypeOf("string");
    expect(routeStyles.sourceCollectionStageAgentStripHead).toBeTypeOf("string");
    expect(routeStyles.sourceCollectionStageAgentChips).toBeTypeOf("string");
    expect(routeStyles.sourceCollectionStageAgentChip).toBeTypeOf("string");
