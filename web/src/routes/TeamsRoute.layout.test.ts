...
describe("TeamsRoute layout contract", () => {
  ...
  it("renders a dense list canvas inspector workflow", () => {
    ...
    expect(routeSource).toContain("sourceCollectionStageChatRoute");
    expect(routeSource).toContain("sourceCollectionStageRoomKey");
    expect(routeSource).toContain("createSourceCollectionStageChatRoomMutation");
    expect(routeSource).toContain("openSourceCollectionStageChat");
    expect(routeSource).toContain("进入 Agent 会话");
    ...
    expect(routeSource).toContain("下一步操作");
    ...
    expect(routeSource).toContain("sourceCollectionStageChatRoute");
    expect(routeSource).toContain("SOURCE_COLLECTION_STAGE_CHAT_PURPOSE");
