...
describe("TeamsRoute layout contract", () => {
  ...
  it("renders a dense list canvas inspector workflow", () => {
    ...
    expect(routeSource).toContain("sourceCollectionTraceHandoff");
    expect(routeSource).toContain("Agent 执行过程");
    expect(routeSource).toContain("结果");
    expect(routeSource).toContain("过程");
    ...
    expect(routeSource).toContain('message.id.startsWith("memory-")');
