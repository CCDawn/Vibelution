...
describe("TeamsRoute layout contract", () => {
  ...
  it("renders a dense list canvas inspector workflow", () => {
    ...
    expect(routeSource).toContain("已搜到");
    ...
    expect(routeSource).toContain("sourceCollectionClickableSourceCount");
    expect(routeSource).toContain("sourceCollectionLocalFileCount");
    expect(routeSource).toContain("sourceCollectionMissingSourceCount");
