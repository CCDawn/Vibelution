...
describe("TeamsRoute layout contract", () => {
  ...
  it("renders a dense list canvas inspector workflow", () => {
    ...
    expect(routeSource).toContain('setChallengeTeamSurface("workspace")');
    ...
    expect(routeAndPureSource).toContain("promptCachePolicy: SOURCE_COLLECTION_PROMPT_CACHE_POLICY");
