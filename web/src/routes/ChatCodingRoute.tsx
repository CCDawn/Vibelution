...
function teamStatusLabel(status: string | undefined, lang: "zh" | "en", fallback: (status: string) => string) {
                  ...
                  {searchHasTerm || !collapsedConversationGroups.teams ? (
                    ...
                    {filteredTeams.map((team) => {
                      ...
                      const memberPreview = (team.members ?? [])
                        ...
                        .filter(Boolean)
                        .join(", ");
                      const teamCategoryLabel = team.teamCategory || team.teamKind || (lang === "zh" ? "自定义团队" : "Custom team");
                      return (
                        <div
                          key={team.teamId}
                        ...
                        >
                          ...
                          <div className={styles.teamTreeLabelRow}>
                            ...
                            <strong>{teamCategoryLabel}</strong>
                          ...
                          <div className={styles.teamTreeChildren}>
                            ...
                            <Link className={styles.teamTreeChild} to={teamRoute}>
                              ...
                              <strong>{memberPreview || (team.memberCount ? String(team.memberCount) : (lang === "zh" ? "待绑定" : "empty"))}</strong>
                            </Link>
                          </div>
                        </div>
                      );
