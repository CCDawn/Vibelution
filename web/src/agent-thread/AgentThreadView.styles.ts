const styles = {
  ...
  message:
    "grid min-w-0 gap-1.5 rounded-[var(--radius-control)] border border-[var(--vui-border-subtle)] bg-[var(--vui-surface-row)] px-2.5 py-2 text-[var(--fg-secondary)]",
  ...
  preview:
    "m-0 max-h-40 overflow-auto rounded-[var(--radius-control)] bg-[var(--surface-code)] px-2 py-1.5 font-mono text-[length:var(--vui-font-xs)] whitespace-pre-wrap text-[var(--fg-primary)]",
  contextPart:
