...
export function agentsRouteCopy(lang: "zh" | "en") {
  return lang === "zh"
    ? {
        ...
        bulkArchiveConfirm: "确认批量归档已选 Agent？受保护或已归档项会自动跳过；不会批量删除会话记录。",
        ...
        avatarEditorHint: "默认头像按对话模型使用 Logo；手动指定头像会保留。Chat、团队和群聊引用会同步使用。",
        uploadAvatar: "上传新头像",
        uploadingAvatar: "上传中...",
        resetDefaultAvatar: "使用模型默认",
        resettingAvatar: "恢复中...",
        avatarLibrary: "头像库",
        ...
        memoryEnabledHint: "关闭后该 Agent 不再挂载个人记忆写入工具，也不注入历史个人记忆；已存记忆保留，重新开启后恢复。",
    ...
    : {
        ...
        bulkArchiveConfirm: "Archive the selected Agents? Protected or already archived items are skipped automatically. This does not bulk-delete session records.",
        ...
        avatarEditorHint: "Default avatars use the dialogue model logo; manual choices stay preserved. Chat, teams, and rooms reuse the same avatar.",
        uploadAvatar: "Upload avatar",
        uploadingAvatar: "Uploading...",
        resetDefaultAvatar: "Use model default",
        ...
        memoryEnabled: "Enable personal memory",
        memoryEnabledHint: "When off, this Agent no longer gets personal memory write tools and historical personal memory is not injected; stored memories are kept and restored when re-enabled.",
