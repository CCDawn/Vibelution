...
const plainFallbackClass = "m-0 h-full min-h-0 overflow-auto whitespace-pre-wrap break-words bg-[var(--vui-surface-panel)] px-4 py-3.5 font-[var(--font-mono)] text-[var(--vui-font-xs)] leading-[1.55] text-vui-fg-primary";
