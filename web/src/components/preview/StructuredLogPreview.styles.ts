...
const filterButtonClass = "min-h-7 border border-vui-border-soft bg-[color-mix(in_srgb,var(--vui-surface-row)_88%,transparent)] px-2 py-1 text-[var(--vui-font-xs)] text-vui-fg-secondary";
