...
const summaryClass = "inline-flex min-w-max items-center gap-2 text-[0.82rem] text-vui-fg-secondary";
const summaryCountClass = "font-[var(--font-mono)] text-vui-fg-primary";
const filterGroupClass = "flex flex-wrap justify-end gap-1.5";
const filterButtonClass = "min-h-7 border border-vui-border-soft bg-[color-mix(in_srgb,var(--surface-raised)_88%,transparent)] px-2 py-1 text-[0.78rem] text-vui-fg-secondary";
...
const filterCountClass = "font-[var(--font-mono)] text-[0.72rem] text-vui-fg-tertiary";
...
const entryMetaClass = "flex flex-wrap items-center gap-1.5 font-[var(--font-mono)] text-[0.72rem] text-vui-fg-tertiary";
...
const entryTitleClass = "break-words font-[var(--font-mono)] text-[0.84rem] text-vui-fg-primary";
const entryMessageClass = "m-0 break-words text-[0.84rem] leading-[1.45] text-vui-fg-secondary";
...
const fieldKeyClass = "font-[var(--font-mono)] text-[0.68rem] text-vui-fg-tertiary";
const fieldValueClass = "m-0 mt-[3px] whitespace-pre-wrap break-words font-[var(--font-mono)] text-[0.74rem] leading-[1.42] text-vui-fg-secondary";
