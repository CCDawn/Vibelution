const styles = {
  ...
  markdownBody:
    "vui-components-conversationview markdownBody min-w-0 text-[var(--vui-font-sm)] leading-[var(--vui-line-readable)] text-[var(--fg-secondary)] max-w-[min(100%,76ch)] whitespace-normal break-words [overflow-wrap:anywhere]",
