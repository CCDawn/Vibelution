...
describe("ConversationView edit resend affordance", () => {
  ...
  it("keeps composer and send controls as named Tailwind slices", () => {
    ...
    expect(styles.attachButton).toContain("disabled:hover:bg-[color-mix(in_srgb,var(--surface-card)_62%,transparent)]");
    ...
    expect(styles.composerRoundButtonPrimary).toContain("active:!bg-[color-mix(in_srgb,var(--accent-cool)_22%,var(--surface-card))]");
    ...
    expect(styles.stopButton).toContain("active:!bg-[color-mix(in_srgb,var(--state-error)_18%,var(--surface-card))]");
