...
describe("ConversationView edit resend affordance", () => {
  ...
  it("renders turn errors as timeline notices instead of assistant replies", () => {
    ...
    expect(styles.turnErrorNotice).toContain("block");
    expect(styles.turnErrorNotice).toContain("border-[var(--vui-border-subtle)]");
    expect(styles.turnErrorNotice).toContain("bg-[var(--vui-control-muted)]");
    expect(styles.turnErrorNotice).not.toContain("state-error");
    ...
    expect(styles.turnErrorNoticeIcon).toContain("sr-only");
    expect(styles.turnErrorNoticeMeta).toContain("sr-only");
    ...
    expect(styles.turnErrorNoticeText).toContain("font-mono");
