...
expect(styles.timeline).toContain("pl-[clamp(1rem,3vw,3rem)]");
  ...
  it("keeps composer and send controls as named Tailwind slices", () => {
    ...
    expect(styles.composerAttachmentChip).toContain("rounded-[12px]");
    expect(styles.composerAttachmentPreview).toContain("!h-9");
    expect(styles.composerAttachmentPreview).toContain("!rounded-[9px]");
    ...
    expect(styles.composerAttachmentMeta).toContain("tabular-nums");
