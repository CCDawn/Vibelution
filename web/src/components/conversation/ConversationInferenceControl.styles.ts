const styles = {
  ...
  trigger: "!inline-flex !min-h-7 !h-7 !w-auto !max-w-[260px] !items-center !gap-1 !rounded-full !border-0 !bg-transparent !px-2 !py-0 !text-[var(--vui-font-xs)] !font-medium !text-[var(--fg-secondary)] !shadow-none hover:!bg-[var(--vui-control-muted)] hover:!text-[var(--fg-primary)] max-[719px]:!max-w-[180px]",
