const styles = {
  ...
  fixedLabel: "inline-flex min-h-7 max-w-[220px] items-center truncate px-2 [font-size:var(--vui-font-xs)] font-medium text-[var(--fg-secondary)] max-[719px]:max-w-[132px]",
  trigger: "!inline-flex !min-h-7 !h-7 !w-auto !max-w-[260px] !items-center !gap-1 !rounded-full !border-0 !bg-transparent !px-2 !py-0 ![font-size:var(--vui-font-xs)] !font-medium !text-[var(--fg-secondary)] !shadow-none hover:!bg-[var(--vui-control-muted)] hover:!text-[var(--fg-primary)] max-[719px]:!max-w-[180px]",
  triggerModel: "min-w-0 truncate",
  triggerSeparator: "shrink-0 text-[var(--fg-tertiary)]",
  triggerEffort: "shrink-0 text-[var(--fg-tertiary)]",
  triggerChevron: "shrink-0 text-[var(--fg-tertiary)]",
