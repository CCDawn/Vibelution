...
const styles = {
  ...
  group: cx(
    "group",
    `group min-w-0 overflow-hidden ${vuiOpaqueRowClass}`,
  ),
  groupSummary: cx(
    "groupSummary",
  ...
  groupTitle: cx("groupTitle", "font-semibold [font-size:var(--vui-font-sm)] leading-5 text-[var(--fg-primary)]"),
  groupMeta: cx("groupMeta", "[font-size:var(--vui-font-xs)] leading-5 text-[var(--fg-tertiary)]"),
  groupPreview: cx("groupPreview", "min-w-0 truncate [font-size:var(--vui-font-xs)] leading-5 text-[var(--fg-secondary)] max-[719px]:whitespace-normal max-[719px]:[overflow-wrap:anywhere]"),
  ...
  itemDetails: cx(
    "itemDetails",
    "group min-w-0 rounded-[var(--radius-control)] border border-transparent bg-transparent open:border-[var(--vui-border-subtle)] open:!bg-[var(--vui-surface-panel)]",
  ),
  itemSummary: cx(
    "itemSummary",
  ...
  itemTitle: cx("itemTitle", "font-semibold [font-size:var(--vui-font-sm)] leading-5 text-[var(--fg-primary)]"),
  itemMeta: cx("itemMeta", "[font-size:var(--vui-font-xs)] leading-5 text-[var(--fg-tertiary)]"),
  itemPreview: cx("itemPreview", "min-w-0 truncate [font-size:var(--vui-font-xs)] leading-5 text-[var(--fg-secondary)] max-[719px]:whitespace-normal max-[719px]:[overflow-wrap:anywhere]"),
