...
export const WORKFLOW_SERPENTINE_NODE_DESIGN_WIDTH = 300;
export const WORKFLOW_SERPENTINE_NODE_DESIGN_HEIGHT = 72;
export const WORKFLOW_SERPENTINE_DECISION_DESIGN_HEIGHT = 72;
