  ...
  return (
    <div
      className={cn(
        ...
        spacious
          ? cn(
              "rounded-[11px] px-3 py-2.5 shadow-[0_1px_2px_rgba(15,23,42,0.05),0_5px_14px_rgba(15,23,42,0.04)] hover:-translate-y-px hover:shadow-[0_2px_4px_rgba(15,23,42,0.06),0_9px_22px_rgba(15,23,42,0.08)]",
              visual.surfaceClass,
            )
