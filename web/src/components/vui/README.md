...
| `VPopover` | `ShadcnPopover` (`@radix-ui/react-popover`) | non-modal floating panel + trigger; rich content |
...
**门禁文件：** `vuiShadcnRouteContract.test.ts` · `vuiComponentDesignContract.test.ts` · `workbenchLayoutGate.test.ts`
