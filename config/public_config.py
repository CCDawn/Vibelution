...
LLM_MODEL_PRESETS = {
    ...
    "custom_opencode_relay": {
        ...
        "category": "relay",
        "provider_id": "custom_opencode_relay",
        "model_id": "custom_opencode_relay",
        "provider": {
            "kind": "relay",
            "api": "opencode-go",
            "api_key_env": "VIBELUTION_LLM_MODEL_OPENCODE_RELAY_API_KEY",
            "base_url": "https://relay.example.com/v1",
            "compat_mode": "openai",
            "requires_api_key": True,
        ...
        "model": {
            "model": "gpt-5.6-luna",
            "label": "OpenCode 中转 · GPT-5.6 Luna",
            "api_key_env": "VIBELUTION_LLM_MODEL_OPENCODE_RELAY_API_KEY",
            "transport": "responses",
    ...
    "xiaomi_mimo_v2_5_pro_token_plan": {
        ...
        "model": {
            ...
            "transport": "chat_completions",
            "contract": "tool_chat",
            "protocol": "xiaomi_mimo_token_plan_openai_compat",
            "strict_compatibility": False,
            "temperature": 0.7,
            "max_output_tokens": 128000,
            "timeout": 120,
    ...
    "xiaomi_mimo_v2_5_multimodal": {
        ...
        "model": {
            ...
            "transport": "chat_completions",
            "contract": "tool_chat",
            "protocol": "xiaomi_mimo_multimodal_openai_compat",
            "strict_compatibility": False,
            "temperature": 0.7,
            "max_output_tokens": 128000,
            "timeout": 120,
    ...
    # 官方直连预设：静态模型条目是初始参考，实际可用模型以 discovery 自动发现为准。
    "zhipu_glm_4_7": {
        "label": "智谱官方 GLM-4.7",
        "provider_id": "zhipu_main",
        "model_id": "zhipu_glm_4_7",
        "provider": {
            "kind": "zhipu",
    ...
    "moonshot_kimi_k2_5": {
        "label": "月之暗面 Kimi K2.5",
        "provider_id": "moonshot_main",
        "model_id": "moonshot_kimi_k2_5",
        "provider": {
            "kind": "moonshot",
    ...
    "volcengine_doubao_seed_1_6": {
        "label": "火山方舟 豆包 Seed 1.6",
        "provider_id": "volcengine_main",
        "model_id": "volcengine_doubao_seed_1_6",
        "provider": {
            "kind": "volcengine",
    ...
    "openrouter_aggregator": {
        "label": "OpenRouter 聚合（OpenAI 兼容）",
        "provider_id": "openrouter_main",
        "model_id": "openrouter_aggregator",
        "provider": {
            "kind": "openrouter",
...
LLM_PROVIDER_TEMPLATE_LABELS = {
    ...
    "custom_opencode_relay": "OpenCode 中转 / Relay",
