...
def test_anomaly_inbox_route_passes_snapshot_through_and_returns_projection(
    ...
    # The canonical V2 snapshot is forwarded verbatim; the optional companion
    # inputs stay empty at this stage (problems/awaiting/heartbeat only).
    assert seen_inputs["state"]["questionId"] == "SCI-001"
    assert seen_inputs["kwargs"] == {}
