...
> **ARCHIVED snapshot** (moved from repo root 2026-08-05).
> Living product context: [`docs/product/README.md`](../../product/README.md).
> Do not treat this file as current product authority.
