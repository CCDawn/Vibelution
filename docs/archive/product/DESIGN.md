...
> Living product UI register: [`docs/product/design-register.md`](../../product/design-register.md).
> Component/token authority: `web/src/components/vui/`.
> Do not treat this file as current design authority.
