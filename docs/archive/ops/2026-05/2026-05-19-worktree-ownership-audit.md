...
> Status: Historical governance snapshot from 2026-05-19. Use `AGENTS.md`, `docs/standards/README.md`, and current `.docs/project-memory/` files for active ownership and claim rules.
