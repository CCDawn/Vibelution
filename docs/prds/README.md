...
| [2026-08-27-virtual-human-life-plugin.md](2026-08-27-virtual-human-life-plugin.md) | 按 Agent 隔离的虚拟人生活插件；当前为讨论稿，尚未授权实施 |

挑战杯科研工作流 PRD（2026-08-07 / 08-09 / 08-12）为私密规划文档，不进入 GitHub。本地副本见桌面 `挑战杯/03-工程合同/`。
