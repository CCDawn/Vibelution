...
| [2026-08-07-research-process-flow-single-page-workspace.md](2026-08-07-research-process-flow-single-page-workspace.md) | 挑战杯科研流程单画布工作台；三个阶段同画布分区；运行决策见 [ADR 0006](../adr/0006-challenge-cup-workflow-runtime-and-single-canvas.md) |
