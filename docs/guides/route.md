...
| **后端 API/行为** | [`core/web/services/README.md`](../../core/web/services/README.md) 定 facade；有 pack 再读 pack README；§24 | pack 优先 / 否则 facade → 薄 `routes/` | `test_*service*` + route/contract；`response_model` 预算不升 | route 内业务/直写 store/LLM |
| **Chat 链路/投影** | [`session/README.md`](../../core/web/services/session/README.md)；`docs/agents/conversation-flow-map.md` | `session/{submit,worker,stream_capture,persist,projection,publish}.py`；FE [`chat/README.md`](../../web/src/routes/chat/README.md) | session 相关 pytest + chat contract | 客户端乱合成 `turnItems`；delta 当 SSOT |
...
| **Teams/SC/研究流** | [`web/src/routes/teams/README.md`](../../web/src/routes/teams/README.md)；[`team_workflow/README.md`](../../core/web/services/team_workflow/README.md) | controller/composition/pack；`team_workflows/` routes 包 | teams `*.contract.test.ts`；`test_team_workflow_*` | 胀 `TeamsRoute`；绕 panels registry |
...
匹配 **后端 API/行为** 行后，用下表跳到 [`core/web/services/README.md`](../../core/web/services/README.md) 对应节（完整 facade 表仍以 README 为准）。

| route.md 关键词 / 任务 | services README 锚点 | 迷你索引（若有） |
| --- | --- | --- |
| session / chat payload / SSE / turn | [Session / Chat hot path](../../core/web/services/README.md#session--chat-hot-path) | [`session/README.md`](../../core/web/services/session/README.md) |
| team workflow / SC / experiment | [Team workflow / SC / experiment](../../core/web/services/README.md#team-workflow--sc--experiment) | [`team_workflow/README.md`](../../core/web/services/team_workflow/README.md) |
| agent directory / config workspace | [Agent directory / config](../../core/web/services/README.md#agent-directory--config) | [`agent_directory/README.md`](../../core/web/services/agent_directory/README.md) |
| memory / RAG / knowledge | [Memory](../../core/web/services/README.md#memory) · [Knowledge / RAG](../../core/web/services/README.md#knowledge--rag) | [`memory_rag_services.md`](../../core/web/services/memory_rag_services.md) |
| evolution / supervised / self-evolution | [Self / Supervised evolution](../../core/web/services/README.md#self--supervised-evolution) | [`evolution_services.md`](../../core/web/services/evolution_services.md) |
| launcher / runtime / reset / tray | [Launcher / Reset](../../core/web/services/README.md#launcher--reset) · [Runtime / runtime scene](../../core/web/services/README.md#runtime--runtime-scene) | [`launcher_runtime.md`](../../core/web/services/launcher_runtime.md) |
| config / provider / model / theme | [Config / Provider / Model / Theme](../../core/web/services/README.md#config--provider--model--theme) | [`config_services.md`](../../core/web/services/config_services.md) |
| git status / commit | [Git](../../core/web/services/README.md#git) | — |
| logs / diagnostics / runtime scenes | [Logs / Diagnostics](../../core/web/services/README.md#logs--diagnostics) | [`runtime_scene/README.md`](../../core/web/services/runtime_scene/README.md) |
| tools registry | [Tools registry](../../core/web/services/README.md#tools-registry) | [`tools/README.md`](../../tools/README.md) |

**FE 路由表：** 非 Chat/Teams 壳文件 → [`web/src/routes/README.md`](../../web/src/routes/README.md)。
