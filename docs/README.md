...
| 草案 | 说明 |
| --- | --- |
| [plans/2026-09-11-command-code-headless-transport-poc.md](plans/2026-09-11-command-code-headless-transport-poc.md) | USER-REQUESTED / PROPOSED：Command Code headless CLI 传输探针设计（GO/NO-GO 判据、采集项、架构阻碍），尚未执行 |
