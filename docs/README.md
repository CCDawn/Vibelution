...
| 草案 | 说明 |
| --- | --- |
| [plans/2026-09-11-command-code-headless-transport-poc.md](plans/2026-09-11-command-code-headless-transport-poc.md) | USER-REQUESTED：Command Code headless CLI 传输探针；P0/P1 已执行（无 shell 层调起路径可行、事件清单与判据修订），G1 未测，无 GO/NO-GO 结论 |
